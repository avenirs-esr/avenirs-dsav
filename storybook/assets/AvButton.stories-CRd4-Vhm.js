import{A as Nn}from"./AvButton-hUwPAGl5.js";import{i as Un,g as wn}from"./storybook-DCqn2qwk.js";import"./AvTooltip-D_3MY-N9.js";import"./iframe-DSboSKe3.js";import"./preload-helper-ILsKNznc.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvIcon-BBUs4yUc.js";import"./icon-path-u9rVYwcY.js";import"./icons-BJ4bGiUf.js";import"./string-BZgCOP9D.js";const Hn={title:"Components/Interaction/Buttons/AvButton",component:Nn,argTypes:{label:{type:{name:"string",required:!0},control:"text"},icon:{control:"select",options:wn,mapping:Un},variant:{control:{type:"radio"},options:["DEFAULT","OUTLINED"]},theme:{control:{type:"radio"},options:["PRIMARY","SECONDARY","TERTIARY"]},small:{control:"boolean"},iconOnly:{control:"boolean"},isLoading:{control:"boolean"},noRadius:{control:"boolean"},disabled:{control:"boolean"}},args:{label:"Click me",icon:"",variant:"DEFAULT",theme:"PRIMARY",small:!1,iconOnly:!1,isLoading:!1,noRadius:!1,disabled:!1},parameters:{docs:{description:{component:`<h1 class="n1">Buttons - <code>AvButton</code></h1>
