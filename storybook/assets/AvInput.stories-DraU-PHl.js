import{A as Ge}from"./AvIcon-oZUXxgzB.js";import{A as T}from"./AvInput-BHJXpuEA.js";import{C as Je}from"./icons-sccjonKC.js";import{L as C,b as Fe}from"./iframe-jnS9PFRR.js";import"./icon-path-u9rVYwcY.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvMessage-D4Im2Cr_.js";import"./AvIconText-CkL2NGsc.js";import"./AvTooltip-DFb7oHg1.js";import"./use-text-truncation-DC9qpAHN.js";import"./preload-helper-ILsKNznc.js";const on={title:"Components/Interaction/Inputs/AvInput",component:T,tags:["autodocs"],argTypes:{hint:{control:"text"},isValid:{control:"boolean"},isTextarea:{control:"boolean"},labelVisible:{control:"boolean"},label:{control:"text"},labelClass:{control:"text"},modelValue:{control:"text"},placeholder:{control:"text"},type:{control:"select",options:["text","email","password","number","tel","url","search","date","datetime-local","month","time","week","color","file","hidden","range"]},minDate:{control:"date"},maxDate:{control:"date"},disabled:{control:"boolean"},required:{control:"boolean"},maxlength:{control:"number"},minlength:{control:"number"},errorMessage:{control:"text"},validMessage:{control:"text"},maxlengthExceededMessage:{control:"text"},prefixIcon:{control:"select",options:[void 0,"mdi:account-circle-outline","mdi:magnify","mdi:email-outline","mdi:lock-outline","mdi:phone-outline","mdi:calendar-outline","mdi:map-marker-outline"]},width:{control:"text"},formatDateStr:{control:"text"}},args:{label:"Input Label",placeholder:"Enter text here...",labelVisible:!0,type:"text",disabled:!1,required:!1,isValid:!1,isTextarea:!1,prefixIcon:void 0},parameters:{docs:{description:{component:`<h2 class="n2">✨ Introduction</h2>
