const c={title:"Foundations/1. Typography",argTypes:{}},s=()=>({template:`
  ...
  \`
})`,...(e=(n=s.parameters)==null?void 0:n.docs)==null?void 0:e.source}}};var t,p,i;l.parameters={...l.parameters,docs:{...(t=l.parameters)==null?void 0:t.docs,source:{originalSource:`() => ({
  template: \`
    <div style="padding: var(--spacing-sm); display: flex; flex-direction: column; flex: 1;">
      <span class="s1-light">Subtitle Style 1 (s1-light)</span>
      <span class="s1-regular">Subtitle Style 1 (s1-regular)</span>
  ...
  \`
})`,...(i=(p=l.parameters)==null?void 0:p.docs)==null?void 0:i.source}}};const o=["Titles","Texts"];export{l as Texts,s as Titles,o as __namedExportsOrder,c as default};
