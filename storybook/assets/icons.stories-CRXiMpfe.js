import"./AvFieldset-DOUfpaSr.js";import"./AvFieldsetElement-Dp1lXEoi.js";import{A as c}from"./AvIcon-DecowREl.js";import"./AvIconText-CuBw24PS.js";import"./AvNotice-oARFgiKu.js";import{M as u,R as O,I as _}from"./icons-CvJnIbum.js";import"./AvMessage-DEg7dTOC.js";import"./iframe-DiKQEeDY.js";import"./preload-helper-ILsKNznc.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./string-BZgCOP9D.js";const L={title:"Foundations/3. DSAV icons"},r=()=>({components:{AvIcon:c},setup(){const e=Object.entries(u).map(([t,i])=>[`MDI_ICONS.${t}`,i]),n=Object.entries(O).map(([t,i])=>[`RI_ICONS.${t}`,i]),A=Object.entries(_).map(([t,i])=>[`ICONS_DATA_URL.${t}`,i]);return{icons:[...e,...n,...A]}},template:`
