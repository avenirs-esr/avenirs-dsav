import{A as b}from"./AvIcon-Bd2ndZUU.js";import{d as $,a as d,k as M,e as o,B as F,y as t,c as h,r as X,j as y,f as i,w as Z,m as k,Q as _,g as I,F as ee,G as ae,z as ne,t as A,J as te}from"./iframe-BFQ4lNBu.js";import{A as se}from"./AvButton-Dwkw2s7h.js";import{A as le}from"./AvIconText-ClophZgP.js";import{M as v}from"./icons-Bmg6g8vX.js";import{_ as oe}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./iconify-De_XfGA7.js";import"./preload-helper-ILsKNznc.js";import"./string-BZgCOP9D.js";const ie={key:0,class:"messages-group",role:"alert"},P=$({__name:"AvFileUploadAlert",props:{error:{default:void 0},validMessage:{default:void 0}},setup(e){return(U,s)=>e.error||e.validMessage?(o(),d("div",ie,[F(le,{icon:e.error?t(v).CLOSE_CIRCLE_OUTLINE:t(v).CHECK_CIRCLE_OUTLINE,"icon-color":e.error?"var(--dark-background-error)":"var(--dark-background-success)",text:e.error?e.error:e.validMessage,"text-color":e.error?"var(--dark-background-error)":"var(--dark-background-success)","typography-class":"caption-regular"},null,8,["icon","icon-color","text","text-color"])])):M("",!0)}});P.__docgenInfo={exportName:"default",displayName:"AvFileUploadAlert",description:"",tags:{},props:[{name:"error",description:"Error message to be displayed in case of upload problem.",tags:{default:[{description:"undefined",title:"default"}]},required:!1,type:{name:"string"},defaultValue:{func:!1,value:"undefined"}},{name:"validMessage",description:"Message indicating that the uploaded file is valid.",tags:{default:[{description:"undefined",title:"default"}]},required:!1,type:{name:"string"},defaultValue:{func:!1,value:"undefined"}}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/files/AvFileUpload/AvFileUploadAlert.vue"]};const re={class:"file-upload-content"},de={class:"left-content-container"},pe={class:"content-container"},ce={key:0},ue={class:"b2-bold"},me={key:1,class:"title-container"},fe={class:"b2-regular"},ge={class:"caption-light"},be={key:0,class:"right-icon-container"},ve=["id","aria-describedby","disabled","aria-disabled","accept"],he={class:"caption-light"},j=$({inheritAttrs:!1,__name:"AvFileUpload",props:{id:{default:()=>crypto.randomUUID()},ariaLabel:{default:""},accept:{default:()=>{}},error:{default:""},validMessage:{default:""},disabled:{type:Boolean,default:!1},modelValue:{default:null},maxWidth:{default:"none"},title:{},description:{},deleteButtonLabel:{default:"Remove"},fileName:{},onDeleteFile:{type:Function},enableMultiple:{type:Boolean,default:!1}},emits:["update:modelValue","update:validMessage","update:error","change","onDropAcceptTypeError"],setup(e,{emit:U}){ae(a=>({bc20438e:a.maxWidth}));const s=U,w=h(()=>Array.isArray(e.accept)?e.accept.join(","):e.accept),g=X(!1);function z(a){const n=w.value;return n?n.split(",").map(l=>l.trim().toLowerCase()).some(l=>l.startsWith(".")?a.name.toLowerCase().endsWith(l):l.includes("/")?a.type===l||a.type.startsWith(`${l.split("/")[0]}/`):!1):!0}async function H(a){var p,l;if(a.preventDefault(),g.value=!1,e.disabled||!((l=(p=a.dataTransfer)==null?void 0:p.files)!=null&&l.length))return;const n=Array.from(a.dataTransfer.files).filter(z);await te(),n.length?(s("change",n),s("update:modelValue",n[0]??"")):s("onDropAcceptTypeError")}function Y(a){a.preventDefault(),e.disabled||(g.value=!0)}function G(){g.value=!1}function J(a){const n=a.target.files;s("change",n),s("update:modelValue",(n==null?void 0:n[0])??null)}const r=h(()=>e.fileName||e.modelValue&&!e.enableMultiple),K=h(()=>({for:e.id,class:["fr-upload-group",{"fr-upload-group--error":e.error,"fr-upload-group--valid":e.validMessage,"fr-upload-group--disabled":e.disabled,"drag-over":g.value}],"aria-label":e.ariaLabel,onDragover:Y,onDragleave:G,onDrop:H}));function Q(a){var n;a?(s("update:modelValue",null),s("update:validMessage",null),s("update:error",null),s("change",[])):(n=e.onDeleteFile)==null||n.call(e)}return(a,n)=>(o(),d(ee,null,[(o(),y(_(t(r)?"div":"label"),k(t(r)?{}:t(K),{class:t(r)?"file-preview-container":""}),{default:Z(()=>[i("div",{class:ne(t(r)?"":"file-upload-container")},[i("div",re,[i("div",de,[I(a.$slots,"left",{},()=>[F(b,{size:2.5,name:t(v).ATTACHMENT_PLUS,color:"var(--icon)"},null,8,["name"])],!0)]),i("div",pe,[t(r)?(o(),d("div",ce,[i("span",ue,A(e.fileName||e.modelValue.name),1)])):(o(),d("div",me,[i("span",fe,A(e.title),1),i("span",ge,A(e.description),1)])),F(P,{"valid-message":e.validMessage,error:e.error},null,8,["valid-message","error"])]),e.disabled?M("",!0):(o(),d("div",be,[t(r)?(o(),y(se,{key:0,label:e.deleteButtonLabel,theme:"SECONDARY",onClick:n[0]||(n[0]=()=>Q(e.modelValue))},null,8,["label"])):(o(),y(b,{key:1,size:1.5,name:t(v).TRAY_UPLOAD,color:"var(--dark-background-primary1)"},null,8,["name"]))])),t(r)?M("",!0):(o(),d("input",k({key:1,id:e.id,class:"fr-upload",type:"file","aria-describedby":e.error||e.validMessage?`${e.id}-desc`:void 0},a.$attrs,{disabled:e.disabled,"aria-disabled":e.disabled,accept:t(w),onChange:n[1]||(n[1]=p=>J(p))}),null,16,ve))])],2)]),_:3},16,["class"])),i("span",he,[I(a.$slots,"hint",{},void 0,!0)])],64))}}),x=oe(j,[["__scopeId","data-v-adf6887e"]]);j.__docgenInfo={exportName:"default",displayName:"AvFileUpload",description:"",tags:{},props:[{name:"id",description:`Unique identifier for the file download component.
