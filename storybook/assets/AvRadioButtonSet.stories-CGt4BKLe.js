import{_ as y}from"./AvRadioButton-CSWzENMW.js";import{_ as h}from"./AvRadioButtonSet-tgUG9wtb.js";import"./iframe-DRmKsEoR.js";import"./preload-helper-ILsKNznc.js";import"./vue-dsfr-C6dkiLOv.js";const T={title:"Components/Interaction/Radios/AvRadioButtonSet",component:h,tags:["autodocs"],argTypes:{name:{type:{name:"string",required:!0},control:"text"},modelValue:{type:{name:"string",required:!0},control:"text"},legend:{control:"text"},disabled:{control:"boolean"},required:{control:"boolean"},small:{control:"boolean"},inline:{control:"boolean"},errorMessage:{control:"text"},validMessage:{control:"text"},hint:{control:"text"}},args:{name:"RadioButtonSet",modelValue:"1",legend:"",disabled:!1,required:!1,small:!1,inline:!1,errorMessage:"",validMessage:"",hint:""},parameters:{docs:{description:{component:`<h1 class="n1">Radio button set - <code>AvRadioButtonSet</code></h1>
