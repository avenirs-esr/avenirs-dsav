import{A as s}from"./AvIcon-Cfj6xq2l.js";import{d as b,e as v,k as i,h as l,i as c,l as y,M as R,g as a}from"./iframe-B9halFky.js";import{_ as k}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{a as r,i as u}from"./storybook-D3VA970Y.js";import"./icon-path-u9rVYwcY.js";import"./preload-helper-ILsKNznc.js";import"./icons-DSO42OmF.js";const B=["title","aria-label"],A={class:"av-rich-button__line av-row av-align-center av-w-full"},w={class:"av-rich-button__left av-row av-align-center av-w-full av-gap-sm av-pr-sm"},g=b({__name:"AvRichButton",props:{label:{},iconLeft:{default:()=>{}},iconRight:{default:()=>{}},customPadding:{default:"var(--spacing-sm)"}},emits:["click"],setup(t){return R(e=>({v2deb83d4:e.customPadding})),(e,o)=>(a(),v("button",{title:t.label,"aria-label":t.label,class:"av-rich-button av-row av-w-full av-align-center av-justify-between",onClick:o[0]||(o[0]=f=>e.$emit("click",f))},[i("div",A,[i("div",w,[t.iconLeft?(a(),l(s,{key:0,name:t.iconLeft,color:"var(--dark-background-primary1)",size:1.5},null,8,["name"])):c("",!0),y(e.$slots,"default",{},void 0,!0)]),t.iconRight?(a(),l(s,{key:0,name:t.iconRight,color:"var(--dark-background-primary1)",size:1.5},null,8,["name"])):c("",!0)])],8,B))}}),h=k(g,[["__scopeId","data-v-ff4425d7"]]);g.__docgenInfo={exportName:"default",displayName:"AvRichButton",description:"",tags:{},props:[{name:"label",description:"Button aria label and title for accessibility.",required:!0,type:{name:"string"}},{name:"iconLeft",description:`Icon displayed on the left of the button.
...
<ul>
  ...
  \`
})`,...(m=(d=n.parameters)==null?void 0:d.docs)==null?void 0:m.source}}};const N=["Default"];export{n as Default,N as __namedExportsOrder,E as default};
