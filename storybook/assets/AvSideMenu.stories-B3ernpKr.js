import{A as m}from"./AvSideMenu-B9boX94q.js";import{M as l}from"./icons-DoXnPNNW.js";import{r as g,w as u}from"./iframe-CHZpZ21y.js";import"./AvButton-D4eILf6n.js";import"./AvIcon-DFOePn3O.js";import"./icon-path-u9rVYwcY.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./string-BZgCOP9D.js";import"./preload-helper-ILsKNznc.js";const X={title:"Components/Navigation/AvSideMenu",component:m,tags:["autodocs"],argTypes:{collapsible:{control:"boolean"},width:{control:"text"},collapsedWidth:{control:"text"}},args:{collapsible:!0,width:"16rem",collapsedWidth:"5rem"},parameters:{docs:{description:{component:`<h1 class="n1">Navigation - <code>AvSideMenu</code></h1>
...
<ul>
...
</ul>`}}}},h=a=>({components:{AvSideMenu:m},setup(){const e=g(a.collapsed??!1);return u(()=>a.collapsed,n=>{e.value=n??!1}),{args:a,isCollapsed:e,handleCollapseChange:n=>{e.value=n},MDI_ICONS:l}},template:`
  ...
  `}),o=h.bind({});o.args={};const t=h.bind({});t.args={collapsed:!0};const r=h.bind({});r.args={collapsed:!0,hideContentWhenCollapsed:!0};const d=h.bind({});d.args={collapsible:!1};const p=h.bind({});p.args={width:"20rem",collapsedWidth:"3rem"};const B=a=>({components:{AvSideMenu:m},setup(){const e=g(a.collapsed??!1),s=g("/");u(()=>a.collapsed,i=>{e.value=i??!1});const n=[{path:"/",label:"Mon parcours",icon:l.HOME_VARIANT_OUTLINE},{path:"/formations",label:"Mes formations",icon:l.BOOK_LOCATION_OUTLINE},{path:"/experiences",label:"Mes expériences",icon:l.BRIEFCASE_VARIANT_OUTLINE},{path:"/activities",label:"Mes activités",icon:l.STAR_SHOOTING_OUTLINE}];return{args:a,isCollapsed:e,activeRoute:s,navigationItems:n,handleCollapseChange:i=>{e.value=i},setActiveRoute:i=>{s.value=i}}},template:`
    <div style="height: 600px; display: flex; border: 1px solid var(--divider); border-radius: var(--radius-md);">
      <AvSideMenu
        v-bind="args"
        v-model:collapsed="isCollapsed"
  ...
  `,methods:{getIconPath(e){const s={[l.HOME_VARIANT_OUTLINE]:"M9 14h6v7h5v-8h3L12 3 2 12h3v9h4z",[l.BOOK_LOCATION_OUTLINE]:"M19 2L13 8l6 6 5-6-5-6zM9 4c0-1.11-.89-2-2-2S5 2.89 5 4s.89 2 2 2 2-.89 2-2zm9 13c0-1.11-.89-2-2-2s-2 .89-2 2 .89 2 2 2 2-.89 2-2z",[l.BRIEFCASE_VARIANT_OUTLINE]:"M10 2h4a2 2 0 0 1 2 2v2h4a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4V4a2 2 0 0 1 2-2zm4 4V4h-4v2h4zm6 3H4v10h16V9z",[l.STAR_SHOOTING_OUTLINE]:"M14.84 13.5l-1.91 1.91L12 16.34l-.93-.93-1.91-1.91L7.34 12l1.82-1.82L12 8.34l2.84 2.84L16.66 12l-1.82 1.5z"};return s[e]||s[l.HOME_VARIANT_OUTLINE]}}}),v=B.bind({});v.args={};const P=a=>({components:{AvSideMenu:m},setup(){const e=g(a.collapsed??!1);return u(()=>a.collapsed,s=>{e.value=s??!1}),{args:a,isCollapsed:e}},template:`
  ...
  `}),c=P.bind({});c.args={};var C,f,x;o.parameters={...o.parameters,docs:{...(C=o.parameters)==null?void 0:C.docs,source:{originalSource:`args => ({
  components: {
    AvSideMenu
  },
  setup() {
  ...
  \`
})`,...(x=(f=o.parameters)==null?void 0:f.docs)==null?void 0:x.source}}};var y,b,w;t.parameters={...t.parameters,docs:{...(y=t.parameters)==null?void 0:y.docs,source:{originalSource:`args => ({
  components: {
    AvSideMenu
  },
  setup() {
  ...
  \`
})`,...(w=(b=t.parameters)==null?void 0:b.docs)==null?void 0:w.source}}};var L,M,A;r.parameters={...r.parameters,docs:{...(L=r.parameters)==null?void 0:L.docs,source:{originalSource:`args => ({
  components: {
    AvSideMenu
  },
  setup() {
  ...
  \`
})`,...(A=(M=r.parameters)==null?void 0:M.docs)==null?void 0:A.source}}};var S,I,V;d.parameters={...d.parameters,docs:{...(S=d.parameters)==null?void 0:S.docs,source:{originalSource:`args => ({
  components: {
    AvSideMenu
  },
  setup() {
  ...
  \`
})`,...(V=(I=d.parameters)==null?void 0:I.docs)==null?void 0:V.source}}};var H,k,N;p.parameters={...p.parameters,docs:{...(H=p.parameters)==null?void 0:H.docs,source:{originalSource:`args => ({
  components: {
    AvSideMenu
  },
  setup() {
  ...
  \`
})`,...(N=(k=p.parameters)==null?void 0:k.docs)==null?void 0:N.source}}};var O,T,_;v.parameters={...v.parameters,docs:{...(O=v.parameters)==null?void 0:O.docs,source:{originalSource:`args => ({
  components: {
    AvSideMenu
  },
  setup() {
...
})`,...(_=(T=v.parameters)==null?void 0:T.docs)==null?void 0:_.source}}};var R,E,z;c.parameters={...c.parameters,docs:{...(R=c.parameters)==null?void 0:R.docs,source:{originalSource:`args => ({
  components: {
    AvSideMenu
  },
  setup() {
  ...
  \`
})`,...(z=(E=c.parameters)==null?void 0:E.docs)==null?void 0:z.source}}};const Y=["Default","Collapsed","HiddenContentCollapsed","NonCollapsible","CustomWidth","StudentNavigation","Minimal"];export{t as Collapsed,p as CustomWidth,o as Default,r as HiddenContentCollapsed,c as Minimal,d as NonCollapsible,v as StudentNavigation,Y as __namedExportsOrder,X as default};
