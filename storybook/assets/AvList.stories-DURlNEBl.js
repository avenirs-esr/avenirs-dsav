...
<ul>
  ...
  `});const a=s.bind({});a.args={size:"small"};const l=s.bind({});l.args={size:"medium"};const m=s.bind({});m.args={size:"large"};const j=t=>({components:{AvList:e,AvCheckboxListItem:K},setup(){const u=P([]);return{args:t,model:u,MDI_ICONS:v}},template:`
    <AvList v-bind="args">
  ...
  `}),c=j.bind({});c.args={size:"xsmall",bordered:!0,borderRadius:"var(--radius-md)",backgroundColor:"var(--surface-alt)"};const q=t=>({components:{AvList:e,AvCheckboxListItem:K},setup(){const u=P([]);return{args:t,model:u,MDI_ICONS:v}},template:`
    <AvList v-bind="args">
  ...
  `}),d=q.bind({});d.args={size:"xsmall",bordered:!0,borderRadius:"var(--radius-md)",backgroundColor:"var(--surface-alt)"};var I,b,L;o.parameters={...o.parameters,docs:{...(I=o.parameters)==null?void 0:I.docs,source:{originalSource:`args => ({
  components: {
    AvList,
    AvListItem
  },
  ...
  \`
})`,...(G=(U=d.parameters)==null?void 0:U.docs)==null?void 0:G.source}}};const lt=["Default","Bordered","DividedList","CustomStyling","SmallSize","MediumSize","LargeSize","CheckboxList","CheckboxListCustomItems"];export{i as Bordered,c as CheckboxList,d as CheckboxListCustomItems,r as CustomStyling,o as Default,n as DividedList,m as LargeSize,l as MediumSize,a as SmallSize,lt as __namedExportsOrder,at as default};
