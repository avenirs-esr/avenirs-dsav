import"./AvFieldset-l8c34R76.js";import"./AvFieldsetElement-C6jbz4q5.js";import{A as c}from"./AvIcon-CcH7s3R9.js";import"./AvIconText-C7ppaQgc.js";import"./AvNotice-hHOdNYtu.js";import{M as u,R as O,I as _}from"./icons-DLse1evt.js";import"./AvMessage-DiwGZ2aV.js";import"./iframe-DHf3xQmt.js";import"./preload-helper-ILsKNznc.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./string-BZgCOP9D.js";const L={title:"Foundations/3. DSAV icons"},r=()=>({components:{AvIcon:c},setup(){const e=Object.entries(u).map(([t,i])=>[`MDI_ICONS.${t}`,i]),n=Object.entries(O).map(([t,i])=>[`RI_ICONS.${t}`,i]),A=Object.entries(_).map(([t,i])=>[`ICONS_DATA_URL.${t}`,i]);return{icons:[...e,...n,...A]}},template:`
