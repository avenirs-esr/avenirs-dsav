import{A as p}from"./AvSideMenu-BiWN1UXB.js";import{M as e}from"./icons-ubxugSKv.js";import{r as d}from"./iframe-CXyHY9rM.js";import"./AvButton-C86yuYRp.js";import"./AvIcon-BfY_vSkK.js";import"./iconify-D5kMrd7u.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./string-BZgCOP9D.js";import"./preload-helper-ILsKNznc.js";const Z={title:"Components/Navigation/AvSideMenu",component:p,tags:["autodocs"],argTypes:{id:{control:"text"},collapsible:{control:"boolean"},width:{control:"text"},collapsedWidth:{control:"text"}},args:{id:"storybook-side-menu",collapsible:!0,width:"16rem",collapsedWidth:"5rem"},parameters:{docs:{description:{component:`<h1 class="n1">Navigation - <code>AvSideMenu</code></h1>
...
<ul>
...
</ul>`}}}},h=s=>({components:{AvSideMenu:p},setup(){const a=d(!1);return{args:s,isCollapsed:a,handleCollapseChange:v=>{a.value=v},MDI_ICONS:e}},template:`
  ...
  `}),t=h.bind({});t.args={};const n=h.bind({});n.args={collapsible:!1};const l=h.bind({});l.args={width:"20rem",collapsedWidth:"3rem"};const O=s=>({components:{AvSideMenu:p},setup(){const a=d(!1),i=d("/"),v=[{path:"/",label:"Mon parcours",icon:e.HOME_VARIANT_OUTLINE},{path:"/formations",label:"Mes formations",icon:e.BOOK_LOCATION_OUTLINE},{path:"/experiences",label:"Mes expériences",icon:e.BRIEFCASE_VARIANT_OUTLINE},{path:"/activities",label:"Mes activités",icon:e.STAR_SHOOTING_OUTLINE}];return{args:s,isCollapsed:a,activeRoute:i,navigationItems:v,handleCollapseChange:c=>{a.value=c},setActiveRoute:c=>{i.value=c}}},template:`
    <div style="height: 600px; display: flex; border: 1px solid var(--divider); border-radius: var(--radius-md);">
      <AvSideMenu
        v-bind="args"
        v-model:collapsed="isCollapsed"
  ...
  `,methods:{getIconPath(a){const i={[e.HOME_VARIANT_OUTLINE]:"M9 14h6v7h5v-8h3L12 3 2 12h3v9h4z",[e.BOOK_LOCATION_OUTLINE]:"M19 2L13 8l6 6 5-6-5-6zM9 4c0-1.11-.89-2-2-2S5 2.89 5 4s.89 2 2 2 2-.89 2-2zm9 13c0-1.11-.89-2-2-2s-2 .89-2 2 .89 2 2 2 2-.89 2-2z",[e.BRIEFCASE_VARIANT_OUTLINE]:"M10 2h4a2 2 0 0 1 2 2v2h4a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4V4a2 2 0 0 1 2-2zm4 4V4h-4v2h4zm6 3H4v10h16V9z",[e.STAR_SHOOTING_OUTLINE]:"M14.84 13.5l-1.91 1.91L12 16.34l-.93-.93-1.91-1.91L7.34 12l1.82-1.82L12 8.34l2.84 2.84L16.66 12l-1.82 1.5z"};return i[a]||i[e.HOME_VARIANT_OUTLINE]}}}),o=O.bind({});o.args={id:"student-nav"};const V=s=>({components:{AvSideMenu:p},setup(){const a=d(!1);return{args:s,isCollapsed:a}},template:`
  ...
  `}),r=V.bind({});r.args={id:"minimal-nav"};var g,m,u;t.parameters={...t.parameters,docs:{...(g=t.parameters)==null?void 0:g.docs,source:{originalSource:`args => ({
  components: {
    AvSideMenu
  },
  setup() {
  ...
  \`
})`,...(u=(m=t.parameters)==null?void 0:m.docs)==null?void 0:u.source}}};var C,f,x;n.parameters={...n.parameters,docs:{...(C=n.parameters)==null?void 0:C.docs,source:{originalSource:`args => ({
  components: {
    AvSideMenu
  },
  setup() {
  ...
  \`
})`,...(x=(f=n.parameters)==null?void 0:f.docs)==null?void 0:x.source}}};var y,b,w;l.parameters={...l.parameters,docs:{...(y=l.parameters)==null?void 0:y.docs,source:{originalSource:`args => ({
  components: {
    AvSideMenu
  },
  setup() {
  ...
  \`
})`,...(w=(b=l.parameters)==null?void 0:b.docs)==null?void 0:w.source}}};var L,M,A;o.parameters={...o.parameters,docs:{...(L=o.parameters)==null?void 0:L.docs,source:{originalSource:`args => ({
  components: {
    AvSideMenu
  },
  setup() {
...
})`,...(A=(M=o.parameters)==null?void 0:M.docs)==null?void 0:A.source}}};var I,S,N;r.parameters={...r.parameters,docs:{...(I=r.parameters)==null?void 0:I.docs,source:{originalSource:`args => ({
  components: {
    AvSideMenu
  },
  setup() {
  ...
  \`
})`,...(N=(S=r.parameters)==null?void 0:S.docs)==null?void 0:N.source}}};const F=["Default","NonCollapsible","CustomWidth","StudentNavigation","Minimal"];export{l as CustomWidth,t as Default,r as Minimal,n as NonCollapsible,o as StudentNavigation,F as __namedExportsOrder,Z as default};
