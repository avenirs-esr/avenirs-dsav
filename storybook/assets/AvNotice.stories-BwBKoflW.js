import{A as v}from"./AvNotice-BU1DHBpy.js";import"./AvIcon-C0rUoNVl.js";import"./iframe-DMLTaAVQ.js";import"./preload-helper-ILsKNznc.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./icons-CvJnIbum.js";import"./string-BZgCOP9D.js";const S={title:"Components/Base/AvNotice",component:v,tags:["autodocs"],argTypes:{title:{control:"text"},text:{control:"text"},type:{control:"radio",options:["info","warning","alert"],description:"The type of notice"}},args:{title:"Attention",text:"Please **read carefully** the instructions.",type:"warning"},parameters:{docs:{description:{component:`<h1 class="n1">Important information banner - <code>AvNotice</code></h1>
