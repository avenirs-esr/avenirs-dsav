import{n as q,P as m,h as f,l as d,a9 as c,a1 as B,L as v,e as i,R as W,$ as b,X as Y,g as U}from"./iframe-Cb79UARr.js";import{A as V}from"./AvIconText-Dm7ODHm_.js";import{A as j}from"./AvCard-DoC4jJnS.js";import{A as $}from"./AvTooltip-VZio7N2M.js";import{u as H}from"./use-text-truncation-IkOLGshO.js";import{M as p}from"./icons-CS5vb1aa.js";import{_ as X}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-ILsKNznc.js";import"./AvIcon-B6XRolpv.js";import"./icon-path-u9rVYwcY.js";import"./AvButton-k4kPiKTH.js";import"./theme.types-DKH7g3eH.js";import"./string-BZgCOP9D.js";const z={class:"av-floating-panel av-floating-right","data-testid":"av-floating-panel"},G={class:"av-row av-gap-sm av-align-center av-flex-fill av-wrap-anywhere","data-testid":"av-floating-panel-title"},J={class:"av-row"},K={key:0,class:"av-flex-fill av-wrap-anywhere"},Q={"data-testid":"av-floating-panel-content"},k=q({__name:"AvFloatingPanel",props:{title:{},subtitle:{},icon:{},defaultCollapsed:{type:Boolean,default:!0},width:{default:"var(--dimension-8xl)"},collapseLabel:{default:"Collapse panel"},expandLabel:{default:"Expand panel"}},setup(e,{expose:E}){B(a=>({v3d83160d:a.width}));const u=m(null),g=m(null),{isTruncated:M}=H(g);function R(){var a;(a=u.value)==null||a.toggleCollapsed()}return E({toggleCollapsed:R}),(a,Z)=>(v(),f("div",z,[d(j,{ref_key:"cardRef",ref:u,collapsible:"",collapsed:e.defaultCollapsed,role:"region","aria-label":e.title,"collapse-label":e.collapseLabel,"expand-label":e.expandLabel,"data-testid":"av-floating-panel-card"},{title:c(()=>[i("div",G,[i("div",J,[d(V,{icon:e.icon??b(p).CHAT_BUBBLE_OUTLINE,text:e.title,"icon-color":"var(--dark-background-primary1)","text-color":"var(--dark-background-primary1)",gap:"var(--spacing-sm)","typography-class":"n6",inline:""},null,8,["icon","text"])]),e.subtitle?(v(),f("div",K,[d($,{disabled:!b(M),content:e.subtitle,"force-focusable":""},{default:c(()=>[i("span",{ref_key:"subtitleRef",ref:g,class:"av-max-lines av-text-primary1 s2-light",style:{"--max-lines":"1"},"data-testid":"av-floating-panel-subtitle"},Y(e.subtitle),513)]),_:1},8,["disabled","content"])])):U("",!0)])]),default:c(()=>[i("div",Q,[W(a.$slots,"default",{},void 0,!0)])]),_:3},8,["collapsed","aria-label","collapse-label","expand-label"])]))}}),D=X(k,[["__scopeId","data-v-412a5590"]]);k.__docgenInfo={exportName:"default",displayName:"AvFloatingPanel",description:"",tags:{},expose:[{name:"toggleCollapsed"}],props:[{name:"title",description:"Title displayed in the panel header.",required:!0,type:{name:"string"}},{name:"subtitle",description:"Subtitle displayed in the panel header.",required:!1,type:{name:"string"}},{name:"icon",description:"Icon name (MDI or other iconify icon) displayed next to the title.",required:!1,type:{name:"string"}},{name:"defaultCollapsed",description:"Controls the initial collapsed state of the panel.",tags:{default:[{description:"true",title:"default"}]},required:!1,type:{name:"boolean"}},{name:"width",description:"Width of the panel.",tags:{default:[{description:"'var(--dimension-8xl)'",title:"default"}]},required:!1,type:{name:"string"}},{name:"collapseLabel",description:"ARIA label for the collapse button when the panel is expanded.",tags:{default:[{description:"'Collapse panel'",title:"default"}]},required:!1,type:{name:"string"}},{name:"expandLabel",description:"ARIA label for the expand button when the panel is collapsed.",tags:{default:[{description:"'Expand panel'",title:"default"}]},required:!1,type:{name:"string"}}],slots:[{name:"default",description:"Main content of the panel."}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/overlay/panels/AvFloatingPanel/AvFloatingPanel.vue"]};const ge={title:"Components/Overlay/FloatingPanel/AvFloatingPanel",component:D,argTypes:{title:{control:"text"},subtitle:{control:"text"},icon:{control:"text"},defaultCollapsed:{control:"boolean"},width:{control:"text"},collapseLabel:{control:"text"},expandLabel:{control:"text"}},args:{title:"Contextual help",subtitle:"",icon:p.INFORMATION_OUTLINE,defaultCollapsed:!0,width:"var(--dimension-8xl)",collapseLabel:"Collapse panel",expandLabel:"Expand panel"},parameters:{docs:{story:{height:"28rem"},description:{component:`<h1 class="n1">Floating Panel - <code>AvFloatingPanel</code></h1>
...
<ul>
  ...
  \`
})`,...(O=(T=s.parameters)==null?void 0:T.docs)==null?void 0:O.source}}};const me=["Default","Expanded","WithSubtitle","WithSubtitleAndFitContent","WithouIcon"];export{r as Default,n as Expanded,l as WithSubtitle,t as WithSubtitleAndFitContent,s as WithouIcon,me as __namedExportsOrder,ge as default};
