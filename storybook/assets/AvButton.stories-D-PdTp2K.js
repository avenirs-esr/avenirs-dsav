import{A as Nn}from"./AvButton-DqSOjErT.js";import{i as Un,g as wn}from"./storybook-BUZ3N58g.js";import"./AvIcon-DT2jjxhi.js";import"./iframe-C6lwSr3i.js";import"./preload-helper-ILsKNznc.js";import"./icon-path-u9rVYwcY.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./icons-jAutzxlg.js";import"./string-BZgCOP9D.js";const Gn={title:"Components/Interaction/Buttons/AvButton",component:Nn,argTypes:{label:{type:{name:"string",required:!0},control:"text"},icon:{control:"select",options:wn,mapping:Un},variant:{control:{type:"radio"},options:["DEFAULT","OUTLINED"]},theme:{control:{type:"radio"},options:["PRIMARY","SECONDARY","TERTIARY"]},small:{control:"boolean"},iconOnly:{control:"boolean"},isLoading:{control:"boolean"},noRadius:{control:"boolean"},disabled:{control:"boolean"}},args:{label:"Click me",icon:"",variant:"DEFAULT",theme:"PRIMARY",small:!1,iconOnly:!1,isLoading:!1,noRadius:!1,disabled:!1},parameters:{docs:{description:{component:`<h1 class="n1">Buttons - <code>AvButton</code></h1>
