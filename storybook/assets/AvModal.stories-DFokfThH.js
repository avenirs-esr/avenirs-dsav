...
<ul>
  ...
  `}),s=Z.bind({});s.args={};var k,A,w;s.parameters={...s.parameters,docs:{...(k=s.parameters)==null?void 0:k.docs,source:{originalSource:`args => ({
  components: {
    AvModal,
    AvIconText,
    AvButton
  ...
  \`
})`,...(w=(A=s.parameters)==null?void 0:A.docs)==null?void 0:w.source}}};const he=["Default"];export{s as Default,he as __namedExportsOrder,be as default};
