import"./AvBreadcrumb-BgBKSvjF.js";import{a as N}from"./AvStepper-CW5RBX21.js";import"./AvSideMenu-D9RT8kJ7.js";import"./AvSideNavigation-W0olkucx.js";import{r as $}from"./iframe-BBg84DrF.js";import"./AvButton-DqCcyT_s.js";import"./AvIcon-BabwAM-T.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./icons-CvJnIbum.js";import"./string-BZgCOP9D.js";import"./use-av-breakpoints-CHcDI45s.js";import"./index-CqdtAgUU.js";import"./use-collapsable-CWc3LIum.js";import"./AvListItem-CZGS7HoF.js";import"./preload-helper-ILsKNznc.js";function k(c){return Array.from({length:c.value},(E,_)=>{const p=_+1;return{title:`${p}`,label:`${p}`,href:`#page-${p}`}})}const X={title:"Components/Navigation/AvPagination",component:N,tags:["autodocs"],argTypes:{compact:{control:"boolean"},truncLimit:{control:"number"},currentPage:{control:"number"},firstPageLabel:{control:"text"},lastPageLabel:{control:"text"},nextPageLabel:{control:"text"},prevPageLabel:{control:"text"},compactCurrentPageLabel:{control:"text"},ariaLabel:{control:"text"}},args:{compact:!1,truncLimit:5,currentPage:0,firstPageLabel:"First page",lastPageLabel:"Last page",nextPageLabel:"Next page",prevPageLabel:"Previous page",compactCurrentPageLabel:"Page 1",ariaLabel:"Pagination navigation",pages:k($(10))},parameters:{docs:{description:{component:`<h1 class="n1">Pagination - <code>AvPagination</code></h1>
...
<p class="b2-regular">
  ...
  template: \`<AvPagination v-bind="args" />\`
})`,...(I=(M=i.parameters)==null?void 0:M.docs)==null?void 0:I.source}}};const Y=["Default","DefaultMiddlePage","DefaultLastPage","DefaultTruncated","Compact","CompactMiddlePage","CompactLastPage"];export{o as Compact,i as CompactLastPage,s as CompactMiddlePage,e as Default,t as DefaultLastPage,n as DefaultMiddlePage,r as DefaultTruncated,Y as __namedExportsOrder,X as default};
