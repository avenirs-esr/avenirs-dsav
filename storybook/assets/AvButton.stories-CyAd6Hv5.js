import{A as se}from"./AvButton-DPCazza2.js";import{i as ie,g as ue}from"./storybook-Bli9j8YZ.js";import"./AvTooltip-DDkIxlIK.js";import"./iframe-CFxraX4B.js";import"./preload-helper-ILsKNznc.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvIcon-CUzc6NR2.js";import"./icon-path-u9rVYwcY.js";import"./icons-CS5vb1aa.js";import"./string-BZgCOP9D.js";const ye={title:"Components/Interaction/Buttons/AvButton",component:se,argTypes:{label:{type:{name:"string",required:!0},control:"text"},icon:{control:"select",options:ue,mapping:ie},variant:{control:{type:"radio"},options:["DEFAULT","OUTLINED","FLAT"]},theme:{control:{type:"radio"},options:["PRIMARY","SECONDARY","TERTIARY"]},small:{control:"boolean"},iconOnly:{control:"boolean"},isLoading:{control:"boolean"},noRadius:{control:"boolean"},disabled:{control:"boolean"},disabledTooltip:{control:"text"},href:{control:"text"},to:{control:"text"}},args:{label:"Click me",icon:"",variant:"DEFAULT",theme:"PRIMARY",small:!1,iconOnly:!1,isLoading:!1,noRadius:!1,disabled:!1,disabledTooltip:void 0,href:void 0,to:void 0},parameters:{docs:{description:{component:`<h1 class="n1">Buttons - <code>AvButton</code></h1>
