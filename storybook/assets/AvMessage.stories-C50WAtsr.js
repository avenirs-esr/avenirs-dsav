import{_ as y}from"./AvMessage-C4FqKhT2.js";import"./AvIconText-BEEX3yYy.js";import"./iframe-Bngxkj9X.js";import"./preload-helper-ILsKNznc.js";import"./AvIcon-CX97yXwg.js";import"./icon-path-u9rVYwcY.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvTooltip-DT1cL-14.js";import"./use-text-truncation-CpnyAgz1.js";import"./icons-0dWeWY1j.js";const B={title:"Components/Base/AvMessage",component:y,tags:["autodocs"],argTypes:{type:{control:"select",options:["info","success","warning","error"]},message:{control:"object"}},args:{type:"info",message:"This is an info message"},parameters:{docs:{description:{component:`<h1 class="n1">Messages - <code>AvMessage</code></h1>
...
<ul>
  ...
  template: \`
    <AvMessage v-bind="args" />
  \`
})`,...(i=(c=e.parameters)==null?void 0:c.docs)==null?void 0:i.source}}};var p,m,g;s.parameters={...s.parameters,docs:{...(p=s.parameters)==null?void 0:p.docs,source:{originalSource:`args => ({
  components: {
    AvMessage
  },
  setup() {
  ...
  template: \`
    <AvMessage v-bind="args" />
  \`
})`,...(g=(m=s.parameters)==null?void 0:m.docs)==null?void 0:g.source}}};var d,u,l;n.parameters={...n.parameters,docs:{...(d=n.parameters)==null?void 0:d.docs,source:{originalSource:`args => ({
  components: {
    AvMessage
  },
  setup() {
  ...
  template: \`
    <AvMessage v-bind="args" />
  \`
})`,...(f=(A=a.parameters)==null?void 0:A.docs)==null?void 0:f.source}}};const O=["Info","Success","Warning","Error","MultipleMessages"];export{r as Error,e as Info,a as MultipleMessages,s as Success,n as Warning,O as __namedExportsOrder,B as default};
