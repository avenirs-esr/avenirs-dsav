...
Provides the prop:
- close: function to close the popover`}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/overlay/popovers/AvPopover/AvPopover.vue"]};const Rt={title:"Components/Overlay/Popovers/AvPopover",component:Ne,tags:["autodocs"],argTypes:{width:{control:"text"},padding:{control:"text"}},args:{width:"12.5rem",padding:"var(--spacing-md)"},parameters:{docs:{description:{component:`<h1 class="n1">Popovers - <code>AvPopover</code></h1>
...
<ul>
...
</ul>`}}}},Et=r=>({components:{AvPopover:Ne,AvButton:ke},setup(){return{args:r}},template:`
    <AvPopover
      v-bind="args"
    >
  ...
  `}),O=Et.bind({});O.args={};O.parameters={docs:{source:{code:`
    <AvPopover
      v-bind="args"
    >
      <template #trigger="{ toggle }">
  ...
  \`
})`,...(be=(pe=O.parameters)==null?void 0:pe.docs)==null?void 0:be.source}}};const Ot=["Default"];export{O as Default,Ot as __namedExportsOrder,Rt as default};
