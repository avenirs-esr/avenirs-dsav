import{A as h}from"./AvVIcon-CcQerrFJ.js";import{A as g}from"./AvIconText-z2uAbuk5.js";import"./vue-dsfr-DDqXwMMy.js";import"./iframe-Dnw8_14l.js";import"./preload-helper-ILsKNznc.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const x=["n1","n2","n3","n4","n5","n6","s1-bold","s1-regular","s1-light","s2-bold","s2-regular","s2-light","b1-bold","b1-regular","b1-light","b2-bold","b2-regular","b2-light","caption-bold","caption-regular","caption-light"],A={title:"Components/Base/AvIconText",component:g,tags:["autodocs"],argTypes:{textColor:{control:"color"},iconColor:{control:"color"},icon:{control:"text",type:{name:"string",required:!0}},text:{control:"text",type:{name:"string",required:!0}},typographyClass:{control:"select",options:["",...x]},gap:{control:"text"},inline:{control:"boolean"}},args:{textColor:"var(--text1)",iconColor:"var(--text1)",icon:"mdi:calendar-month",text:"Example text with icon",typographyClass:"b2-regular",gap:"var(--spacing-xxs)",inline:!1},parameters:{docs:{description:{component:`<h1 class="n1">Texts with icon - <code>AvIconText</code></h1>
...
<ul>
...
</ul>`}}}},t=u=>({components:{AvIconText:g,AvVIcon:h},setup(){return{args:u}},template:`
  ...
  template: \`
    <AvIconText v-bind="args" />
  \`
})`,...(m=(d=e.parameters)==null?void 0:d.docs)==null?void 0:m.source}}};const C=["Default","InlineNoEllipsis","CustomColors"];export{e as CustomColors,n as Default,o as InlineNoEllipsis,C as __namedExportsOrder,A as default};
