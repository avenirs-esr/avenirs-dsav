import{A as ce}from"./AvButton-k4kPiKTH.js";import"./iframe-Cb79UARr.js";import{T as e}from"./theme.types-DKH7g3eH.js";import{i as ue,g as de}from"./storybook-Bli9j8YZ.js";import"./AvTooltip-VZio7N2M.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvIcon-B6XRolpv.js";import"./icon-path-u9rVYwcY.js";import"./icons-CS5vb1aa.js";import"./string-BZgCOP9D.js";import"./preload-helper-ILsKNznc.js";const Te={title:"Components/Interaction/Buttons/AvButton",component:ce,argTypes:{label:{type:{name:"string",required:!0},control:"text"},icon:{control:"select",options:de,mapping:ue},variant:{control:{type:"radio"},options:["DEFAULT","OUTLINED","FLAT"]},theme:{control:{type:"radio"},options:Object.values(e)},small:{control:"boolean"},iconOnly:{control:"boolean"},isLoading:{control:"boolean"},iconScale:{control:"number"},noRadius:{control:"boolean"},disabled:{control:"boolean"},disabledTooltip:{control:"text"},noSentenceCase:{control:"boolean"},href:{control:"text"},to:{control:"text"}},args:{label:"Click me",icon:"",variant:"DEFAULT",theme:e.PRIMARY,small:!1,iconOnly:!1,isLoading:!1,iconScale:void 0,noRadius:!1,disabled:!1,disabledTooltip:void 0,noSentenceCase:!1,href:void 0,to:void 0},parameters:{docs:{description:{component:`<h1 class="n1">Buttons - <code>AvButton</code></h1>
