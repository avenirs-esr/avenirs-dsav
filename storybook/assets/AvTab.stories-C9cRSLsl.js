import{_ as s}from"./AvTab-ClqgTTbn.js";import"./iframe-CFxraX4B.js";import"./preload-helper-ILsKNznc.js";const i={title:"Components/Interaction/Tabs/AvTab",component:s,tags:["autodocs"],argTypes:{title:{control:"text"},icon:{control:"text"},disabled:{control:"boolean"},isLoading:{control:"boolean"}},args:{title:"Tab 1",icon:"",disabled:!1,isLoading:!1},parameters:{docs:{description:{component:`<h1 class="n1">Tabs - <code>AvTab</code></h1>
