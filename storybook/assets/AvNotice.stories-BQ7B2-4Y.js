import{d as f}from"./vue-dsfr-DDqXwMMy.js";import{_ as m}from"./AvNotice-CyHjHQ5G.js";import"./iframe-Dnw8_14l.js";import"./preload-helper-ILsKNznc.js";import"./string-BZgCOP9D.js";const y={title:"Components/Base/AvNotice",component:m,tags:["autodocs"],argTypes:{title:{control:"text"},text:{control:"text"},type:{control:"radio",options:["info","warning","alert"],description:"The type of notice"}},args:{title:"Attention",text:"Please **read carefully** the instructions.",type:"warning"},parameters:{docs:{description:{component:`<h1 class="n1">Important information banner - <code>AvNotice</code></h1>
...
<ul>
...
</ul>`}}}},n=g=>({components:{AvNotice:m,DsfrNotice:f},setup(){return{args:g}},template:'<AvNotice v-bind="args" />'}),e=n.bind({});e.args={};const t=n.bind({});t.args={title:"Information",text:"This is an **informative message** with underlined parts.",type:"info"};const a=n.bind({});a.args={title:"Critical alert",text:"**Immediate action** is required.",type:"alert"};var o,s,r;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`args => ({
  components: {
    AvNotice,
    DsfrNotice
  },
  ...
  template: \`<AvNotice v-bind="args" />\`
})`,...(u=(d=a.parameters)==null?void 0:d.docs)==null?void 0:u.source}}};const w=["Default","InfoNotice","AlertNotice"];export{a as AlertNotice,e as Default,t as InfoNotice,w as __namedExportsOrder,y as default};
