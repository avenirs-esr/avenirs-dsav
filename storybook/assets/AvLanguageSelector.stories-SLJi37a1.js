import{_ as s}from"./AvLanguageSelector-KxY9sdDv.js";import"./iframe-B0Y85Vql.js";import"./preload-helper-ILsKNznc.js";import"./use-collapsable-C8jq-Ulh.js";const p={title:"Components/Interaction/Buttons/AvLanguageSelector",component:s,tags:["autodocs"],argTypes:{languages:{control:!1},currentLanguage:{control:"select",options:["fr","en"]},title:{control:"text"}},args:{languages:[{codeIso:"fr",label:"Français"},{codeIso:"en",label:"English"}],currentLanguage:"fr",title:"Select a language"},parameters:{docs:{story:{height:"10rem"},description:{component:`<h2 class="n2">✨ Introduction</h2>
