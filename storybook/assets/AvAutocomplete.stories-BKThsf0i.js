import{A as We,a as Ce}from"./AvListItem-D0-GvPAI.js";import{i as Pe,d as G,O as J,r as w,c as D,w as He,A as ee,a as A,e as te,u as l,D as Ue,x as Ke,b as P,B as V,v as Le,y as N,q as L,I as De,o as g,F as X,E as Ve,a2 as U,K as Ne,R as ae,S as Ge,f as Je,z as Qe}from"./iframe-Db37qRGB.js";import{a as Ye}from"./index-MBHbusoQ.js";import{A as Xe}from"./AvIcon-CtlF11ml.js";import{M}from"./icons-ByBBphah.js";import{_ as Q}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{A as Me}from"./AvButton-Ch0qglr3.js";import{A as Ze}from"./AvInput-B5CXyQUA.js";import"./preload-helper-ILsKNznc.js";import"./string-BZgCOP9D.js";import"./AvMessage-Cmzn7_J-.js";import"./AvIconText-B3xg1K8H.js";var C=(e=>(e.LOADING="loading",e.NO_OPTIONS="no-options",e.HAS_OPTIONS="has-options",e))(C||{});const Re=Symbol("AvAutocompleteContext");function oe(){const e=Pe(Re);if(!e)throw new Error("useAutocompleteContext must be used within AvAutocomplete component");return e}var et=typeof global=="object"&&global&&global.Object===Object&&global,tt=typeof self=="object"&&self&&self.Object===Object&&self,je=et||tt||Function("return this")(),K=je.Symbol,qe=Object.prototype,ot=qe.hasOwnProperty,nt=qe.toString,q=K?K.toStringTag:void 0;function at(e){var n=ot.call(e,q),r=e[q];try{e[q]=void 0;var v=!0}catch{}var m=nt.call(e);return v&&(n?e[q]=r:delete e[q]),m}var lt=Object.prototype,rt=lt.toString;function st(e){return rt.call(e)}var it="[object Null]",ct="[object Undefined]",le=K?K.toStringTag:void 0;function dt(e){return e==null?e===void 0?ct:it:le&&le in Object(e)?at(e):st(e)}function ut(e){return e!=null&&typeof e=="object"}var mt="[object Symbol]";function pt(e){return typeof e=="symbol"||ut(e)&&dt(e)==mt}var ft=/\s/;function vt(e){for(var n=e.length;n--&&ft.test(e.charAt(n)););return n}var gt=/^\s+/;function ht(e){return e&&e.slice(0,vt(e)+1).replace(gt,"")}function Z(e){var n=typeof e;return e!=null&&(n=="object"||n=="function")}var re=NaN,bt=/^[-+]0x[0-9a-f]+$/i,yt=/^0b[01]+$/i,St=/^0o[0-7]+$/i,At=parseInt;function se(e){if(typeof e=="number")return e;if(pt(e))return re;if(Z(e)){var n=typeof e.valueOf=="function"?e.valueOf():e;e=Z(n)?n+"":n}if(typeof e!="string")return e===0?e:+e;e=ht(e);var r=yt.test(e);return r||St.test(e)?At(e.slice(2),r?2:8):bt.test(e)?re:+e}var Y=function(){return je.Date.now()},_t="Expected a function",Ot=Math.max,It=Math.min;function Ee(e,n,r){var v,m,p,f,i,t,d=0,b=!1,y=!1,_=!0;if(typeof e!="function")throw new TypeError(_t);n=se(n)||0,Z(r)&&(b=!!r.leading,y="maxWait"in r,p=y?Ot(se(r.maxWait)||0,n):p,_="trailing"in r?!!r.trailing:_);function O(c){var h=v,k=m;return v=m=void 0,d=c,f=e.apply(k,h),f}function x(c){return d=c,i=setTimeout(S,n),b?O(c):f}function I(c){var h=c-t,k=c-d,j=n-h;return y?It(j,p-k):j}function T(c){var h=c-t,k=c-d;return t===void 0||h>=n||h<0||y&&k>=p}function S(){var c=Y();if(T(c))return u(c);i=setTimeout(S,I(c))}function u(c){return i=void 0,_&&v?O(c):(v=m=void 0,f)}function o(){i!==void 0&&clearTimeout(i),d=0,v=t=m=i=void 0}function a(){return i===void 0?f:u(Y())}function s(){var c=Y(),h=T(c);if(v=arguments,m=this,t=c,h){if(i===void 0)return x(t);if(y)return clearTimeout(i),i=setTimeout(S,n),O(t)}return i===void 0&&(i=setTimeout(S,n)),f}return s.cancel=o,s.flush=a,s}const wt={key:0,class:"av-autocomplete-dropdown__loading"},xt={key:1,class:"av-autocomplete-dropdown__empty"},Tt={key:1,class:"av-autocomplete-dropdown__empty-text"},$e=G({__name:"AvAutocompleteDropdown",emits:["loadMore"],setup(e,{expose:n,emit:r}){const v=r,m=J(),{selectedItems:p,searchQuery:f,isOpen:i,props:t,getOptionId:d,getDisplayLabel:b}=oe(),y=w(),_=w(),O=D(()=>{if(!t.options)return[];if(t.serverSideFiltering)return t.maxResults?t.options.slice(0,t.maxResults):t.options;const o=f.value.toLowerCase().trim();if(!o){const s=t.options;return t.maxResults?s.slice(0,t.maxResults):s}let a;return t.filterOptions?a=t.filterOptions(t.options,o):a=t.options.filter(s=>b(s).toLowerCase().includes(o)),t.maxResults?a.slice(0,t.maxResults):a}),x=D(()=>t.loading?C.LOADING:i.value&&t.options&&t.options.length>0&&O.value.length>0?C.HAS_OPTIONS:C.NO_OPTIONS);function I(o){return p.value.some(a=>d(a)===d(o))}function T(o){if(!t.multiSelect){p.value=[o],i.value=!1,f.value="";return}const a=p.value,s=d(o);a.some(h=>d(h)===s)?p.value=a.filter(h=>d(h)!==s):p.value=[...a,o]}const{arrivedState:S}=Ye(_,{throttle:100}),u=Ee(()=>{v("loadMore")},t.loadMoreThrottleDelay);return He(()=>S.bottom,o=>{t.enableLoadMore&&o&&i.value&&u()}),ee(()=>{u.cancel()}),n({dropdownRef:y}),(o,a)=>l(i)?(g(),A("div",{key:0,ref_key:"dropdownRef",ref:y,class:Ke(["av-autocomplete-dropdown",l(t).dropdownClass]),style:Ue({width:l(t).dropdownWidth,maxHeight:l(t).maxDropdownHeight})},[l(x)===l(C).LOADING?(g(),A("div",wt,[V(Xe,{name:l(M).LOADING,size:1.5,class:"av-autocomplete-dropdown__spinner"},null,8,["name"]),a[0]||(a[0]=Le("span",{class:"av-autocomplete-dropdown__loading-text"},"Loading...",-1))])):l(x)===l(C).NO_OPTIONS?(g(),A("div",xt,[m.empty?N(o.$slots,"empty",{key:0},void 0,!0):(g(),A("div",Tt," No results found "))])):(g(),P(We,De({key:2,ref_key:"listRef",ref:_},l(t).listOptions,{class:["av-autocomplete-dropdown__options",l(t).scrollbarClass]}),{default:L(()=>[(g(!0),A(X,null,Ve(l(O),s=>(g(),A(X,{key:l(d)(s)},[m.item?N(o.$slots,"item",{key:0,option:s,isSelected:I(s),toggle:()=>T(s)},void 0,!0):(g(),P(Ce,{key:1,title:l(b)(s),icon:I(s)?l(M).CHECK:void 0,selected:I(s),clickable:"","on-click":()=>T(s),"hover-background-color":"var(--light-background-neutral)","color-on-hover":"var(--base)"},null,8,["title","icon","selected","on-click"]))],64))),128))]),_:3},16,["class"]))],6)):te("",!0)}}),kt=Q($e,[["__scopeId","data-v-32439dba"]]);$e.__docgenInfo={exportName:"default",displayName:"AvAutocompleteDropdown",description:"",tags:{},expose:[{name:"dropdownRef"}],events:[{name:"loadMore"}],slots:[{name:"empty"},{name:"item",scoped:!0,bindings:[{name:"option",title:"binding"},{name:"is-selected",title:"binding"},{name:"toggle",title:"binding"}]}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/selects/AvAutocomplete/AvAutocompleteDropdown.vue"]};const Ct={class:"av-autocomplete-input"},Lt={key:0,class:"av-autocomplete-input__suffix"},Be=G({__name:"AvAutocompleteInput",emits:["search","clear"],setup(e,{expose:n,emit:r}){const v=r,m=J(),{selectedItems:p,searchQuery:f,isOpen:i,props:t,inputId:d,handleBlur:b,getDisplayLabel:y}=oe(),_=w(),O=D(()=>!t.multiSelect&&p.value.length>0?y(p.value[0]):t.multiSelect&&p.value.length>0?t.showSelectedSection?`${p.value.length} element(s) selected`:p.value.map(y).join(", "):f.value),x=D(()=>{var o;return((o=t.inputOptions)==null?void 0:o.placeholder)||"Search..."}),I=Ee(o=>{f.value=o,v("search",o)},t.debounceDelay);function T(o){f.value=String(o||""),I(f.value)}function S(){i.value=!0}function u(){p.value=[],f.value="",v("clear")}return ee(()=>{I.cancel()}),n({inputRef:_,searchQuery:D(()=>f.value)}),(o,a)=>(g(),A("div",Ct,[V(Ze,De({id:l(d),ref_key:"inputRef",ref:_,"model-value":l(O),placeholder:l(x)},l(t).inputOptions,{"onUpdate:modelValue":T,onFocus:S,onBlur:l(b),onClick:S}),U({_:2},[m.requiredTip?{name:"requiredTip",fn:L(()=>[(g(),P(Ne(m.requiredTip)))]),key:"0"}:void 0]),1040,["id","model-value","placeholder","onBlur"]),l(p).length>0?(g(),A("div",Lt,[V(Me,{label:"Clear selected items",icon:l(M).CLOSE_CIRCLE_OUTLINE,"icon-only":"","icon-scale":1.25,variant:"DEFAULT",theme:"SECONDARY",onClick:u},null,8,["icon"])])):te("",!0)]))}}),Dt=Q(Be,[["__scopeId","data-v-318a09bc"]]);Be.__docgenInfo={exportName:"default",displayName:"AvAutocompleteInput",description:"",tags:{},expose:[{name:"inputRef"},{name:"searchQuery"}],events:[{name:"search",type:{names:["string"]}},{name:"clear"}],slots:[{name:"requiredTip"}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/selects/AvAutocomplete/AvAutocompleteInput.vue"]};const Vt={key:0,class:"av-autocomplete-selected-tags"},ze=G({__name:"AvAutocompleteSelectedTags",setup(e){const n=J(),{selectedItems:r,props:v,getOptionId:m,getDisplayLabel:p}=oe();function f(i){const t=r.value,d=m(i);r.value=t.filter(b=>m(b)!==d)}return(i,t)=>l(v).multiSelect&&l(r).length>0&&l(v).showSelectedSection?(g(),A("div",Vt,[(g(!0),A(X,null,Ve(l(r),d=>(g(),A("div",{key:l(m)(d),class:"av-autocomplete-selected-tags__item"},[n.selectedItem?N(i.$slots,"selectedItem",{key:0,option:d,remove:()=>f(d)},void 0,!0):(g(),P(Me,{key:1,label:l(p)(d),icon:l(M).CLOSE_CIRCLE_OUTLINE,"icon-right":"",size:"sm",variant:"OUTLINED",theme:"SECONDARY",onClick:()=>f(d)},null,8,["label","icon","onClick"]))]))),128))])):te("",!0)}}),Nt=Q(ze,[["__scopeId","data-v-c42c1ff5"]]);ze.__docgenInfo={exportName:"default",displayName:"AvAutocompleteSelectedTags",description:"",tags:{},slots:[{name:"selectedItem",scoped:!0,bindings:[{name:"option",title:"binding"},{name:"remove",title:"binding"}]}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/selects/AvAutocomplete/AvAutocompleteSelectedTags.vue"]};const Mt={class:"av-autocomplete"},Fe=G({__name:"AvAutocomplete",props:ae({id:{},inputOptions:{default:()=>({})},options:{},multiSelect:{type:Boolean,default:!1},getOptionLabel:{},getOptionKey:{},filterOptions:{},dropdownWidth:{default:"100%"},maxDropdownHeight:{default:"20rem"},listOptions:{default:()=>({size:"small",ariaLabel:"Available options list"})},scrollbarClass:{default:"av-autocomplete__scrollbar--default"},dropdownClass:{default:"av-autocomplete__dropdown--default"},loading:{type:Boolean,default:!1},debounceDelay:{default:300},maxResults:{},enableLoadMore:{type:Boolean,default:!1},showSelectedSection:{type:Boolean,default:!1},blurCloseDelay:{default:150},loadMoreThrottleDelay:{default:200},serverSideFiltering:{type:Boolean,default:!1}},{modelValue:{default:()=>[]},modelModifiers:{}}),emits:ae(["search","loadMore","clear"],["update:modelValue"]),setup(e,{emit:n}){const r=e,v=n,m=J(),p=Ge(e,"modelValue"),f=w(!1),i=w(""),t=w(),d=w(),b=w(),y=D(()=>r.id||`av-autocomplete-${crypto.randomUUID()}`);function _(u){i.value=u,v("search",u)}function O(u){var o,a;(a=(o=b.value)==null?void 0:o.dropdownRef)!=null&&a.contains(u.relatedTarget)||setTimeout(()=>{f.value=!1},r.blurCloseDelay)}function x(u){return r.getOptionKey?r.getOptionKey(u):u.value}function I(u){return r.getOptionLabel?r.getOptionLabel(u):u.label}Qe(Re,{selectedItems:p,searchQuery:i,isOpen:f,props:r,inputId:y,handleBlur:O,getOptionId:x,getDisplayLabel:I});function S(u){var s,c,h,k,j;const o=u.target,a=(s=d.value)==null?void 0:s.inputRef;!((c=a==null?void 0:a.contains)!=null&&c.call(a,o))&&!((h=t.value)!=null&&h.contains(o))&&!((j=(k=b.value)==null?void 0:k.dropdownRef)!=null&&j.contains(o))&&(f.value=!1)}return Je(()=>{document.addEventListener("click",S)}),ee(()=>{document.removeEventListener("click",S)}),(u,o)=>(g(),A("div",Mt,[Le("div",{ref_key:"wrapperRef",ref:t,class:"av-autocomplete__wrapper"},[V(Dt,{ref_key:"inputRef",ref:d,onSearch:_,onClear:o[0]||(o[0]=a=>v("clear"))},U({_:2},[m.requiredTip?{name:"requiredTip",fn:L(()=>[(g(),P(Ne(m.requiredTip)))]),key:"0"}:void 0]),1536),V(kt,{ref_key:"dropdownRef",ref:b,onLoadMore:o[1]||(o[1]=a=>v("loadMore"))},U({_:2},[m.item?{name:"item",fn:L(({option:a,isSelected:s,toggle:c})=>[N(u.$slots,"item",{option:a,isSelected:s,toggle:c},void 0,!0)]),key:"0"}:void 0,m.empty?{name:"empty",fn:L(()=>[N(u.$slots,"empty",{},void 0,!0)]),key:"1"}:void 0]),1536)],512),V(Nt,null,U({_:2},[m.selectedItem?{name:"selectedItem",fn:L(({option:a,remove:s})=>[N(u.$slots,"selectedItem",{option:a,remove:s},void 0,!0)]),key:"0"}:void 0]),1024)]))}}),ne=Q(Fe,[["__scopeId","data-v-a8c4de33"]]);Fe.__docgenInfo={exportName:"default",displayName:"AvAutocomplete",description:"",tags:{},props:[{name:"inputOptions",defaultValue:{func:!1,value:"() => ({})"}},{name:"multiSelect",defaultValue:{func:!1,value:"false"}},{name:"dropdownWidth",defaultValue:{func:!1,value:"'100%'"}},{name:"maxDropdownHeight",defaultValue:{func:!1,value:"'20rem'"}},{name:"listOptions",defaultValue:{func:!1,value:`() => ({
  size: 'small',
...
<p><span class="b2-regular">The autocomplete consists of an input field, dropdown with filterable options, and optional selected items section for multi-select mode.</span></p>`}}}},R=e=>({components:{AvAutocomplete:ne},setup(){const n=w([]);return{args:e,modelValue:n,MDI_ICONS:M}},template:`<AvAutocomplete v-bind="args" v-model="modelValue" @search="(query) => console.log('Search:', query)" @load-more="() => console.log('Load more')" />`}),E=R.bind({});E.args={};const $=R.bind({});$.args={multiSelect:!0,showSelectedSection:!0,inputOptions:{label:"Multi-select options",placeholder:"Search and select multiple options..."}};const B=R.bind({});B.args={inputOptions:{label:"Custom input",placeholder:"Start typing to search...",required:!0}};const z=R.bind({});z.args={loading:!0,inputOptions:{label:"Loading state",placeholder:"Loading options..."}};const F=R.bind({});F.args={enableLoadMore:!0,maxDropdownHeight:"15rem",inputOptions:{label:"Infinite scroll",placeholder:"Scroll to load more..."},options:Array.from({length:20},(e,n)=>({label:`Option ${n+1}`,value:`${n+1}`}))};const W=R.bind({});W.args={dropdownWidth:"25rem",maxDropdownHeight:"12rem",inputOptions:{label:"Custom dropdown size",placeholder:"Fixed width dropdown..."}};const H={render(){return{components:{AvAutocomplete:ne,AvListItem:Ce},setup(){return{modelValue:w([]),customOptions:[{label:"John Doe",value:"john",role:"Developer",department:"Engineering"},{label:"Jane Smith",value:"jane",role:"Designer",department:"Design"},{label:"Bob Johnson",value:"bob",role:"Manager",department:"Product"},{label:"Alice Brown",value:"alice",role:"Analyst",department:"Marketing"}],MDI_ICONS:M}},template:`
        <AvAutocomplete 
          v-model="modelValue"
  ...
  template: \`<AvAutocomplete v-bind="args" v-model="modelValue" @search="(query) => console.log('Search:', query)" @load-more="() => console.log('Load more')" />\`
})`,...(we=(Ie=W.parameters)==null?void 0:Ie.docs)==null?void 0:we.source}}};var xe,Te,ke;H.parameters={...H.parameters,docs:{...(xe=H.parameters)==null?void 0:xe.docs,source:{originalSource:`{
  render() {
    return {
      components: {
        AvAutocomplete,
