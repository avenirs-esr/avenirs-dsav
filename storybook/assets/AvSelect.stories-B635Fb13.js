import{_ as xe}from"./AvMessage-TkseEWZ9.js";import{d as qe,U as Ce,V as Me,c as p,e as r,k as c,f as T,n as k,i as D,u as t,L as u,I as De,O as w,P as N,g as l}from"./iframe-CQX1b8Yz.js";import{A as we}from"./AvIcon-BV59L0Mk.js";import{b as Oe,M as We}from"./icons-DSO42OmF.js";import{_ as ke}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvIconText-DkoTyLmF.js";import"./preload-helper-ILsKNznc.js";import"./icon-path-u9rVYwcY.js";const Ue={key:0,class:"av-select-prefix av-align-center av-col av-text-text2"},$e=["for"],Te={key:0,class:"required"},Ne={key:1,class:"av-hint-text"},Pe=["id","value","name","disabled","aria-disabled","required","aria-required","aria-describedby","title"],Be={disabled:"",value:"",hidden:""},Ge=["label"],Re=["value","disabled","aria-disabled"],Ee=["value","disabled","aria-disabled"],be=qe({__name:"AvSelect",props:Ce({required:{type:Boolean,default:!1},disabled:{type:Boolean,default:!1},id:{},name:{default:""},hint:{default:""},label:{default:""},options:{default:()=>[]},successMessage:{default:""},errorMessage:{default:""},placeholder:{},dense:{type:Boolean,default:!1},prefixIcon:{}},{selectedItem:{default:()=>({itemId:""})},selectedItemModifiers:{}}),emits:["update:selectedItem"],setup(e){const U=Me(e,"selectedItem"),O=p(()=>String(U.value.itemId??"")),o=e.id??`select-${crypto.randomUUID()}`,he=p(()=>{if(!O.value)return e.placeholder;const s=ve(O.value);return s?s.label:e.placeholder}),Ie=p(()=>({"--icon-path":`url(${Oe.MDI_KEYBOARD_ARROW_DOWN})`})),C=p(()=>e.errorMessage||e.successMessage),m=p(()=>e.errorMessage?"error":"success");function W(s){return Array.isArray(s.children)}function ve(s){for(const a of e.options){if(W(a)&&a.children){const i=a.children.find(n=>String(n.id)===s);if(i)return i}if(String(a.id)===s)return a}}function Se(s){for(const a of e.options){if(W(a)&&a.children){const i=a.children.find(n=>String(n.id)===s);if(i)return{itemId:i.id,parentId:a.id}}if(String(a.id)===s)return{itemId:a.id}}return{itemId:s}}function ye(s){const a=s.target.value;U.value=Se(a)}return(s,a)=>{const i=xe;return l(),r("div",{class:k({"av-select--dense":e.dense})},[c("div",{class:k(["av-select-group",{[`av-select-group--${t(m)}`]:t(C)}])},[c("div",{class:k(["av-select-control",{"av-select-control--disabled":e.disabled}])},[e.prefixIcon?(l(),r("div",Ue,[T(we,{name:e.prefixIcon,size:1.2},null,8,["name"])])):D("",!0),c("label",{class:"av-label b2-light",for:t(o)},[c("span",null,u(e.label),1),e.required?(l(),r("span",Te," *")):D("",!0),e.hint?(l(),r("span",Ne,u(e.hint),1)):D("",!0)],8,$e),c("select",De({id:t(o),value:t(O),class:[{[`av-select--${t(m)}`]:t(C),"av-select--with-prefix av-pl-xl":e.prefixIcon,"av-py-xxs":e.dense,"av-py-xs":!e.dense},"av-select b2-light av-w-full av-pr-xl av-pl-sm av-text-text2 av-radius-lg"],name:e.name||t(o),disabled:e.disabled,"aria-disabled":e.disabled,required:e.required,"aria-required":e.required,"aria-describedby":t(C)?`${t(o)}-${t(m)}`:void 0,title:t(he)},s.$attrs,{style:t(Ie),onChange:ye}),[c("option",Be,u(e.placeholder),1),(l(!0),r(w,null,N(e.options,(n,$)=>(l(),r(w,{key:$},[W(n)&&n.children?(l(),r(w,{key:0},[n.children.length>0?(l(),r("optgroup",{key:0,label:n.label},[(l(!0),r(w,null,N(n.children,(M,Ae)=>(l(),r("option",{key:`${$}-${Ae}`,value:M.id,disabled:M.disabled,"aria-disabled":M.disabled},u(M.label),9,Re))),128))],8,Ge)):D("",!0)],64)):(l(),r("option",{key:1,value:n.id,disabled:n.disabled,"aria-disabled":n.disabled},u(n.label),9,Ee))],64))),128))],16,Pe)],2),T(i,{"message-id":`${t(o)}-${t(m)}`,message:t(C),type:t(m)},null,8,["message-id","message","type"])],2)],2)}}}),fe=ke(be,[["__scopeId","data-v-93ab697d"]]);be.__docgenInfo={exportName:"default",displayName:"AvSelect",description:"",tags:{},props:[{name:"required",description:"Indicates if the select is required.",tags:{default:[{description:"false",title:"default"}]},required:!1,type:{name:"boolean"}},{name:"disabled",description:"Indicated if the select is disabled.",tags:{default:[{description:"false",title:"default"}]},required:!1,type:{name:"boolean"}},{name:"id",description:"Unique id for the select. Used for the accessibility.",tags:{default:[{description:"`select-${crypto.randomUUID()}`",title:"default"}]},required:!1,type:{name:"string"}},{name:"name",description:"Field name.",tags:{default:[{description:"''",title:"default"}]},required:!1,type:{name:"string"}},{name:"hint",description:"Hint for guidance.",tags:{default:[{description:"''",title:"default"}]},required:!1,type:{name:"string"}},{name:"label",description:"Select text label.",tags:{default:[{description:"''",title:"default"}]},required:!1,type:{name:"string"}},{name:"options",description:"Selectable options.",tags:{default:[{description:"[]",title:"default"}]},required:!1,type:{name:"Array",elements:[{name:"AvSelectOption"}]}},{name:"successMessage",description:"If set, display a success message.",tags:{default:[{description:"''",title:"default"}]},required:!1,type:{name:"string"}},{name:"errorMessage",description:"If set, display an error message.",tags:{default:[{description:"''",title:"default"}]},required:!1,type:{name:"string"}},{name:"placeholder",description:"Placeholder text.",required:!0,type:{name:"string"}},{name:"dense",description:"dense mode",tags:{default:[{description:"false",title:"default"}]},required:!1,type:{name:"boolean"}},{name:"prefixIcon",description:"Prefix icon name (optional)",required:!1,type:{name:"string"}}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/selects/AvSelect/AvSelect.vue"]};const Je={title:"Components/Interaction/Selects/AvSelect",component:fe,tags:["autodocs"],argTypes:{required:{control:"boolean"},disabled:{control:"boolean"},dense:{control:"boolean"},name:{control:"text"},hint:{control:"text"},label:{control:"text"},options:{type:{name:"{id: string | number | undefined, label: string, disabled?: boolean}[]",required:!0},control:!1},selectedItem:{control:!1},successMessage:{control:"text"},errorMessage:{control:"text"},placeholder:{control:"text",required:!0},prefixIcon:{control:"text"}},args:{options:[{id:"1",label:"Choice 1"},{id:"2",label:"Choice 2"},{id:"3",label:"Choice 3"},{id:"4",label:"Choice 4"},{id:"5",label:"Choice 5"}],placeholder:"Placeholder",required:!1,disabled:!1,name:"select",hint:"",selectedItem:{itemId:""},label:"",successMessage:"",errorMessage:"",dense:!1,prefixIcon:""},parameters:{docs:{description:{component:`<h1 class="n1">Drop-down list - <code>AvSelect</code></h1>
...
<p><span class="b2-regular">The <code>AvSelect</code> consists of a set of <code>&lt;option&gt;</code> within a <code>&lt;select&gt;</code>.</span></p>`}}}},d=e=>({components:{AvSelect:fe},setup(){return{args:e}},template:`
  ...
  template: \`
    ...
    <p>Selected item parent: {{ args.selectedItem.parentId }}</p>
  \`
})`,...(G=(B=g.parameters)==null?void 0:B.docs)==null?void 0:G.source}}};var R,E,V;b.parameters={...b.parameters,docs:{...(R=b.parameters)==null?void 0:R.docs,source:{originalSource:`args => ({
  components: {
    AvSelect
  },
  setup() {
  ...
  template: \`
    ...
    <p>Selected item parent: {{ args.selectedItem.parentId }}</p>
  \`
})`,...(V=(E=b.parameters)==null?void 0:E.docs)==null?void 0:V.source}}};var L,H,z;f.parameters={...f.parameters,docs:{...(L=f.parameters)==null?void 0:L.docs,source:{originalSource:`args => ({
  components: {
    AvSelect
  },
  setup() {
  ...
  template: \`
    ...
    <p>Selected item parent: {{ args.selectedItem.parentId }}</p>
  \`
})`,...(z=(H=f.parameters)==null?void 0:H.docs)==null?void 0:z.source}}};var F,K,Y;h.parameters={...h.parameters,docs:{...(F=h.parameters)==null?void 0:F.docs,source:{originalSource:`args => ({
  components: {
    AvSelect
  },
  setup() {
  ...
  template: \`
    ...
    <p>Selected item parent: {{ args.selectedItem.parentId }}</p>
  \`
})`,...(Y=(K=h.parameters)==null?void 0:K.docs)==null?void 0:Y.source}}};var j,J,Q;I.parameters={...I.parameters,docs:{...(j=I.parameters)==null?void 0:j.docs,source:{originalSource:`args => ({
  components: {
    AvSelect
  },
  setup() {
