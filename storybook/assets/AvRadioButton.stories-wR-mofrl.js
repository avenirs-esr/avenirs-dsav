import{_ as s}from"./AvRadioButton-BnMw1t9a.js";import"./iframe-DbXmFJO9.js";import"./preload-helper-ILsKNznc.js";const p={title:"Components/Interaction/Radios/AvRadioButton",component:s,tags:["autodocs"],argTypes:{value:{control:"text"},label:{control:"text"},description:{control:"text"},disabled:{control:"boolean"}},args:{value:"option1",label:"Choice 1",description:"This is choice 1",disabled:!1},parameters:{docs:{description:{component:`<h1 class="n1">Radio buttons - <code>AvRadioButton</code></h1>
