...
<p><span class="b2-regular">The <code>AvSelect</code> consists of a set of <code>&lt;option&gt;</code> within a <code>&lt;select&gt;</code>.</span></p>`}}}},a=e=>({components:{AvSelect:X},setup(){return{args:e}},template:'<AvSelect v-bind="args" v-model="args.modelValue" />'}),c=a.bind({});c.args={name:"default-select",label:"Select"};const u=a.bind({});u.args={name:"dense-select",dense:!0,label:"Dense Select"};const m=a.bind({});m.args={name:"disabled-select",disabled:!0,label:"Disabled Select"};const p=a.bind({});p.args={name:"required-select",required:!0,label:"Required Select"};const g=a.bind({});g.args={name:"hint-select",hint:"This is a hint message.",label:"Hint Select"};const f=a.bind({});f.args={name:"custom-placeholder-select",placeholder:"Please select an option",label:"Custom placeholder Select"};const v=a.bind({});v.args={name:"with-error-select",errorMessage:"This field is required.",label:"With error Select"};const b=a.bind({});b.args={name:"with-success-select",successMessage:"Selection successful!",label:"With success Select"};var I,M,C;c.parameters={...c.parameters,docs:{...(I=c.parameters)==null?void 0:I.docs,source:{originalSource:`args => ({
...
})`,...(C=(M=c.parameters)==null?void 0:M.docs)==null?void 0:C.source}}};var w,T,B;u.parameters={...u.parameters,docs:{...(w=u.parameters)==null?void 0:w.docs,source:{originalSource:`args => ({
  components: {
    AvSelect
  },
  setup() {
  ...
  template: \`<AvSelect v-bind="args" v-model="args.modelValue" />\`
})`,...(B=(T=u.parameters)==null?void 0:T.docs)==null?void 0:B.source}}};var W,$,E;m.parameters={...m.parameters,docs:{...(W=m.parameters)==null?void 0:W.docs,source:{originalSource:`args => ({
  components: {
    AvSelect
  },
  setup() {
  ...
  template: \`<AvSelect v-bind="args" v-model="args.modelValue" />\`
})`,...(E=($=m.parameters)==null?void 0:$.docs)==null?void 0:E.source}}};var N,R,U;p.parameters={...p.parameters,docs:{...(N=p.parameters)==null?void 0:N.docs,source:{originalSource:`args => ({
  components: {
    AvSelect
  },
  setup() {
  ...
  template: \`<AvSelect v-bind="args" v-model="args.modelValue" />\`
})`,...(U=(R=p.parameters)==null?void 0:R.docs)==null?void 0:U.source}}};var k,O,P;g.parameters={...g.parameters,docs:{...(k=g.parameters)==null?void 0:k.docs,source:{originalSource:`args => ({
  components: {
    AvSelect
  },
  setup() {
  ...
  template: \`<AvSelect v-bind="args" v-model="args.modelValue" />\`
})`,...(z=(H=f.parameters)==null?void 0:H.docs)==null?void 0:z.source}}};var L,G,K;v.parameters={...v.parameters,docs:{...(L=v.parameters)==null?void 0:L.docs,source:{originalSource:`args => ({
  components: {
    AvSelect
  },
  setup() {
  ...
  template: \`<AvSelect v-bind="args" v-model="args.modelValue" />\`
})`,...(K=(G=v.parameters)==null?void 0:G.docs)==null?void 0:K.source}}};var Y,j,J;b.parameters={...b.parameters,docs:{...(Y=b.parameters)==null?void 0:Y.docs,source:{originalSource:`args => ({
  components: {
    AvSelect
  },
  setup() {
  ...
  template: \`<AvSelect v-bind="args" v-model="args.modelValue" />\`
})`,...(J=(j=b.parameters)==null?void 0:j.docs)==null?void 0:J.source}}};const xe=["Default","Dense","Disabled","Required","Hint","CustomPlaceholder","WithError","WithSuccess"];export{f as CustomPlaceholder,c as Default,u as Dense,m as Disabled,g as Hint,p as Required,v as WithError,b as WithSuccess,xe as __namedExportsOrder,Ve as default};
