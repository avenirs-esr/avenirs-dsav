import{A as re}from"./AvDropdown-lKsRNllM.js";import{M as e,C as b}from"./icons-CS5vb1aa.js";import{T as I}from"./theme.types-DKH7g3eH.js";import"./iframe-Cb79UARr.js";import"./preload-helper-ILsKNznc.js";import"./AvButton-k4kPiKTH.js";import"./AvTooltip-VZio7N2M.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvIcon-B6XRolpv.js";import"./icon-path-u9rVYwcY.js";import"./string-BZgCOP9D.js";import"./AvPopover-CH-3WDtP.js";import"./focus-trap.esm-CPw4bcQR.js";const Ae={title:"Components/Overlay/Dropdowns/AvDropdown",component:re,argTypes:{items:{control:"object"},triggerAriaLabel:{control:"text"},triggerIcon:{control:"text"},triggerLabel:{control:"text"},triggerVariant:{control:{type:"radio"},options:["DEFAULT","OUTLINED","FLAT"]},triggerSmall:{control:"boolean"},width:{control:"text"},padding:{control:"text"},itemSmall:{control:"boolean"},itemTheme:{control:{type:"radio"},options:[I.PRIMARY,I.SECONDARY]},itemIconScale:{control:"number"}},args:{items:[{name:"edit",label:"Edit",icon:e.PENCIL_OUTLINE},{name:"delete",label:"Delete",icon:e.TRASH_CAN_OUTLINE},{name:"share",label:"Share",icon:e.SHARE_VARIANT_OUTLINE},{name:"details",label:"Details",to:"/details",icon:b.VISIBILITY_ON_OUTLINE},{name:"external",label:"External",href:"https://example.com",icon:e.LINK}],triggerAriaLabel:"Actions menu",triggerIcon:e.DOTS_VERTICAL,triggerLabel:void 0,triggerVariant:"OUTLINED",triggerSmall:!0,width:"15rem",padding:"var(--spacing-xs)",itemSmall:!0,itemTheme:I.SECONDARY,itemIconScale:1.3},parameters:{docs:{description:{component:`<h1 class="n1">Dropdowns - <code>AvDropdown</code></h1>
...
<ul>
  ...
  template: \`<AvDropdown v-bind="args" />\`
})`,...(Y=(W=c.parameters)==null?void 0:W.docs)==null?void 0:Y.source}}};var F,B,K;p.parameters={...p.parameters,docs:{...(F=p.parameters)==null?void 0:F.docs,source:{originalSource:`args => ({
  components: {
    AvDropdown
  },
  setup() {
  ...
  template: \`<AvDropdown v-bind="args" />\`
})`,...(K=(B=p.parameters)==null?void 0:B.docs)==null?void 0:K.source}}};var k,z,j;m.parameters={...m.parameters,docs:{...(k=m.parameters)==null?void 0:k.docs,source:{originalSource:`args => ({
  components: {
    AvDropdown
  },
  setup() {
