import{_ as Y}from"./AvTab-DALkBxzx.js";import{m as Z,Y as j,Z as M}from"./vue-dsfr-CBTjZMzH.js";import{d as O,V as R,r as W,c as G,x as f,k as d,w as p,n as A,W as H,B as u,i as o,b as g,F as h,j as y,M as J,m as K,t as Q}from"./iframe-CCrYptT9.js";import{_ as X}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-ILsKNznc.js";const C=O({__name:"AvTabs",props:{ariaLabel:{},modelValue:{},compact:{type:Boolean,default:!1}},emits:["update:modelValue"],setup(n,{expose:L,emit:D}){const $=D,m=R(),e=W(n.modelValue),r=G(()=>{var a;return((a=m.default)==null?void 0:a.call(m))||[]});function v(a){const i=r.value.length;e.value=(e.value+a+i)%i}function B(){v(-1)}function N(){v(1)}function q(){e.value=0}function E(){e.value=r.value.length-1}return f(()=>n.modelValue,a=>{a!==void 0&&(e.value=a)}),f(e,a=>{$("update:modelValue",a)}),L({activeTab:e}),(a,i)=>{const z=M,P=j,U=Z;return o(),d(U,{modelValue:u(e),"onUpdate:modelValue":i[0]||(i[0]=s=>H(e)?e.value=s:null),class:A({compact:n.compact}),"tab-list-name":n.ariaLabel??"Liste d’onglets","tab-titles":[]},{"tab-items":p(()=>[(o(!0),g(h,null,y(u(r),(s,t)=>{var T;return o(),d(z,{key:t,class:A({compact:n.compact}),"tab-id":`tab-${t}`,"panel-id":`panel-${t}`,icon:(T=s.props)==null?void 0:T.icon,onClick:b=>e.value=t,onNext:N,onPrevious:B,onFirst:q,onLast:E},{default:p(()=>{var b;return[K(Q((b=s.props)==null?void 0:b.title),1)]}),_:2},1032,["class","tab-id","panel-id","icon","onClick"])}),128))]),default:p(()=>[(o(!0),g(h,null,y(u(r),(s,t)=>(o(),d(P,{key:t,"panel-id":`panel-${t}`,"tab-id":`tab-${t}`},{default:p(()=>[(o(),d(J(s.children.default)))]),_:2},1032,["panel-id","tab-id"]))),128))]),_:1},8,["modelValue","class","tab-list-name"])}}}),F=X(C,[["__scopeId","data-v-dbd71c5f"]]);C.__docgenInfo={exportName:"default",displayName:"AvTabs",description:"",tags:{},expose:[{name:"activeTab"}],props:[{name:"ariaLabel",description:`Aria label for tab list.
