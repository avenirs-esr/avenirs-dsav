import"./AvBreadcrumb-BA9cUGY8.js";import{a as N}from"./AvStepper-BjFnlGPb.js";import"./AvSideMenu-nJWWsQrL.js";import"./AvSideNavigation-25m0AmMz.js";import{r as $}from"./iframe-D1dQtzRZ.js";import"./AvButton-DkuApIL8.js";import"./AvIcon-B9ZvUdtT.js";import"./icon-path-u9rVYwcY.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./icons-m2nAwYSh.js";import"./string-BZgCOP9D.js";import"./use-av-breakpoints-Cj7EEaSE.js";import"./index-BeC8jE43.js";import"./use-collapsable-By5jVOTJ.js";import"./AvListItem-G0Galr-V.js";import"./preload-helper-ILsKNznc.js";function k(c){return Array.from({length:c.value},(E,_)=>{const p=_+1;return{title:`${p}`,label:`${p}`,href:`#page-${p}`}})}const Y={title:"Components/Navigation/AvPagination",component:N,tags:["autodocs"],argTypes:{compact:{control:"boolean"},truncLimit:{control:"number"},currentPage:{control:"number"},firstPageLabel:{control:"text"},lastPageLabel:{control:"text"},nextPageLabel:{control:"text"},prevPageLabel:{control:"text"},compactCurrentPageLabel:{control:"text"},ariaLabel:{control:"text"}},args:{compact:!1,truncLimit:5,currentPage:0,firstPageLabel:"First page",lastPageLabel:"Last page",nextPageLabel:"Next page",prevPageLabel:"Previous page",compactCurrentPageLabel:"Page 1",ariaLabel:"Pagination navigation",pages:k($(10))},parameters:{docs:{description:{component:`<h1 class="n1">Pagination - <code>AvPagination</code></h1>
...
<p class="b2-regular">
  ...
  template: \`<AvPagination v-bind="args" />\`
})`,...(I=(M=i.parameters)==null?void 0:M.docs)==null?void 0:I.source}}};const Z=["Default","DefaultMiddlePage","DefaultLastPage","DefaultTruncated","Compact","CompactMiddlePage","CompactLastPage"];export{o as Compact,i as CompactLastPage,s as CompactMiddlePage,e as Default,t as DefaultLastPage,n as DefaultMiddlePage,r as DefaultTruncated,Z as __namedExportsOrder,Y as default};
