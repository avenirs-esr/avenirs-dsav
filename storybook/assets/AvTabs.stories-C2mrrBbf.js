import{_ as J}from"./AvTab-C8crq-Vu.js";import{d as x,W as Q,Z as X,e as h,l as Y,n as y,g as b,a1 as ee,c as k,w as te,k as S,h as I,i as H,u as w,L as ae,I as ne,_ as se,r as g,U as oe,S as ie,V as le,E as re,o as ce,a as de,O as E,P as q,N as be,j as ue,K as me}from"./iframe-pRXexesd.js";import{_ as C}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{A as pe}from"./AvIcon-CchWSR_s.js";import"./preload-helper-ILsKNznc.js";import"./icon-path-u9rVYwcY.js";const ve=["id","aria-labelledby","tabindex"],M=x({__name:"TabContent",props:{panelId:{},tabId:{},isVisible:{type:Boolean}},setup(e){return(l,a)=>Q((b(),h("div",{id:e.panelId,class:y(["av-tab-content",{"av-tab-content--selected":e.isVisible}]),role:"tabpanel","aria-labelledby":e.tabId,tabindex:e.isVisible?0:-1},[Y(l.$slots,"default",{},void 0,!0)],10,ve)),[[X,e.isVisible]])}}),O=C(M,[["__scopeId","data-v-3bab28a1"]]);M.__docgenInfo={exportName:"default",displayName:"TabContent",description:"",tags:{},props:[{name:"panelId",description:"ID of the associated tab panel.",required:!0,type:{name:"string"}},{name:"tabId",description:"ID of the tab item.",required:!0,type:{name:"string"}},{name:"isVisible",description:"Whether the tab content is visible.",required:!0,type:{name:"boolean"}}],slots:[{name:"default",description:"Default slot for passing tab panel content."}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/tabs/AvTabs/components/TabContent.vue"]};const fe=["id","data-testid","tabindex","aria-selected","aria-controls"],U=x({__name:"TabItem",props:{panelId:{},tabId:{},isSelected:{type:Boolean},title:{},icon:{},compact:{type:Boolean,default:!1}},emits:["click","next","previous","first","last"],setup(e,{emit:l}){const a=l,n=ee("button"),u=k(()=>e.isSelected?"s2-bold":"s2-regular"),p={ArrowRight:"next",ArrowLeft:"previous",Home:"first",End:"last"};function c(o){const m=o==null?void 0:o.key,d=p[m];if(d)switch(d){case"next":a("next");break;case"previous":a("previous");break;case"first":a("first");break;case"last":a("last");break}}return te(()=>e.isSelected,()=>{var o;e.isSelected&&((o=n.value)==null||o.focus())}),(o,m)=>{const d=pe;return b(),h("li",{class:y(["av-tab-item av-py-xs",{"av-tab-item--compact av-no-before":e.compact,"av-flex-fill av-w-full":!e.compact}]),role:"presentation"},[S("button",ne(o.$attrs,{id:e.tabId,ref:"button","data-testid":`test-${e.tabId}`,class:["av-tab-item__tab av-row av-gap-xs av-align-center av-justify-center av-text-text2 av-w-full",{"av-tab-item--compact__tab av-radius-none av-m-none av-py-xs av-px-2xl":e.compact,"av-radius-lg":!e.compact}],tabindex:e.isSelected?0:-1,role:"tab",type:"button","aria-selected":e.isSelected,"aria-controls":e.panelId,onClick:m[0]||(m[0]=se(T=>a("click",e.tabId),["prevent"])),onKeydown:m[1]||(m[1]=T=>c(T))}),[e.icon?(b(),I(d,{key:0,name:e.icon,size:2},null,8,["name"])):H("",!0),S("span",{class:y(w(u))},ae(e.title),3)],16,fe)],2)}}}),P=C(U,[["__scopeId","data-v-9b3fc9bd"]]);U.__docgenInfo={exportName:"default",displayName:"TabItem",description:"",tags:{},props:[{name:"panelId",description:"ID of the associated tab panel.",required:!0,type:{name:"string"}},{name:"tabId",description:"ID of the tab item.",required:!0,type:{name:"string"}},{name:"isSelected",description:"Whether the tab is currently selected.",required:!0,type:{name:"boolean"}},{name:"title",description:"Title of the tab displayed in the tab bar.",required:!0,type:{name:"string"}},{name:"icon",description:"Name of the icon to display in the tab.",required:!1,type:{name:"string"}},{name:"compact",description:"Whether the tab is displayed in compact mode.",tags:{default:[{description:"false",title:"default"}]},required:!1,type:{name:"boolean"}}],events:[{name:"click",type:{names:["string"]},description:"Emitted when the tab is clicked.",properties:[{type:{names:["mixed"]},name:"tabId",description:"The ID of the clicked tab."}],tags:[{title:"param",type:{name:"mixed"},name:"tabId",description:"The ID of the clicked tab."}]},{name:"next",description:"Emitted when the user navigates to the next tab."},{name:"previous",description:"Emitted when the user navigates to the previous tab."},{name:"first",description:"Emitted when the user navigates to the first tab."},{name:"last",description:"Emitted when the user navigates to the last tab."}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/tabs/AvTabs/components/TabItem.vue"]};function Te(e,l,a){const n=g({"--tabs-height":"100px"});function u(){if(a.value<0||!e.value||!e.value.offsetHeight)return;const p=e.value.offsetHeight,c=l.value[a.value];if(!c||!c.offsetHeight)return;const o=c.offsetHeight;n.value["--tabs-height"]=`${p+o}px`}return{tabsStyle:n,updateTabsStyle:u}}const he=["aria-label"],R=x({__name:"AvTabs",props:oe({ariaLabel:{},compact:{type:Boolean,default:!1}},{modelValue:{default:0},modelModifiers:{}}),emits:["update:modelValue"],setup(e){const l=ie(),a=k(()=>{var t;return((t=l.default)==null?void 0:t.call(l))||[]}),n=le(e,"modelValue"),u=g(null),p=g(null),c=re({}),{tabsStyle:o,updateTabsStyle:m}=Te(p,k(()=>{var t;return Array.from(((t=u.value)==null?void 0:t.querySelectorAll(".av-tab-content"))||[])}),n);function d(t){if(c[t])return c[t];const i=`tab-${crypto.randomUUID()}`;return c[t]=i,i}function T(t){const i=a.value.length;n.value=(n.value+t+i)%i}function K(){T(-1)}function j(){T(1)}function Z(){n.value=0}function G(){n.value=a.value.length-1}const A=g(null);return ce(()=>{var t;window.ResizeObserver&&(A.value=new window.ResizeObserver(()=>{m()})),(t=u.value)==null||t.querySelectorAll(".av-tab-content").forEach(i=>{var r;i&&((r=A.value)==null||r.observe(i))})}),de(()=>{var t,i;(t=u.value)==null||t.querySelectorAll(".av-tab-content").forEach(r=>{var s;r&&((s=A.value)==null||s.unobserve(r))}),(i=A.value)==null||i.disconnect()}),(t,i)=>(b(),h("div",{ref_key:"$el",ref:u,class:y(["av-tabs",{"av-tabs--compact":e.compact}]),style:be(w(o))},[S("ul",{ref_key:"tablist",ref:p,class:y(["av-tabs__list av-row av-px-xs av-py-none av-align-center av-gap-sm av-list-reset av-radius-lg",{"av-tabs__list--compact":e.compact,"av-w-full":!e.compact}]),role:"tablist","aria-label":e.ariaLabel??"Liste d’onglets"},[(b(!0),h(E,null,q(w(a),(r,s)=>{var D,$;return b(),I(P,{key:s,"tab-id":d(s),"panel-id":`${d(s)}-panel`,title:(D=r.props)==null?void 0:D.title,icon:($=r.props)==null?void 0:$.icon,compact:e.compact,"is-selected":n.value===s,onClick:ge=>n.value=s,onNext:j,onPrevious:K,onFirst:Z,onLast:G},null,8,["tab-id","panel-id","title","icon","compact","is-selected","onClick"])}),128))],10,he),(b(!0),h(E,null,q(w(a),(r,s)=>(b(),I(O,{key:s,"panel-id":`${d(s)}-panel`,"tab-id":d(s),"is-visible":n.value===s},{default:ue(()=>[n.value===s?(b(),I(me(r.children.default),{key:0})):H("",!0)]),_:2},1032,["panel-id","tab-id","is-visible"]))),128))],6))}}),W=C(R,[["__scopeId","data-v-e74f88fe"]]);R.__docgenInfo={exportName:"default",displayName:"AvTabs",description:"",tags:{},props:[{name:"ariaLabel",description:`Aria label for tab list.
...
<p>
...
</p>`}}}},_=e=>({components:{AvTabs:W,AvTab:J,TabContent:O,TabItem:P},setup(){const l=g(0);return{args:e,activeTab:l}},template:`
  ...
  \`
})`,...(L=(N=v.parameters)==null?void 0:N.docs)==null?void 0:L.source}}};var V,z,B;f.parameters={...f.parameters,docs:{...(V=f.parameters)==null?void 0:V.docs,source:{originalSource:`args => ({
  components: {
    AvTabs,
    AvTab,
    TabContent,
