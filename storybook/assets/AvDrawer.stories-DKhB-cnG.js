import{A as L}from"./AvButton-BM5d_lLZ.js";import{d as M,U as W,W as V,b as p,f as g,e as v,a as D,Q as q,n as $,B as m,C as j,i as u,r as z}from"./iframe-CM3fYS2g.js";import{_ as K}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./vue-dsfr-keweR0Qw.js";import"./icons-DLnh1uvi.js";import"./preload-helper-ILsKNznc.js";const Q={key:0},G={key:0,class:"av-drawer-backdrop"},H=["aria-label"],J={class:"av-drawer__content-wrapper"},X={class:"av-drawer__content"},Z={key:0,class:"footer-container"},S=M({__name:"AvDrawer",props:{show:{type:Boolean},position:{default:"right"},width:{default:"35rem"},backdrop:{type:Boolean,default:!0},padding:{default:"var(--spacing-md)"},ariaLabel:{default:"Menu latéral"}},emits:["escapePressed"],setup(n,{emit:e}){j(c=>({b9426bca:m(P),v7249d1b4:m(F)}));const l=n,d=e,U=W(),{position:_,width:P,padding:F}=V(l);return(c,h)=>n.show?(u(),p("div",Q,[n.backdrop?(u(),p("div",G)):g("",!0),v("div",{class:$(["av-drawer",`av-drawer--${m(_)}`]),role:"dialog","aria-modal":"true","aria-label":n.ariaLabel,onKeydown:h[0]||(h[0]=q(ne=>d("escapePressed"),["esc"]))},[v("div",J,[v("div",X,[D(c.$slots,"default",{},void 0,!0)]),U.footer?(u(),p("div",Z,[D(c.$slots,"footer",{},void 0,!0)])):g("",!0)])],42,H)])):g("",!0)}}),w=K(S,[["__scopeId","data-v-4b1b7481"]]);S.__docgenInfo={exportName:"default",displayName:"AvDrawer",description:"",tags:{},props:[{name:"show",description:"Controls the visibility of the drawer",required:!0,type:{name:"boolean"}},{name:"position",description:"Position of the drawer on the screen",required:!1,type:{name:"union",elements:[{name:'"left"'},{name:'"right"'}]},defaultValue:{func:!1,value:"'right'"}},{name:"width",description:"Width of the drawer panel",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'35rem'"}},{name:"backdrop",description:"Whether to show the backdrop overlay, default true",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"padding",description:"Padding inside the drawer content area",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'var(--spacing-md)'"}},{name:"ariaLabel",description:"ARIA label for accessibility",tags:{default:[{description:"'Menu latéral'",title:"default"}]},required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'Menu latéral'"}}],events:[{name:"escapePressed",description:"Event triggered when escape is pressed."}],slots:[{name:"default",description:"Default slot for main content."},{name:"footer",description:"Footer slot for content under the main scrollable content."}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/overlay/drawers/AvDrawer/AvDrawer.vue"]};const le={title:"Components/Overlay/Drawers/AvDrawer",component:w,tags:["autodocs"],argTypes:{show:{control:"boolean"},position:{control:"select",options:["left","right"]},width:{control:"text"},backdrop:{control:"boolean"},padding:{control:"text"}},args:{show:!0,position:"right",width:"35rem",backdrop:!0,padding:"var(--spacing-md)"},parameters:{docs:{story:{height:"20rem"},description:{component:`<h1 class="n1">Drawers - <code>AvDrawer</code></h1>
...
<ul>
  ...
  \`
})`,...(Y=(I=s.parameters)==null?void 0:I.docs)==null?void 0:Y.source}}};const de=["Default","LeftPosition","WithoutBackdrop","CustomWidth","WithFooter"];export{o as CustomWidth,a as Default,r as LeftPosition,s as WithFooter,t as WithoutBackdrop,de as __namedExportsOrder,le as default};
