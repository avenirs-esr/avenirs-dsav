import{_ as Y}from"./AvTab-CALuXeXH.js";import{c as I,j as x,X as Z,E as A,G as H,$ as ee,L as te,u as f,m as u,T as ae,v as C,A as w,k as ne,W as se,r as T,a0 as oe,w as R,l as S,K as ie,C as re,H as le,y as ce,R as de,O as be,S as ue,e as me,o as pe,q as ve,F as E,B as F,z as fe,J as Te}from"./iframe-yBTjBEyE.js";import{_ as $}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{A as he}from"./AvIcon-CAAnQjhf.js";import"./preload-helper-ILsKNznc.js";function ge(e){const n={true:"100%",false:"-100%"},s=I(()=>e.value?n.true:n.false),a=I(()=>e.value?n.false:n.true);return{translateValueFrom:s,translateValueTo:a}}const ye=["id","aria-labelledby","tabindex"],M=x({__name:"TabContent",props:{panelId:{},tabId:{},isVisible:{type:Boolean},asc:{type:Boolean}},setup(e){te(r=>({v669d671c:f(s),v4357d543:f(a)}));const n=e,{translateValueFrom:s,translateValueTo:a}=ge(Z(n,"asc"));return(r,d)=>(u(),A(ee,{name:"slide-fade",mode:"in-out"},{default:H(()=>[ae(C("div",{id:e.panelId,class:w(["av-tab-content",{"av-tab-content--selected":e.isVisible}]),role:"tabpanel","aria-labelledby":e.tabId,tabindex:e.isVisible?0:-1},[ne(r.$slots,"default",{},void 0,!0)],10,ye),[[se,e.isVisible]])]),_:3}))}}),O=$(M,[["__scopeId","data-v-41de8f25"]]);M.__docgenInfo={exportName:"default",displayName:"TabContent",description:"",tags:{},props:[{name:"panelId",description:"ID of the associated tab panel.",required:!0,type:{name:"string"}},{name:"tabId",description:"ID of the tab item.",required:!0,type:{name:"string"}},{name:"isVisible",description:"Whether the tab content is visible.",required:!0,type:{name:"boolean"}},{name:"asc",description:`Direction of the tab transition animation.
