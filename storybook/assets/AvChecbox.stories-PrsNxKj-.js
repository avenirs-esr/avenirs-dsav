...
<ul class="b2-regular">
...
</ul>`}}}},e=Y=>({components:{AvCheckbox:O},setup(){const j=z([]);return{args:Y,model:j}},template:'<AvCheckbox v-bind="args" v-model="model" />'}),o=e.bind({});o.args={};const r=e.bind({});r.args={name:"with-icon-checkbox",label:"A checkbox with icon",icon:"mdi:home-variant-outline"};const n=e.bind({});n.args={name:"required-checkbox",label:"A required checkbox",required:!0};const s=e.bind({});s.args={name:"disabled-checkbox",label:"A disabled checkbox",disabled:!0};const a=e.bind({});a.args={name:"error-checkbox",label:"A checkbox with error",errorMessage:"An error has occured"};const t=e.bind({});t.args={name:"valid-checkbox",label:"A valid checkbox",validMessage:"Congratulations!"};const c=e.bind({});c.args={name:"hint-checkbox",label:"A checkbox with a hint",hint:"You should click this"};const l=e.bind({});l.args={name:"small-checkbox",label:"A small checkbox",small:!0};const d=e.bind({});d.args={name:"small-with-icon-checkbox",label:"A disabled checkbox with icon",small:!0,icon:"mdi:home-variant-outline"};const m=e.bind({});m.args={name:"small-required-checkbox",label:"A small required checkbox",small:!0,required:!0};var i,u,b;o.parameters={...o.parameters,docs:{...(i=o.parameters)==null?void 0:i.docs,source:{originalSource:`args => ({
  components: {
    AvCheckbox
  },
  setup() {
  ...
  template: \`<AvCheckbox v-bind="args" v-model="model" />\`
})`,...(g=(h=r.parameters)==null?void 0:h.docs)==null?void 0:g.source}}};var v,x,k;n.parameters={...n.parameters,docs:{...(v=n.parameters)==null?void 0:v.docs,source:{originalSource:`args => ({
  components: {
    AvCheckbox
  },
  setup() {
  ...
  template: \`<AvCheckbox v-bind="args" v-model="model" />\`
})`,...(k=(x=n.parameters)==null?void 0:x.docs)==null?void 0:k.source}}};var A,C,f;s.parameters={...s.parameters,docs:{...(A=s.parameters)==null?void 0:A.docs,source:{originalSource:`args => ({
  components: {
    AvCheckbox
  },
  setup() {
