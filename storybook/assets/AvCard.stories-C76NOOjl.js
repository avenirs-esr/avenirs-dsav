import{A as I}from"./AvButton-C5WGw7Ra.js";import{j as Y,O as $,r as x,l as i,K as p,T as z,z as f,A as V,u as t,k as u,E as M,W as R,v as j,m as r}from"./iframe-Du0WIMDe.js";import{M as v}from"./icons-Cf51SoRU.js";import{_ as K}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvIcon-DvoVtCV7.js";import"./string-BZgCOP9D.js";import"./preload-helper-ILsKNznc.js";const L={class:"av-card__content-collapsible"},G={key:0,class:"av-card__body"},J={key:1,class:"av-card__footer"},F=Y({__name:"AvCard",props:{backgroundColor:{default:"var(--card)"},borderColor:{default:"var(--stroke)"},titleBackground:{default:"var(--surface-background)"},titleHeight:{},collapsible:{type:Boolean,default:!1},collapsed:{type:Boolean,default:!1}},setup(e){const g=$(),a=x(e.collapsed);return(d,b)=>{const E=I;return r(),i("div",{class:"av-card",style:f({borderColor:e.borderColor,background:e.backgroundColor})},[g.title?(r(),i("div",{key:0,class:V(["av-card__title",{"av-card__title--collapsed":t(a)}]),style:f({background:e.titleBackground,height:e.titleHeight})},[u(d.$slots,"title",{},void 0,!0),e.collapsible?(r(),M(E,{key:0,icon:t(a)?t(v).CHEVRON_DOWN:t(v).CHEVRON_LEFT,"icon-only":"",label:"",onClick:b[0]||(b[0]=Q=>a.value=!t(a))},null,8,["icon"])):p("",!0)],6)):p("",!0),z(j("div",L,[u(d.$slots,"default",{},void 0,!0),g.body?(r(),i("div",G,[u(d.$slots,"body",{},void 0,!0)])):p("",!0),g.footer?(r(),i("div",J,[u(d.$slots,"footer",{},void 0,!0)])):p("",!0)],512),[[R,!e.collapsible||!t(a)]])],4)}}}),h=K(F,[["__scopeId","data-v-5225c453"]]);F.__docgenInfo={exportName:"default",displayName:"AvCard",description:"",tags:{},props:[{name:"backgroundColor",description:"The background color of the card.",tags:{default:[{description:"'var(--card)'",title:"default"}]},required:!1,type:{name:"string"}},{name:"borderColor",description:"The border color of the card.",tags:{default:[{description:"'var(--stroke)'",title:"default"}]},required:!1,type:{name:"string"}},{name:"titleBackground",description:"The background color of the card title.",tags:{default:[{description:"'var(--surface-background)'",title:"default"}]},required:!1,type:{name:"string"}},{name:"titleHeight",description:"The height of the card title.",required:!1,type:{name:"string"}},{name:"collapsible",description:`Whether the card is collapsible. When collapsed, the title is still shown.
...
<p>
  ...
  \`
})`,...(k=(y=o.parameters)==null?void 0:y.docs)==null?void 0:k.source}}};var A,T,_;n.parameters={...n.parameters,docs:{...(A=n.parameters)==null?void 0:A.docs,source:{originalSource:`args => ({
  components: {
    AvCard
  },
  setup() {
  ...
  \`
})`,...(_=(T=n.parameters)==null?void 0:T.docs)==null?void 0:_.source}}};var S,B,D;l.parameters={...l.parameters,docs:{...(S=l.parameters)==null?void 0:S.docs,source:{originalSource:`args => ({
  components: {
    AvCard
  },
  setup() {
  ...
  \`
})`,...(D=(B=l.parameters)==null?void 0:B.docs)==null?void 0:D.source}}};var W,H,N;s.parameters={...s.parameters,docs:{...(W=s.parameters)==null?void 0:W.docs,source:{originalSource:`args => ({
  components: {
    AvCard
  },
  setup() {
  ...
  \`
})`,...(N=(H=s.parameters)==null?void 0:H.docs)==null?void 0:N.source}}};var O,q,w;c.parameters={...c.parameters,docs:{...(O=c.parameters)==null?void 0:O.docs,source:{originalSource:`args => ({
  components: {
    AvCard
  },
  setup() {
