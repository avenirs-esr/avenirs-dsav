import{d as X,g as Y,b as f,n as b,f as g,o as u}from"./iframe-DRmKsEoR.js";import"./AvAccordion-DHHVnWJy.js";import"./AvAccordionsGroup-Y0tXGgu4.js";import{A as C}from"./AvButton-CxvG46Se.js";import"./AvRichButton-5fs0seRn.js";import"./AvFileUpload-nMndayZV.js";import"./AvInput-HK56OX_S.js";import"./AvListItem-BarOctjQ.js";import"./AvPageSizePicker-D-OEBl3U.js";import"./AvTagPicker-DwNMGP0R.js";import"./AvRadioButton-CSWzENMW.js";import"./AvRadioButtonSet-tgUG9wtb.js";import"./AvAutocomplete-BRdjwj6d.js";import"./AvMultiselect-0NMK0Y52.js";import"./AvSelect-CLF7ru6y.js";import"./AvTab-BJLlf5sQ.js";import"./AvTabs-DfbxOvE3.js";import"./AvToggle-BwdGDko-.js";import{M as v}from"./icons-DLnh1uvi.js";import{_ as Z}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-ILsKNznc.js";import"./vue-dsfr-C6dkiLOv.js";import"./AvVIcon-Bz_XRoTN.js";import"./string-BZgCOP9D.js";import"./AvIconText-DVQkl0gk.js";const $={class:"av-cancel-confirm-buttons-container"},P=X({__name:"AvCancelConfirmButtons",props:{cancelLabel:{},cancelIcon:{default:()=>v.CLOSE_CIRCLE_OUTLINE},cancelDisabled:{type:Boolean},cancelIsLoading:{type:Boolean},confirmLabel:{},confirmIcon:{default:()=>v.CLOSE_CIRCLE_OUTLINE},confirmDisabled:{type:Boolean},confirmIsLoading:{type:Boolean}},emits:["cancel","confirm"],setup(n,{emit:W}){const p=W;return(_,d)=>(u(),Y("div",$,[n.cancelLabel?(u(),f(g(C),{key:0,icon:n.cancelIcon,label:n.cancelLabel,title:n.cancelLabel,variant:"OUTLINED","is-loading":n.cancelIsLoading,disabled:n.cancelDisabled,size:"sm",onClick:d[0]||(d[0]=()=>p("cancel"))},null,8,["icon","label","title","is-loading","disabled"])):b("",!0),n.confirmLabel?(u(),f(g(C),{key:1,icon:n.confirmIcon,label:n.confirmLabel,title:n.confirmLabel,variant:"FLAT","is-loading":n.confirmIsLoading,disabled:n.confirmDisabled,size:"sm",onClick:d[1]||(d[1]=()=>p("confirm"))},null,8,["icon","label","title","is-loading","disabled"])):b("",!0)]))}}),Q=Z(P,[["__scopeId","data-v-b2b6579f"]]);P.__docgenInfo={exportName:"default",displayName:"AvCancelConfirmButtons",description:"",tags:{},props:[{name:"cancelLabel",description:"Label and title (for accessibility) of the cancel button.",required:!1,type:{name:"string"}},{name:"cancelIcon",description:"Icon name of the cancel button.",tags:{default:[{description:"'mdi:close-circle-outline'",title:"default"}]},required:!1,type:{name:"string"}},{name:"cancelDisabled",description:"Adds a disabled state on the cancel button.",required:!1,type:{name:"boolean"}},{name:"cancelIsLoading",description:"Adds a loading state on the cancel button.",required:!1,type:{name:"boolean"}},{name:"confirmLabel",description:"Label and title (for accessibility) of the confirm button.",required:!1,type:{name:"string"}},{name:"confirmIcon",description:"Icon name of the confirm button.",tags:{default:[{description:"'mdi:check-circle-outline'",title:"default"}]},required:!1,type:{name:"string"}},{name:"confirmDisabled",description:"Adds a disabled state on the confirm button.",required:!1,type:{name:"boolean"}},{name:"confirmIsLoading",description:"Adds a loading state on the confirm button.",required:!1,type:{name:"boolean"}}],events:[{name:"cancel"},{name:"confirm"}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/buttons/AvCancelConfirmButtons/AvCancelConfirmButtons.vue"]};const Sn={title:"Components/Interaction/Buttons/AvCancelConfirmButtons",component:Q,argTypes:{cancelLabel:{control:"text"},cancelIcon:{control:"text"},cancelDisabled:{control:"boolean"},cancelIsLoading:{control:"boolean"},confirmLabel:{control:"text"},confirmIcon:{control:"text"},confirmDisabled:{control:"boolean"},confirmIsLoading:{control:"boolean"}},args:{cancelLabel:"Cancel",cancelIcon:void 0,confirmLabel:"Confirm",confirmIcon:void 0},parameters:{docs:{description:{component:`<h2 class="n2">✨ Introduction</h2>
...
<ul>
  ...
  template: \`<AvCancelConfirmButtons v-bind="args" />\`
})`,...(R=(M=i.parameters)==null?void 0:M.docs)==null?void 0:R.source}}};var V,j,G;l.parameters={...l.parameters,docs:{...(V=l.parameters)==null?void 0:V.docs,source:{originalSource:`args => ({
  components: {
    AvCancelConfirmButtons
  },
  setup() {
  ...
  template: \`<AvCancelConfirmButtons v-bind="args" />\`
})`,...(G=(j=l.parameters)==null?void 0:j.docs)==null?void 0:G.source}}};var H,J,K;m.parameters={...m.parameters,docs:{...(H=m.parameters)==null?void 0:H.docs,source:{originalSource:`args => ({
  components: {
    AvCancelConfirmButtons
  },
  setup() {
  ...
  template: \`<AvCancelConfirmButtons v-bind="args" />\`
})`,...(K=(J=m.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};const On=["Default","CancelOnly","ConfirmOnly","CancelDisabled","ConfirmDisabled","BothDisabled","CancelLoading","ConfirmLoading","BothLoading"];export{c as BothDisabled,m as BothLoading,r as CancelDisabled,i as CancelLoading,o as CancelOnly,s as ConfirmDisabled,l as ConfirmLoading,t as ConfirmOnly,a as Default,On as __namedExportsOrder,Sn as default};
