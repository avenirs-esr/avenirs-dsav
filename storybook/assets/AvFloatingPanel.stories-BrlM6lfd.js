import{m as D,g as d,k as p,a4 as u,Y as M,H as g,d as s,N as k,W as T,R as W,f as B}from"./iframe-I7pj9E8z.js";import{A as E}from"./AvIconText-DHgMQbrz.js";import{A as Y}from"./AvCard-jNJR8We1.js";import{M as c}from"./icons-jAutzxlg.js";import{_ as q}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-ILsKNznc.js";import"./AvIcon-CspUcQd4.js";import"./icon-path-u9rVYwcY.js";import"./AvButton-jbZaoBc_.js";import"./string-BZgCOP9D.js";const U={class:"av-floating-panel","data-testid":"av-floating-panel"},V={class:"av-row av-gap-sm av-align-end","data-testid":"av-floating-panel-title"},L={class:"av-flex-fill"},j={key:0},H={class:"av-max-lines av-text-primary1 s2-light",style:{"--max-lines":"1"},"data-testid":"av-floating-panel-subtitle"},R={"data-testid":"av-floating-panel-content"},N=D({__name:"AvFloatingPanel",props:{title:{},subtitle:{},icon:{},defaultCollapsed:{type:Boolean,default:!0},width:{default:"var(--dimension-8xl)"}},setup(e){return M(r=>({v4d6b4b1a:r.width})),(r,$)=>(g(),d("div",U,[p(Y,{collapsible:"",collapsed:e.defaultCollapsed,role:"region","aria-label":e.title,"data-testid":"av-floating-panel-card"},{title:u(()=>[s("div",V,[s("div",L,[p(E,{icon:e.icon??T(c).CHAT_BUBBLE_OUTLINE,text:e.title,"icon-color":"var(--dark-background-primary1)","text-color":"var(--dark-background-primary1)",gap:"var(--spacing-sm)","typography-class":"s1-regular"},null,8,["icon","text"])]),e.subtitle?(g(),d("div",j,[s("span",H,W(e.subtitle),1)])):B("",!0)])]),default:u(()=>[s("div",R,[k(r.$slots,"default",{},void 0,!0)])]),_:3},8,["collapsed","aria-label"])]))}}),O=q(N,[["__scopeId","data-v-8f02bc49"]]);N.__docgenInfo={exportName:"default",displayName:"AvFloatingPanel",description:"",tags:{},props:[{name:"title",description:"Title displayed in the panel header.",required:!0,type:{name:"string"}},{name:"subtitle",description:"Subtitle displayed in the panel header.",required:!1,type:{name:"string"}},{name:"icon",description:"Icon name (MDI or other iconify icon) displayed next to the title.",required:!1,type:{name:"string"}},{name:"defaultCollapsed",description:"Controls the initial collapsed state of the panel.",tags:{default:[{description:"true",title:"default"}]},required:!1,type:{name:"boolean"}},{name:"width",description:"Width of the panel.",tags:{default:[{description:"'var(--dimension-8xl)'",title:"default"}]},required:!1,type:{name:"string"}}],slots:[{name:"default",description:"Main content of the panel."}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/overlay/panels/AvFloatingPanel/AvFloatingPanel.vue"]};const te={title:"Components/Overlay/FloatingPanel/AvFloatingPanel",component:O,argTypes:{title:{control:"text"},subtitle:{control:"text"},icon:{control:"text"},defaultCollapsed:{control:"boolean"},width:{control:"text"}},args:{title:"Contextual help",subtitle:"",icon:c.INFORMATION_OUTLINE,defaultCollapsed:!0,width:"var(--dimension-8xl)"},parameters:{docs:{story:{height:"28rem"},description:{component:`<h1 class="n1">Floating Panel - <code>AvFloatingPanel</code></h1>
...
<ul>
  ...
  \`
})`,...(S=(w=l.parameters)==null?void 0:w.docs)==null?void 0:S.source}}};const le=["Default","Expanded","WithSubtitle","WithSubtitleAndFitContent","WithouIcon"];export{o as Default,a as Expanded,n as WithSubtitle,t as WithSubtitleAndFitContent,l as WithouIcon,le as __namedExportsOrder,te as default};
