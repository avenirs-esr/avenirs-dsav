import{A as c}from"./AvTagPicker-Bl5XQBuT.js";import"./iframe-C-V1HFqN.js";import"./preload-helper-ILsKNznc.js";import"./AvTag-D9xf6WVr.js";import"./AvIcon-DTFenJdJ.js";import"./icon-path-u9rVYwcY.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvTooltip-CbkWw2gD.js";import"./icons-0dWeWY1j.js";const A={title:"Components/Interaction/Pickers/AvTagPicker",component:c,tags:["autodocs"],argTypes:{options:{type:{name:"AvTagPickerOption[]",required:!0},control:!1},label:{type:{name:"string"},control:"text"},labelColor:{type:{name:"string"},control:"text"},labelTypographyClass:{type:{name:"string"},control:"text"},multiple:{type:{name:"boolean"},control:"boolean"},selected:{type:{name:"AvTagPickerOption | AvTagPickerOption[]"},control:!1},handleSelectChange:{type:{name:"function",required:!0},control:!1,action:"select-change"}},args:{label:"Pick:"},parameters:{docs:{description:{component:`<h1 class="n1">Tag picker - <code>AvTagPicker</code></h1>
