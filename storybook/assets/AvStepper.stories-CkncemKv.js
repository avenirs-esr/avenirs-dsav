import{d as H,W as J,a,f as s,y as e,F as b,i as f,G as K,e as p,z as g,t as _}from"./iframe-DoGY7sZo.js";import{_ as M}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-ILsKNznc.js";const Q={class:"custom-width-container"},U={class:"block-container"},X={class:"main-container"},Y=["aria-current"],Z=["aria-current"],$={class:"b1-regular"},ee={class:"main-labels-container"},R=H({__name:"AvStepper",props:{steps:{},currentStep:{},width:{default:"100%"}},setup(m){K(P=>({v06d1bdf1:e(O)}));const G=m,{steps:v,currentStep:r,width:O}=J(G);return(P,S)=>(p(),a("div",Q,[s("div",U,[s("div",X,[s("div",{class:"step step--active","aria-current":e(r)===0?"step":void 0},[...S[0]||(S[0]=[s("span",{class:"b1-regular"},"1",-1)])],8,Y),(p(!0),a(b,null,f(e(v).slice(1,e(v).length),(h,t)=>(p(),a("div",{key:t,class:"steps-container"},[s("div",{class:g(["separator",{"separator--active":t+1<=e(r)}])},null,2),s("div",{class:g(["step",{"step--active":t+1<=e(r)}]),"aria-current":t+1===e(r)?"step":void 0},[s("span",$,_(t+2),1)],10,Z)]))),128))]),s("div",ee,[(p(!0),a(b,null,f(e(v),(h,t)=>(p(),a("div",{key:t,class:"label-container"},[s("span",{class:g(["label",{"b1-bold":t<=e(r),"b1-light":t>e(r)}])},_(h),3)]))),128))])])]))}}),j=M(R,[["__scopeId","data-v-26a5b40e"]]);R.__docgenInfo={exportName:"default",displayName:"AvStepper",description:"",tags:{},props:[{name:"steps",description:"List of steps to display in the stepper.",required:!0,type:{name:"Array",elements:[{name:"string"}]}},{name:"currentStep",description:"Index of the current step (starts at 0).",required:!0,type:{name:"number"}},{name:"width",description:"Width of the stepper.",tags:{default:[{description:"'100%'",title:"default"}]},required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'100%'"}}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/navigation/AvStepper/AvStepper.vue"]};const ne={title:"Components/Navigation/AvStepper",component:j,tags:["autodocs"],argTypes:{steps:{control:{type:"object",required:!0}},currentStep:{control:{type:"number",required:!0}},width:{control:"text"}},args:{steps:["Step 1: Init","Step 2: Develop a feature","Step 3: Deploy"],currentStep:0},parameters:{docs:{description:{component:`<h2 class="n2">✨ Introduction</h2>
...
<ul>
  ...
  template: \`<AvStepper v-bind="args" />\`
})`,...(N=(I=l.parameters)==null?void 0:I.docs)==null?void 0:N.source}}};var z,B,V;u.parameters={...u.parameters,docs:{...(z=u.parameters)==null?void 0:z.docs,source:{originalSource:`args => ({
  components: {
    AvStepper
  },
  setup() {
  ...
  template: \`<AvStepper v-bind="args" />\`
})`,...(V=(B=u.parameters)==null?void 0:B.docs)==null?void 0:V.source}}};var x,E,L;d.parameters={...d.parameters,docs:{...(x=d.parameters)==null?void 0:x.docs,source:{originalSource:`args => ({
  components: {
    AvStepper
  },
  setup() {
