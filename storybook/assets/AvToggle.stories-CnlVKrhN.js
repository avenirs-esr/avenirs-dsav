...
<p><span class="b2-regular">None.</span></p>`}}}},C=e=>({components:{AvToggle:c},setup(){return{args:e}},template:'<AvToggle v-bind="args" v-model="args.modelValue" />'}),n=C.bind({});n.args={};const o=C.bind({});o.args={modelValue:!0};const R=e=>({components:{AvToggle:c},setup(){return{args:e}},template:`<div :style="{width: '100px'}"><AvToggle v-bind="args" v-model="args.modelValue" /></div>`}),s=R.bind({});s.args={description:"A long description to see how this works"};var v,h,f;n.parameters={...n.parameters,docs:{...(v=n.parameters)==null?void 0:v.docs,source:{originalSource:`args => ({
  components: {
    AvToggle
  },
  setup() {
