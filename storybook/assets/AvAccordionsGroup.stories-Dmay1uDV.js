...
<p>
...
</p>`}}}},p=t=>({components:{AvAccordionsGroup:d,AvAccordion:k},setup(){return{args:t}},template:`
  ...
  `}),c=p.bind({});c.args={};const e=p.bind({});e.args={activeAccordion:0};const r=p.bind({});r.args={activeAccordion:1};var A,v,m;c.parameters={...c.parameters,docs:{...(A=c.parameters)==null?void 0:A.docs,source:{originalSource:`args => ({
  components: {
    AvAccordionsGroup,
    AvAccordion
  },
