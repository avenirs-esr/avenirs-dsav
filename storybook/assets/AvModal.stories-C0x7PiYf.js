...
<ul>
...
</ul>`}}}},Z=e=>({components:{AvModal:w,AvIconText:T,AvButton:M},setup(){const c=()=>alert("Clicked outside!"),a=h(e.opened);return{args:e,show:a,onClickOutside:c}},template:`
  ...
  `}),s=Z.bind({});s.args={};var y,C,A;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`args => ({
  components: {
    AvModal,
    AvIconText,
    AvButton
  ...
  \`
})`,...(A=(C=s.parameters)==null?void 0:C.docs)==null?void 0:A.source}}};const we=["Default"];export{s as Default,we as __namedExportsOrder,ke as default};
