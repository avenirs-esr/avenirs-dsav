import{A as w}from"./AvIcon-Cf7v-rIP.js";import{A as y}from"./AvIconText-CWzGtZXH.js";import{g as a,i as A}from"./storybook-BUZ3N58g.js";import"./iframe-B7ZjWHjt.js";import"./preload-helper-ILsKNznc.js";import"./icon-path-u9rVYwcY.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./icons-jAutzxlg.js";const I=["n1","n2","n3","n4","n5","n6","s1-bold","s1-regular","s1-light","s2-bold","s2-regular","s2-light","b1-bold","b1-regular","b1-light","b2-bold","b2-regular","b2-light","caption-bold","caption-regular","caption-light"],_={title:"Components/Base/AvIconText",component:y,tags:["autodocs"],argTypes:{textColor:{control:"color"},iconColor:{control:"color"},icon:{control:"select",options:a,mapping:A},text:{control:"text",type:{name:"string",required:!0}},typographyClass:{control:"select",options:["",...I]},gap:{control:"text"},inline:{control:"boolean"},wrapAnywhere:{control:"boolean"}},args:{textColor:"var(--text1)",iconColor:"var(--text1)",icon:a[0],text:"Example text with icon",typographyClass:"b2-regular",gap:"var(--spacing-xs)",inline:!1,wrapAnywhere:!1},parameters:{docs:{description:{component:`<h1 class="n1">Texts with icon - <code>AvIconText</code></h1>
...
<ul>
  ...
  \`
})`,...(x=(v=t.parameters)==null?void 0:v.docs)==null?void 0:x.source}}};const z=["Default","InlineNoEllipsis","CustomColors","WrapAnywhere"];export{o as CustomColors,n as Default,e as InlineNoEllipsis,t as WrapAnywhere,z as __namedExportsOrder,_ as default};
