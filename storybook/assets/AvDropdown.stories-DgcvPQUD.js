...
<ul>
  ...
  template: \`<AvDropdown v-bind="args" />\`
})`,...(Y=(z=m.parameters)==null?void 0:z.docs)==null?void 0:Y.source}}};var H,j,K;p.parameters={...p.parameters,docs:{...(H=p.parameters)==null?void 0:H.docs,source:{originalSource:`args => ({
  components: {
    AvDropdown
  },
  setup() {
