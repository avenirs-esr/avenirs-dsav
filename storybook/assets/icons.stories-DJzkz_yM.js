import"./AvFieldset-CYpig1IR.js";import"./AvFieldsetElement-D8fsg0hd.js";import{A as c}from"./AvIcon-C0rUoNVl.js";import"./AvIconText-FOBO4dK0.js";import"./AvNotice-BU1DHBpy.js";import{M as u,R as O,I as _}from"./icons-CvJnIbum.js";import"./AvMessage-BIctlDsD.js";import"./iframe-DMLTaAVQ.js";import"./preload-helper-ILsKNznc.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./string-BZgCOP9D.js";const L={title:"Foundations/3. DSAV icons"},r=()=>({components:{AvIcon:c},setup(){const e=Object.entries(u).map(([t,i])=>[`MDI_ICONS.${t}`,i]),n=Object.entries(O).map(([t,i])=>[`RI_ICONS.${t}`,i]),A=Object.entries(_).map(([t,i])=>[`ICONS_DATA_URL.${t}`,i]);return{icons:[...e,...n,...A]}},template:`
