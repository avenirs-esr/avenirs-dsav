...
<ul>
...
</ul>`}}}},Q=e=>({components:{AvModal:L,AvIconText:E,AvButton:D},setup(){const r=h(e.opened);return{args:e,show:r}},template:`
  ...
  `}),a=Q.bind({});a.args={};var A,C,I;a.parameters={...a.parameters,docs:{...(A=a.parameters)==null?void 0:A.docs,source:{originalSource:`args => ({
  components: {
    AvModal,
    AvIconText,
    AvButton
