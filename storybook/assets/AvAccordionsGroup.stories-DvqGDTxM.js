import{r as I,A as O}from"./AvAccordion-Cgx0sU6O.js";import{d as T,r as a,c as A,a as k,h as D,o as W,C,w as E,D as N}from"./iframe-DV6v5drW.js";import"./AvIcon-Bqvgb0Cd.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./use-collapsable-BH9l3Op8.js";import"./preload-helper-ILsKNznc.js";const B={class:"fr-accordions-group",role:"group","aria-label":"Accordion group"},d=T({__name:"AvAccordionsGroup",props:{activeAccordion:{}},emits:["update:activeAccordion"],setup(t,{emit:S}){const _=S,u=a(t.activeAccordion??-1),i=A({get:()=>u.value,set(n){u.value=n,_("update:activeAccordion",n)}}),s=a(new Map),w=a(0);return C(I,n=>{const o=w.value++;s.value.set(o,n.value);const x=A(()=>o===i.value);E(n,()=>{s.value.set(o,n.value)});function F(){if(i.value===o){i.value=-1;return}i.value=o}return N(()=>{s.value.delete(o)}),{isActive:x,expand:F}}),(n,o)=>(W(),k("div",B,[D(n.$slots,"default")]))}});d.__docgenInfo={exportName:"default",displayName:"AvAccordionsGroup",description:"",tags:{},props:[{name:"activeAccordion",description:"Index of the currently active accordion.",required:!1,type:{name:"number"}}],events:[{name:"update:activeAccordion",type:{names:["union"],elements:[{name:"number"},{name:"undefined"}]},description:"Emitted when the active accordion changes."}],slots:[{name:"default",description:"Default slot for passing `AvAccordion` components."}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/accordions/AvAccordionsGroup/AvAccordionsGroup.vue"]};const j={title:"Components/Interaction/Accordions/AvAccordionsGroup",component:d,tags:["autodocs"],argTypes:{activeAccordion:{control:{type:"number",min:0,max:2},description:"Index of the currently active accordion"}},args:{activeAccordion:void 0},parameters:{docs:{description:{component:`<h2 class="n2">✨ Introduction</h2>
...
<p>
  ...
  \`
})`,...(y=(b=r.parameters)==null?void 0:b.docs)==null?void 0:y.source}}};const H=["Default","WithFirstAccordionOpen","WithSecondAccordionOpen"];export{c as Default,e as WithFirstAccordionOpen,r as WithSecondAccordionOpen,H as __namedExportsOrder,j as default};
