import{A as v}from"./AvNotice-CKptAJqF.js";import"./AvIcon-49-Fyb5m.js";import"./iframe-Brfx2YmW.js";import"./preload-helper-ILsKNznc.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./icons-BZJLfc_p.js";import"./string-BZgCOP9D.js";const S={title:"Components/Base/AvNotice",component:v,tags:["autodocs"],argTypes:{title:{control:"text"},text:{control:"text"},type:{control:"radio",options:["info","warning","alert"],description:"The type of notice"}},args:{title:"Attention",text:"Please **read carefully** the instructions.",type:"warning"},parameters:{docs:{description:{component:`<h1 class="n1">Important information banner - <code>AvNotice</code></h1>
...
<ul>
...
})`,...(i=(r=e.parameters)==null?void 0:r.docs)==null?void 0:i.source}}};var c,l,p;t.parameters={...t.parameters,docs:{...(c=t.parameters)==null?void 0:c.docs,source:{originalSource:`args => ({
  components: {
    AvNotice
  },
  setup() {
  ...
  template: \`<AvNotice v-bind="args" />\`
})`,...(p=(l=t.parameters)==null?void 0:l.docs)==null?void 0:p.source}}};var d,u,m;a.parameters={...a.parameters,docs:{...(d=a.parameters)==null?void 0:d.docs,source:{originalSource:`args => ({
  components: {
    AvNotice
  },
  setup() {
  ...
  template: \`<AvNotice v-bind="args" />\`
})`,...(b=(f=n.parameters)==null?void 0:f.docs)==null?void 0:b.source}}};const O=["Default","InfoNotice","AlertNotice","WithoutTitle"];export{a as AlertNotice,e as Default,t as InfoNotice,n as WithoutTitle,O as __namedExportsOrder,S as default};
