...
<p>
  ...
  `}),u=v.bind({});u.args={};const p=v.bind({});p.args={backgroundColor:"var(--surface-background)",borderColor:"var(--other-border-skill-card)",titleBackground:"var(--light-background-primary1)",titleHeight:"var(--dimension-5xl)"};const m=ue.bind({});m.args={backgroundColor:"#fff4e5",borderColor:"#ff9900"};const b=v.bind({});b.args={collapsible:!0};const g=v.bind({});g.args={collapsible:!0,collapsed:!0};const f=v.bind({});f.args={titleOnly:!0};var D,H,I;u.parameters={...u.parameters,docs:{...(D=u.parameters)==null?void 0:D.docs,source:{originalSource:`args => ({
  components: {
    AvCard
  },
  setup() {
  ...
  \`
})`,...(L=(j=g.parameters)==null?void 0:j.docs)==null?void 0:L.source}}};var U,z,P;f.parameters={...f.parameters,docs:{...(U=f.parameters)==null?void 0:U.docs,source:{originalSource:`args => ({
  components: {
    AvCard
  },
  setup() {
  ...
  \`
})`,...(P=(z=f.parameters)==null?void 0:z.docs)==null?void 0:P.source}}};const ke=["Default","WithCustomColors","WithOnlyDefaultSlot","Collapsible","CollapsedByDefault","TitleOnly"];export{g as CollapsedByDefault,b as Collapsible,u as Default,f as TitleOnly,p as WithCustomColors,m as WithOnlyDefaultSlot,ke as __namedExportsOrder,ye as default};
