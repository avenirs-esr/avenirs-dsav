import{d as Pe,c as l,e as we,D as x,L as qe,u,E as C,f as A,M as Le,g as ke}from"./iframe-YyWxUzWH.js";import{c as D,t as be,A as P,p as Be,i as Ne}from"./AvInput-Y1dCczno.js";import{_ as Te}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-ILsKNznc.js";import"./AvMessage-DQRPF6qf.js";import"./AvIconText-yz8KScE8.js";import"./AvIcon-Mj4VcQrf.js";import"./icons-CvJnIbum.js";function We(e,o){let r,d=o==null?void 0:o.in;return e.forEach(t=>{!d&&typeof t=="object"&&(d=D.bind(null,t));const i=be(t,d);(!r||r<i||isNaN(+i))&&(r=i)}),D(d,r||NaN)}function Ye(e,o){let r,d=o==null?void 0:o.in;return e.forEach(t=>{!d&&typeof t=="object"&&(d=D.bind(null,t));const i=be(t,d);(!r||r>i||isNaN(+i))&&(r=i)}),D(d,r||NaN)}const Oe=["for"],he=Pe({__name:"AvPeriodInput",props:{id:{},label:{},labelClass:{default:"b2-light"},startModelValue:{default:""},endModelValue:{default:""},startLabel:{},endLabel:{},width:{},startMinDate:{},startMaxDate:{},endMinDate:{},endMaxDate:{},stacked:{type:Boolean,default:!1},separatorSpacing:{default:"var(--spacing-sm)"},endDateDisabled:{type:Boolean,default:!1},startDateDisabled:{type:Boolean,default:!1},type:{default:"date"},labelVisible:{type:Boolean,default:!0},startErrorMessage:{},endErrorMessage:{}},emits:["update:startModelValue","update:endModelValue","change"],setup(e,{emit:o}){Le(a=>({c7c0c816:a.separatorSpacing}));const r=o,d=l(()=>e.id??`period-input-${crypto.randomUUID()}`),t=l(()=>`${d.value}__start`),i=l(()=>`${d.value}__end`);function I(a){if(!a)return;const n=Be(a);return Ne(n)?n:void 0}function Ve(a,n){return a&&n?We([a,n]):a??n}function fe(a,n){return a&&n?Ye([a,n]):a??n}const ye=l(()=>I(e.startModelValue)),Ue=l(()=>I(e.endModelValue)),Se=l(()=>e.startMinDate),De=l(()=>fe(e.startMaxDate,Ue.value)),Ee=l(()=>Ve(e.endMinDate,ye.value)),Ce=l(()=>e.endMaxDate),Ie=l(()=>["av-label",{"av-hidden":!e.labelVisible},e.labelClass]);function xe(a){const n=(a==null?void 0:a.toString())??"";r("update:startModelValue",n),r("change",{start:n,end:e.endModelValue})}function Ae(a){const n=(a==null?void 0:a.toString())??"";r("update:endModelValue",n),r("change",{start:e.startModelValue,end:n})}return(a,n)=>(ke(),we("div",{class:C(["av-period-input av-col av-gap-xxs",{"av-period-input--stacked":e.stacked}])},[x("label",{class:C(u(Ie)),for:u(t),"data-testid":"common-label"},qe(e.label),11,Oe),x("div",{class:C(["av-period-input__row",{"av-row av-align-end":!e.stacked,"av-col av-align-stretch":e.stacked}])},[A(P,{id:u(t),type:e.type,"model-value":e.startModelValue,label:e.startLabel,"aria-label":e.startLabel,"label-visible":!1,disabled:e.startDateDisabled,width:e.width,"min-date":u(Se),"max-date":u(De),"error-message":e.startErrorMessage,"data-testid":"start-date-input","onUpdate:modelValue":n[0]||(n[0]=E=>xe(E))},null,8,["id","type","model-value","label","aria-label","disabled","width","min-date","max-date","error-message"]),A(P,{id:u(i),type:e.type,"model-value":e.endModelValue,label:e.endLabel,"aria-label":e.endLabel,"label-visible":!1,disabled:e.endDateDisabled,width:e.width,"min-date":u(Ee),"max-date":u(Ce),"error-message":e.endErrorMessage,"data-testid":"end-date-input","onUpdate:modelValue":n[1]||(n[1]=E=>Ae(E))},null,8,["id","type","model-value","label","aria-label","disabled","width","min-date","max-date","error-message"])],2)],2))}}),ve=Te(he,[["__scopeId","data-v-658fa9fb"]]);he.__docgenInfo={exportName:"default",displayName:"AvPeriodInput",description:"",tags:{},props:[{name:"id",description:"Unique id for the period input",tags:{default:[{description:"`period-input-${crypto.randomUUID()}`",title:"default"}]},required:!1,type:{name:"string"}},{name:"label",description:"Label displayed above the two inputs",required:!0,type:{name:"string"}},{name:"labelClass",description:"CSS class for the label",tags:{default:[{description:"'b2-light'",title:"default"}]},required:!1,type:{name:"string"}},{name:"startModelValue",description:"Start date value (ISO string: YYYY-MM-DD)",tags:{default:[{description:"''",title:"default"}]},required:!1,type:{name:"string"}},{name:"endModelValue",description:"End date value (ISO string: YYYY-MM-DD)",tags:{default:[{description:"''",title:"default"}]},required:!1,type:{name:"string"}},{name:"startLabel",description:`Label for the start input (optional).
...
<p>
  ...
  template: \`
    ...
    />
  \`
})`,...(ee=(_=v.parameters)==null?void 0:_.docs)==null?void 0:ee.source}}};var ae,ne,te;V.parameters={...V.parameters,docs:{...(ae=V.parameters)==null?void 0:ae.docs,source:{originalSource:`args => ({
  components: {
    AvPeriodInput
  },
  setup() {
  ...
  template: \`
    ...
    />
  \`
})`,...(te=(ne=V.parameters)==null?void 0:ne.docs)==null?void 0:te.source}}};var re,de,se;f.parameters={...f.parameters,docs:{...(re=f.parameters)==null?void 0:re.docs,source:{originalSource:`args => ({
  components: {
    AvPeriodInput
  },
  setup() {
