...
<p><span class="b2-regular">The <code>AvSelect</code> consists of a set of <code>&lt;option&gt;</code> within a <code>&lt;select&gt;</code>.</span></p>`}}}},a=e=>({components:{AvSelect:X},setup(){return{args:e}},template:'<AvSelect v-bind="args" v-model="args.modelValue" />'}),c=a.bind({});c.args={name:"default-select",label:"Select"};const u=a.bind({});u.args={name:"dense-select",dense:!0,label:"Dense Select"};const m=a.bind({});m.args={name:"disabled-select",disabled:!0,label:"Disabled Select"};const p=a.bind({});p.args={name:"required-select",required:!0,label:"Required Select"};const g=a.bind({});g.args={name:"hint-select",hint:"This is a hint message.",label:"Hint Select"};const f=a.bind({});f.args={name:"custom-placeholder-select",placeholder:"Please select an option",label:"Custom placeholder Select"};const v=a.bind({});v.args={name:"with-error-select",errorMessage:"This field is required.",label:"With error Select"};const b=a.bind({});b.args={name:"with-success-select",successMessage:"Selection successful!",label:"With success Select"};var C,M,I;c.parameters={...c.parameters,docs:{...(C=c.parameters)==null?void 0:C.docs,source:{originalSource:`args => ({
...
})`,...(I=(M=c.parameters)==null?void 0:M.docs)==null?void 0:I.source}}};var w,T,B;u.parameters={...u.parameters,docs:{...(w=u.parameters)==null?void 0:w.docs,source:{originalSource:`args => ({
  components: {
    AvSelect
  },
  setup() {
  ...
  template: \`<AvSelect v-bind="args" v-model="args.modelValue" />\`
})`,...(B=(T=u.parameters)==null?void 0:T.docs)==null?void 0:B.source}}};var W,$,N;m.parameters={...m.parameters,docs:{...(W=m.parameters)==null?void 0:W.docs,source:{originalSource:`args => ({
  components: {
    AvSelect
  },
  setup() {
  ...
  template: \`<AvSelect v-bind="args" v-model="args.modelValue" />\`
})`,...(N=($=m.parameters)==null?void 0:$.docs)==null?void 0:N.source}}};var R,U,k;p.parameters={...p.parameters,docs:{...(R=p.parameters)==null?void 0:R.docs,source:{originalSource:`args => ({
  components: {
    AvSelect
  },
  setup() {
  ...
  template: \`<AvSelect v-bind="args" v-model="args.modelValue" />\`
})`,...(P=(O=g.parameters)==null?void 0:O.docs)==null?void 0:P.source}}};var H,F,z;f.parameters={...f.parameters,docs:{...(H=f.parameters)==null?void 0:H.docs,source:{originalSource:`args => ({
  components: {
    AvSelect
  },
  setup() {
  ...
  template: \`<AvSelect v-bind="args" v-model="args.modelValue" />\`
})`,...(z=(F=f.parameters)==null?void 0:F.docs)==null?void 0:z.source}}};var K,L,j;v.parameters={...v.parameters,docs:{...(K=v.parameters)==null?void 0:K.docs,source:{originalSource:`args => ({
  components: {
    AvSelect
  },
  setup() {
  ...
  template: \`<AvSelect v-bind="args" v-model="args.modelValue" />\`
})`,...(j=(L=v.parameters)==null?void 0:L.docs)==null?void 0:j.source}}};var Y,G,J;b.parameters={...b.parameters,docs:{...(Y=b.parameters)==null?void 0:Y.docs,source:{originalSource:`args => ({
  components: {
    AvSelect
  },
  setup() {
