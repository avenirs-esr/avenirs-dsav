import{A as V}from"./AvButton-DJhlCexR.js";import{d as j,S as z,r as M,a as n,e as o,Q as R,D as v,x as L,u as t,y as g,b as Q,V as G,o as a}from"./iframe-BQ7qKONV.js";import{M as y}from"./icons-DLse1evt.js";import{_ as J}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvIcon-DsbNWGPN.js";import"./string-BZgCOP9D.js";import"./preload-helper-ILsKNznc.js";const K={key:1,class:"av-card__content-collapsible av-col av-justify-between av-h-full av-pt-sm av-gap-sm"},P={key:0,class:"av-card__body"},U={key:1,class:"av-card__footer"},E=j({__name:"AvCard",props:{titleOnly:{type:Boolean,default:!1},backgroundColor:{default:"var(--card)"},borderColor:{default:"var(--stroke)"},titleBackground:{default:"var(--surface-background)"},titleHeight:{},collapsible:{type:Boolean,default:!1},collapsed:{type:Boolean,default:!1}},setup(e){const b=z(),r=M(e.collapsed);return(m,f)=>{const $=V;return a(),n("div",{class:"av-card av-col av-p-sm av-justify-start",style:v({borderColor:e.borderColor,background:e.backgroundColor})},[b.title?(a(),n("div",{key:0,class:L(["av-card__title av-row av-align-center av-justify-between av-p-sm av-gap-sm",{"av-card__title--collapsed":t(r),"av-card__title--title-only":e.titleOnly}]),style:v({background:e.titleBackground,minHeight:e.titleHeight,maxHeight:e.titleHeight})},[g(m.$slots,"title",{},void 0,!0),!e.titleOnly&&e.collapsible?(a(),Q($,{key:0,icon:t(r)?t(y).CHEVRON_DOWN:t(y).CHEVRON_LEFT,"icon-only":"",label:"",onClick:f[0]||(f[0]=Z=>r.value=!t(r))},null,8,["icon"])):o("",!0)],6)):o("",!0),e.titleOnly?o("",!0):R((a(),n("div",K,[g(m.$slots,"default",{},void 0,!0),b.body?(a(),n("div",P,[g(m.$slots,"body",{},void 0,!0)])):o("",!0),b.footer?(a(),n("div",U,[g(m.$slots,"footer",{},void 0,!0)])):o("",!0)],512)),[[G,!e.collapsible||!t(r)]])],4)}}}),h=J(E,[["__scopeId","data-v-a65a28ed"]]);E.__docgenInfo={exportName:"default",displayName:"AvCard",description:"",tags:{},props:[{name:"titleOnly",description:"If true, the card will be displayed in title-only mode.",tags:{default:[{description:"false",title:"default"}]},required:!1,type:{name:"boolean"}},{name:"backgroundColor",description:"The background color of the card.",tags:{default:[{description:"'var(--card)'",title:"default"}]},required:!1,type:{name:"string"}},{name:"borderColor",description:"The border color of the card.",tags:{default:[{description:"'var(--stroke)'",title:"default"}]},required:!1,type:{name:"string"}},{name:"titleBackground",description:"The background color of the card title.",tags:{default:[{description:"'var(--surface-background)'",title:"default"}]},required:!1,type:{name:"string"}},{name:"titleHeight",description:"The height of the card title.",required:!1,type:{name:"string"}},{name:"collapsible",description:`Whether the card is collapsible. When collapsed, the title is still shown.
This requires a title slot to be provided.`,tags:{default:[{description:"false",title:"default"}]},required:!1,type:{name:"boolean"}},{name:"collapsed",description:"Whether the card is collapsed by default (only if collapsible is true).",tags:{default:[{description:"false",title:"default"}]},required:!1,type:{name:"boolean"}}],slots:[{name:"title",description:"Slot for the card title."},{name:"default",description:"Default slot for global content."},{name:"body",description:"Slot for the card body."},{name:"footer",description:"Slot for the card footer."}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/cards/AvCard/AvCard.vue"]};const se={title:"Components/Cards/AvCard",component:h,tags:["autodocs"],argTypes:{backgroundColor:{control:"color"},borderColor:{control:"color"},titleBackground:{control:"color"},titleHeight:{control:"text"},collapsible:{control:"boolean"},collapsed:{control:"boolean"}},args:{backgroundColor:"var(--card)",borderColor:"var(--stroke)",titleBackground:"var(--surface-background)",titleHeight:void 0,collapsible:!1,collapsed:!1},parameters:{docs:{description:{component:`<h1 class="n1">Cards - <code>AvCard</code></h1>
...
<p>
...
</p>`}}}},u=e=>({components:{AvCard:h},setup(){return{args:e}},template:`
    <AvCard v-bind="args">
      <template #title>
  ...
  `}),X=e=>({components:{AvCard:h},setup(){return{args:e}},template:`
    <AvCard v-bind="args">
  ...
  \`
})`,...(B=(S=s.parameters)==null?void 0:S.docs)==null?void 0:B.source}}};var O,D,_;c.parameters={...c.parameters,docs:{...(O=c.parameters)==null?void 0:O.docs,source:{originalSource:`args => ({
  components: {
    AvCard
  },
  setup() {
  ...
  \`
})`,...(_=(D=c.parameters)==null?void 0:D.docs)==null?void 0:_.source}}};var w,H,W;d.parameters={...d.parameters,docs:{...(w=d.parameters)==null?void 0:w.docs,source:{originalSource:`args => ({
  components: {
    AvCard
  },
  setup() {
  ...
  \`
})`,...(W=(H=d.parameters)==null?void 0:H.docs)==null?void 0:W.source}}};var q,F,I;i.parameters={...i.parameters,docs:{...(q=i.parameters)==null?void 0:q.docs,source:{originalSource:`args => ({
  components: {
    AvCard
  },
  setup() {
  ...
  \`
})`,...(I=(F=i.parameters)==null?void 0:F.docs)==null?void 0:I.source}}};var N,x,Y;p.parameters={...p.parameters,docs:{...(N=p.parameters)==null?void 0:N.docs,source:{originalSource:`args => ({
  components: {
    AvCard
  },
  setup() {
