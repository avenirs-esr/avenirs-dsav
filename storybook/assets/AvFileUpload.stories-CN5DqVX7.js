import{A as b}from"./AvIcon-Bfg3o1FR.js";import{_ as Q}from"./AvMessage-Ckvx0rXa.js";import{d as X,c as h,r as Z,e as p,i as y,l as o,k as _,m as w,u as t,N as ee,p as U,R as ae,P as ne,g as i,n as te,j as D,f as I,O as A,z as se}from"./iframe-BEyNThJa.js";import{A as le}from"./AvButton-Beyp3nCU.js";import{M as V}from"./icons-YGS6wEJ5.js";import{_ as oe}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./icon-path-u9rVYwcY.js";import"./AvIconText-Bk-1FX9L.js";import"./preload-helper-ILsKNznc.js";import"./string-BZgCOP9D.js";const ie={class:"av-row av-align-center av-gap-xs"},re={class:"left-content-container av-row av-align-center av-justify-center av-radius-md"},de={class:"content-container av-col"},pe={key:0},ce={class:"b2-bold"},ue={key:1,class:"av-col av-gap-xxs"},me={class:"b2-regular"},fe={class:"caption-light"},ge={key:0,class:"av-px-xs"},be=["id","aria-describedby","disabled","aria-disabled","accept"],ve={class:"caption-light"},R=X({inheritAttrs:!1,__name:"AvFileUpload",props:{id:{},ariaLabel:{default:""},accept:{default:()=>{}},error:{default:""},validMessage:{default:""},disabled:{type:Boolean,default:!1},modelValue:{default:null},maxWidth:{default:"none"},title:{},description:{},deleteButtonLabel:{default:"Remove"},fileName:{},onDeleteFile:{type:Function},enableMultiple:{type:Boolean,default:!1}},emits:["update:modelValue","update:validMessage","update:error","change","acceptTypeError"],setup(e,{emit:j}){ne(n=>({v25f2c89c:n.maxWidth}));const l=j,v=e.id??`file-upload-${crypto.randomUUID()}`,x=h(()=>Array.isArray(e.accept)?e.accept.join(","):e.accept),g=Z(!1);function T(n){const a=x.value;return a?a.split(",").map(s=>s.trim().toLowerCase()).some(s=>s.startsWith(".")?n.name.toLowerCase().endsWith(s):s.includes("/")?n.type===s||n.type.startsWith(`${s.split("/")[0]}/`):!1):!0}async function z(n){var d,s;if(n.preventDefault(),g.value=!1,e.disabled||!((s=(d=n.dataTransfer)==null?void 0:d.files)!=null&&s.length))return;const a=Array.from(n.dataTransfer.files).filter(T);await se(),a.length?(l("change",a),l("update:modelValue",a[0]??null)):l("acceptTypeError")}function H(n){n.preventDefault(),e.disabled||(g.value=!0)}function Y(){g.value=!1}function G(n){const a=n.target.files;if(a!=null&&a.length&&!Array.from(a).filter(T).length){l("acceptTypeError");return}l("change",a),l("update:modelValue",(a==null?void 0:a[0])??null)}const r=h(()=>e.fileName||e.modelValue&&!e.enableMultiple),J=h(()=>({for:v,class:["av-upload-group",{"av-upload-group--error":e.error,"av-upload-group--valid":e.validMessage,"av-upload-group--disabled":e.disabled,"drag-over":g.value}],"aria-label":e.ariaLabel,onDragover:H,onDragleave:Y,onDrop:z}));function K(n){var a;n?(l("update:modelValue",null),l("update:validMessage",null),l("update:error",null),l("change",[])):(a=e.onDeleteFile)==null||a.call(e)}return(n,a)=>{const d=Q;return i(),p(ae,null,[(i(),y(ee(t(r)?"div":"label"),w(t(r)?{}:t(J),{class:t(r)?"file-preview-container av-radius-lg av-p-xs":""}),{default:_(()=>[o("div",{class:te(t(r)?"":"file-upload-container av-radius-lg av-p-xs")},[o("div",ie,[o("div",re,[U(n.$slots,"left",{},()=>[I(b,{size:2.5,name:t(V).ATTACHMENT_PLUS,color:"var(--icon)"},null,8,["name"])],!0)]),o("div",de,[t(r)?(i(),p("div",pe,[o("span",ce,A(e.fileName||e.modelValue.name),1)])):(i(),p("div",ue,[o("span",me,A(e.title),1),o("span",fe,A(e.description),1)])),I(d,{type:e.error?"error":"success",message:e.error?e.error:e.validMessage},null,8,["type","message"])]),e.disabled?D("",!0):(i(),p("div",ge,[t(r)?(i(),y(le,{key:0,label:e.deleteButtonLabel,theme:"SECONDARY",onClick:a[0]||(a[0]=()=>K(e.modelValue))},null,8,["label"])):(i(),y(b,{key:1,size:1.5,name:t(V).TRAY_UPLOAD,color:"var(--dark-background-primary1)"},null,8,["name"]))])),t(r)?D("",!0):(i(),p("input",w({key:1,id:t(v),class:"av-upload",type:"file","aria-describedby":e.error||e.validMessage?`${t(v)}-desc`:void 0},n.$attrs,{disabled:e.disabled,"aria-disabled":e.disabled,accept:t(x),onChange:a[1]||(a[1]=s=>G(s))}),null,16,be))])],2)]),_:3},16,["class"])),o("span",ve,[U(n.$slots,"hint",{},void 0,!0)])],64)}}}),M=oe(R,[["__scopeId","data-v-e5c14747"]]);R.__docgenInfo={exportName:"default",displayName:"AvFileUpload",description:"",tags:{},props:[{name:"id",description:`Unique identifier for the file download component.
...
<p>
  ...
  `}),f=ye.bind({});f.args={leftImageSrc:he};var L,k,S;c.parameters={...c.parameters,docs:{...(L=c.parameters)==null?void 0:L.docs,source:{originalSource:`args => ({
  components: {
    AvFileUpload,
    AvIcon
  },
  ...
  \`
})`,...(W=(B=m.parameters)==null?void 0:B.docs)==null?void 0:W.source}}};var $,O,P;f.parameters={...f.parameters,docs:{...($=f.parameters)==null?void 0:$.docs,source:{originalSource:`args => ({
  components: {
    AvFileUpload,
    AvIcon
  },
  ...
  \`
})`,...(P=(O=f.parameters)==null?void 0:O.docs)==null?void 0:P.source}}};const ke=["Default","Error","Success","LeftSlot"];export{c as Default,u as Error,f as LeftSlot,m as Success,ke as __namedExportsOrder,Le as default};
