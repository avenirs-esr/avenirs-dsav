import{A as c}from"./AvVIcon-CpQItURD.js";import"./vue-dsfr-B20psRaW.js";import"./iframe-BxXJz-6C.js";import"./preload-helper-ILsKNznc.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const v={title:"Components/Base/AvVIcon",component:c,tags:["autodocs"],argTypes:{name:{control:"text",description:"Name of the icon (from VIcon naming convention)",type:{name:"string",required:!0}},size:{control:{type:"range",min:.5,max:5,step:.25},description:"Size in rem of the container and icon scale"},verticalAlign:{control:"text"},animation:{control:"select",options:["spin","wrench","pulse","spin-pulse","flash","float",void 0]},speed:{control:"radio",options:["fast","slow",void 0]},flip:{control:"radio",options:["horizontal","vertical","both",void 0]},color:{control:"color"},inverse:{control:"boolean"},label:{control:"text"},title:{control:"text"},ssr:{control:"boolean"}},args:{name:"mdi:check",size:2,verticalAlign:"-0.2em",animation:void 0,speed:void 0,flip:void 0,color:"#000000",inverse:!1,label:"Check icon",title:"Check",ssr:!0},parameters:{docs:{description:{component:`<h1 class="n1">Icons - <code>AvVIcon</code></h1>
