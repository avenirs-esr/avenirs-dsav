import{A as Ge}from"./AvIcon-C00em3Ax.js";import{A as T}from"./AvInput-jZ3vy0bt.js";import{C as Je}from"./icons-_H15CKU0.js";import{P as C,d as Fe}from"./iframe-ySlSybNg.js";import"./icon-path-u9rVYwcY.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvMessage-BkyIU1s8.js";import"./AvIconText-DLzq2rAh.js";import"./AvTooltip-DgwIpgPv.js";import"./use-text-truncation-BjHJ02TV.js";import"./format-AL68iITa.js";import"./parseISO-Bq0sW2Ur.js";import"./preload-helper-ILsKNznc.js";const ln={title:"Components/Interaction/Inputs/AvInput",component:T,tags:["autodocs"],argTypes:{hint:{control:"text"},isValid:{control:"boolean"},isTextarea:{control:"boolean"},labelVisible:{control:"boolean"},label:{control:"text"},labelClass:{control:"text"},modelValue:{control:"text"},placeholder:{control:"text"},type:{control:"select",options:["text","email","password","number","tel","url","search","date","datetime-local","month","time","week","color","file","hidden","range"]},minDate:{control:"date"},maxDate:{control:"date"},disabled:{control:"boolean"},required:{control:"boolean"},maxlength:{control:"number"},minlength:{control:"number"},errorMessage:{control:"text"},validMessage:{control:"text"},maxlengthExceededMessage:{control:"text"},prefixIcon:{control:"select",options:[void 0,"mdi:account-circle-outline","mdi:magnify","mdi:email-outline","mdi:lock-outline","mdi:phone-outline","mdi:calendar-outline","mdi:map-marker-outline"]},width:{control:"text"},formatDateStr:{control:"text"}},args:{label:"Input Label",placeholder:"Enter text here...",labelVisible:!0,type:"text",disabled:!1,required:!1,isValid:!1,isTextarea:!1,prefixIcon:void 0},parameters:{docs:{description:{component:`<h2 class="n2">✨ Introduction</h2>
...
<p>
  ...
  `});w.args={label:"Password",placeholder:"Enter your password"};var E,M,P;a.parameters={...a.parameters,docs:{...(E=a.parameters)==null?void 0:E.docs,source:{originalSource:`args => ({
  components: {
    AvInput
  },
  setup() {
  ...
  \`
})`,...(P=(M=a.parameters)==null?void 0:M.docs)==null?void 0:P.source}}};var W,L,N;t.parameters={...t.parameters,docs:{...(W=t.parameters)==null?void 0:W.docs,source:{originalSource:`args => ({
  components: {
    AvInput
  },
  setup() {
  ...
  \`
})`,...(Te=(Ce=V.parameters)==null?void 0:Ce.docs)==null?void 0:Te.source}}};var Ee,Me,Pe;b.parameters={...b.parameters,docs:{...(Ee=b.parameters)==null?void 0:Ee.docs,source:{originalSource:`args => ({
  components: {
    AvInput
  },
  setup() {
  ...
  \`
})`,...(Pe=(Me=b.parameters)==null?void 0:Me.docs)==null?void 0:Pe.source}}};var We,Le,Ne;A.parameters={...A.parameters,docs:{...(We=A.parameters)==null?void 0:We.docs,source:{originalSource:`args => ({
  components: {
    AvInput
  },
  setup() {
