import{A as Q}from"./AvDropdown-CljqmVhE.js";import{M as n}from"./icons-BJ4bGiUf.js";import"./iframe-Tmj36suw.js";import"./preload-helper-ILsKNznc.js";import"./AvButton-CpchSxpv.js";import"./AvTooltip-B4C9vfpJ.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvIcon-D79D3YL1.js";import"./icon-path-u9rVYwcY.js";import"./string-BZgCOP9D.js";import"./AvPopover-BQQXCexu.js";import"./focus-trap.esm-CPw4bcQR.js";const me={title:"Components/Overlay/Dropdowns/AvDropdown",component:Q,argTypes:{items:{control:"object"},triggerAriaLabel:{control:"text"},triggerIcon:{control:"text"},triggerLabel:{control:"text"},triggerVariant:{control:{type:"radio"},options:["DEFAULT","OUTLINED","FLAT"]},triggerSmall:{control:"boolean"},width:{control:"text"},padding:{control:"text"},itemSmall:{control:"boolean"},itemTheme:{control:{type:"radio"},options:["PRIMARY","SECONDARY"]},itemIconScale:{control:"number"}},args:{items:[{name:"edit",label:"Edit",icon:n.PENCIL_OUTLINE},{name:"delete",label:"Delete",icon:n.TRASH_CAN_OUTLINE},{name:"share",label:"Share",icon:n.LINK}],triggerAriaLabel:"Actions menu",triggerIcon:n.DOTS_VERTICAL,triggerLabel:void 0,triggerVariant:"OUTLINED",triggerSmall:!0,width:"15rem",padding:"var(--spacing-xs)",itemSmall:!0,itemTheme:"SECONDARY",itemIconScale:1.3},parameters:{docs:{description:{component:`<h1 class="n1">Dropdowns - <code>AvDropdown</code></h1>
