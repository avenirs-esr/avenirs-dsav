import{A as b}from"./AvIcon-D4HZJfn_.js";import{_ as Q}from"./AvMessage-BPyea9O5.js";import{d as X,c as h,r as Z,e as p,i as y,s as o,j as _,q as T,u as t,N as ee,l as w,R as ae,P as ne,g as i,t as te,p as U,f as D,O as A,z as se}from"./iframe-DuBRBV4Y.js";import{A as le}from"./AvButton-BJ8LTJzW.js";import{M as I}from"./icons-Bl054jz3.js";import{_ as oe}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./icon-path-u9rVYwcY.js";import"./AvIconText-CPJTgCHW.js";import"./preload-helper-ILsKNznc.js";import"./string-BZgCOP9D.js";const ie={class:"av-row av-align-center av-gap-xs"},re={class:"left-content-container av-row av-align-center av-justify-center av-radius-md"},de={class:"content-container av-col"},pe={key:0},ce={class:"b2-bold"},ue={key:1,class:"av-col av-gap-xxs"},me={class:"b2-regular"},fe={class:"caption-light"},ge={key:0,class:"av-px-xs"},be=["id","aria-describedby","disabled","aria-disabled","accept"],ve={class:"caption-light"},P=X({inheritAttrs:!1,__name:"AvFileUpload",props:{id:{},ariaLabel:{default:""},accept:{default:()=>{}},error:{default:""},validMessage:{default:""},disabled:{type:Boolean,default:!1},modelValue:{default:null},maxWidth:{default:"none"},title:{},description:{},deleteButtonLabel:{default:"Remove"},fileName:{},onDeleteFile:{type:Function},enableMultiple:{type:Boolean,default:!1}},emits:["update:modelValue","update:validMessage","update:error","change","onDropAcceptTypeError"],setup(e,{emit:R}){ne(a=>({v1f017175:a.maxWidth}));const l=R,v=e.id??`file-upload-${crypto.randomUUID()}`,x=h(()=>Array.isArray(e.accept)?e.accept.join(","):e.accept),g=Z(!1);function j(a){const n=x.value;return n?n.split(",").map(s=>s.trim().toLowerCase()).some(s=>s.startsWith(".")?a.name.toLowerCase().endsWith(s):s.includes("/")?a.type===s||a.type.startsWith(`${s.split("/")[0]}/`):!1):!0}async function z(a){var d,s;if(a.preventDefault(),g.value=!1,e.disabled||!((s=(d=a.dataTransfer)==null?void 0:d.files)!=null&&s.length))return;const n=Array.from(a.dataTransfer.files).filter(j);await se(),n.length?(l("change",n),l("update:modelValue",n[0]??null)):l("onDropAcceptTypeError")}function H(a){a.preventDefault(),e.disabled||(g.value=!0)}function Y(){g.value=!1}function G(a){const n=a.target.files;l("change",n),l("update:modelValue",(n==null?void 0:n[0])??null)}const r=h(()=>e.fileName||e.modelValue&&!e.enableMultiple),J=h(()=>({for:v,class:["av-upload-group",{"av-upload-group--error":e.error,"av-upload-group--valid":e.validMessage,"av-upload-group--disabled":e.disabled,"drag-over":g.value}],"aria-label":e.ariaLabel,onDragover:H,onDragleave:Y,onDrop:z}));function K(a){var n;a?(l("update:modelValue",null),l("update:validMessage",null),l("update:error",null),l("change",[])):(n=e.onDeleteFile)==null||n.call(e)}return(a,n)=>{const d=Q;return i(),p(ae,null,[(i(),y(ee(t(r)?"div":"label"),T(t(r)?{}:t(J),{class:t(r)?"file-preview-container av-radius-lg av-p-xs":""}),{default:_(()=>[o("div",{class:te(t(r)?"":"file-upload-container av-radius-lg av-p-xs")},[o("div",ie,[o("div",re,[w(a.$slots,"left",{},()=>[D(b,{size:2.5,name:t(I).ATTACHMENT_PLUS,color:"var(--icon)"},null,8,["name"])],!0)]),o("div",de,[t(r)?(i(),p("div",pe,[o("span",ce,A(e.fileName||e.modelValue.name),1)])):(i(),p("div",ue,[o("span",me,A(e.title),1),o("span",fe,A(e.description),1)])),D(d,{type:e.error?"error":"success",message:e.error?e.error:e.validMessage},null,8,["type","message"])]),e.disabled?U("",!0):(i(),p("div",ge,[t(r)?(i(),y(le,{key:0,label:e.deleteButtonLabel,theme:"SECONDARY",onClick:n[0]||(n[0]=()=>K(e.modelValue))},null,8,["label"])):(i(),y(b,{key:1,size:1.5,name:t(I).TRAY_UPLOAD,color:"var(--dark-background-primary1)"},null,8,["name"]))])),t(r)?U("",!0):(i(),p("input",T({key:1,id:t(v),class:"av-upload",type:"file","aria-describedby":e.error||e.validMessage?`${t(v)}-desc`:void 0},a.$attrs,{disabled:e.disabled,"aria-disabled":e.disabled,accept:t(x),onChange:n[1]||(n[1]=s=>G(s))}),null,16,be))])],2)]),_:3},16,["class"])),o("span",ve,[w(a.$slots,"hint",{},void 0,!0)])],64)}}}),M=oe(P,[["__scopeId","data-v-e5f26964"]]);P.__docgenInfo={exportName:"default",displayName:"AvFileUpload",description:"",tags:{},props:[{name:"id",description:`Unique identifier for the file download component.
...
<p>
  ...
  `}),f=ye.bind({});f.args={leftImageSrc:he};var V,L,S;c.parameters={...c.parameters,docs:{...(V=c.parameters)==null?void 0:V.docs,source:{originalSource:`args => ({
  components: {
    AvFileUpload,
    AvIcon
  },
  ...
  \`
})`,...(S=(L=c.parameters)==null?void 0:L.docs)==null?void 0:S.source}}};var k,q,C;u.parameters={...u.parameters,docs:{...(k=u.parameters)==null?void 0:k.docs,source:{originalSource:`args => ({
  components: {
    AvFileUpload,
    AvIcon
  },
  ...
  \`
})`,...(C=(q=u.parameters)==null?void 0:q.docs)==null?void 0:C.source}}};var N,E,B;m.parameters={...m.parameters,docs:{...(N=m.parameters)==null?void 0:N.docs,source:{originalSource:`args => ({
  components: {
    AvFileUpload,
    AvIcon
  },
  ...
  \`
})`,...(B=(E=m.parameters)==null?void 0:E.docs)==null?void 0:B.source}}};var W,$,O;f.parameters={...f.parameters,docs:{...(W=f.parameters)==null?void 0:W.docs,source:{originalSource:`args => ({
  components: {
    AvFileUpload,
    AvIcon
  },
  ...
  \`
})`,...(O=($=f.parameters)==null?void 0:$.docs)==null?void 0:O.source}}};const Se=["Default","Error","Success","LeftSlot"];export{c as Default,u as Error,f as LeftSlot,m as Success,Se as __namedExportsOrder,Le as default};
