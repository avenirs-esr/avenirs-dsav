import{A as s}from"./AvIcon-CspUcQd4.js";import{m as b,g as v,d as i,e as l,f as c,N as y,Y as R,H as a}from"./iframe-I7pj9E8z.js";import{_ as B}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{i as r,g as u}from"./storybook-BUZ3N58g.js";import"./icon-path-u9rVYwcY.js";import"./preload-helper-ILsKNznc.js";import"./icons-jAutzxlg.js";const k=["title","aria-label"],A={class:"av-rich-button__line av-row av-align-center av-w-full"},w={class:"av-rich-button__left av-row av-align-center av-w-full av-gap-sm av-pr-sm"},g=b({__name:"AvRichButton",props:{label:{},iconLeft:{default:()=>{}},iconRight:{default:()=>{}},customPadding:{default:"var(--spacing-sm)"}},emits:["click"],setup(t){return R(e=>({v2deb83d4:e.customPadding})),(e,o)=>(a(),v("button",{title:t.label,"aria-label":t.label,class:"av-rich-button av-row av-w-full av-align-center av-justify-between",onClick:o[0]||(o[0]=h=>e.$emit("click",h))},[i("div",A,[i("div",w,[t.iconLeft?(a(),l(s,{key:0,name:t.iconLeft,color:"var(--dark-background-primary1)",size:1.5},null,8,["name"])):c("",!0),y(e.$slots,"default",{},void 0,!0)]),t.iconRight?(a(),l(s,{key:0,name:t.iconRight,color:"var(--dark-background-primary1)",size:1.5},null,8,["name"])):c("",!0)])],8,k))}}),f=B(g,[["__scopeId","data-v-ff4425d7"]]);g.__docgenInfo={exportName:"default",displayName:"AvRichButton",description:"",tags:{},props:[{name:"label",description:"Button aria label and title for accessibility.",required:!0,type:{name:"string"}},{name:"iconLeft",description:`Icon displayed on the left of the button.
Must be an icon name.`,required:!1,type:{name:"string"}},{name:"iconRight",description:`Icon displayed on the right of the button.
Must be an icon name.`,required:!1,type:{name:"string"}},{name:"customPadding",description:"Allows you to change the padding of the button.",tags:{default:[{description:"'1rem'",title:"default"}]},required:!1,type:{name:"string"}}],events:[{name:"click",type:{names:["MouseEvent"]},description:"Emitted when the button is clicked."}],slots:[{name:"default",description:"Default slot for rich button content."}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/buttons/AvRichButton/AvRichButton.vue"]};const E={title:"Components/Interaction/Buttons/AvRichButton",component:f,tags:["autodocs"],argTypes:{label:{type:{name:"string",required:!0},control:"text"},iconLeft:{control:"select",options:u,mapping:r},iconRight:{control:"select",options:u,mapping:r}},args:{label:"Ckick me",iconLeft:"",iconRight:"",customPadding:"var(--spacing-sm)"},parameters:{docs:{description:{component:`<h1 class="n1">Rich buttons - <code>AvRichButton</code></h1>
...
</ul>`}}}},_=t=>({components:{AvRichButton:f,AvIcon:s},setup(){return{args:t}},template:`
