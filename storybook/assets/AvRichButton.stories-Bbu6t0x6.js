import{A as i}from"./AvVIcon-CpQItURD.js";import{A as a}from"./AvRichButton-C4mSKsEh.js";import"./vue-dsfr-B20psRaW.js";import"./iframe-BxXJz-6C.js";import"./preload-helper-ILsKNznc.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const g={title:"Components/Interaction/Buttons/AvRichButton",component:a,tags:["autodocs"],argTypes:{label:{type:{name:"string",required:!0},control:"text"},iconLeft:{control:"text"},iconRight:{control:"text"},customPadding:{control:"text"},onClick:{type:{name:"function"},control:!1,action:"click"}},args:{label:"Ckick me",iconLeft:"",iconRight:"",customPadding:"var(--spacing-sm)"},parameters:{docs:{description:{component:`<h1 class="n1">Rich buttons - <code>AvRichButton</code></h1>
