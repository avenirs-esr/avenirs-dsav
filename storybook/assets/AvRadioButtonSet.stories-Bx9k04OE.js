import{_ as j}from"./AvRadioButton-Cla7MdbH.js";import{d as $,U as G,c as J,r as K,x as h,k as b,w as y,z as W,B as s,i as c,b as X,F as S,j as Y,V as Z,M as ee}from"./iframe-DhY3rxPY.js";import{Q as ne,O as te}from"./vue-dsfr-CfU3oKsL.js";import"./preload-helper-ILsKNznc.js";const B=$({__name:"AvRadioButtonSet",props:{name:{},legend:{},modelValue:{type:[String,Number,Boolean]},disabled:{type:Boolean},required:{type:Boolean},small:{type:Boolean},inline:{type:Boolean},errorMessage:{},validMessage:{},hint:{}},emits:["update:modelValue"],setup(m,{expose:z,emit:U}){const t=m,L=U,v=G();function P(e){return e!=null&&typeof e=="object"&&"type"in e&&e.type===j}function f(e){return e?e.flatMap(n=>!n||typeof n!="object"||!("type"in n)?[]:n.type===S&&Array.isArray(n.children)?f(n.children):P(n)?[n]:[]):[]}const Q=J(()=>{var e;return f((e=v.default)==null?void 0:e.call(v))}),o=K(t.modelValue);return h(()=>t.modelValue,e=>{o.value=e}),h(o,e=>{e&&L("update:modelValue",e)}),z({selected:o}),(e,n)=>(c(),b(s(te),W(t,{"model-value":s(o)}),{default:y(()=>[(c(!0),X(S,null,Y(s(Q),(g,H)=>{var A,R;return c(),b(s(ne),{key:H,modelValue:s(o),"onUpdate:modelValue":n[0]||(n[0]=p=>Z(o)?o.value=p:null),value:(A=g.props)==null?void 0:A.value,disabled:((R=g.props)==null?void 0:R.disabled)??t.disabled,small:t.small,inline:t.inline,name:t.name},{label:y(()=>{var p;return[(c(),b(ee((p=g.children)==null?void 0:p.default)))]}),_:2},1032,["modelValue","value","disabled","small","inline","name"])}),128))]),_:1},16,["model-value"]))}});B.__docgenInfo={exportName:"default",displayName:"AvRadioButtonSet",description:"",tags:{},expose:[{name:"selected"}],props:[{name:"name",description:"Name of the radio group, applied to each radio `<input name>`.\nUsed for form submission and accessibility.",required:!0,type:{name:"string"}},{name:"legend",description:`Label (legend) for the radio group, rendered visually as a title.
