import{A as i}from"./AvIcon-DEMXgWn8.js";import{m as b,e as a,a4 as v,Y as y,H as o,d as s,w as R,f as r,N as A}from"./iframe-DnxxszEz.js";import{A as B}from"./AvTooltip-Dm57a0_W.js";import{_ as k}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{i as c,g as p}from"./storybook-uSYNO3Bs.js";import"./icon-path-u9rVYwcY.js";import"./preload-helper-ILsKNznc.js";import"./icons-B0BGqEX0.js";const w=["aria-label"],_={class:"av-rich-button__line av-row av-align-center av-w-full"},x={class:"av-rich-button__left av-row av-align-center av-w-full av-gap-sm av-pr-sm"},f=b({inheritAttrs:!1,__name:"AvRichButton",props:{label:{},iconLeft:{default:()=>{}},iconRight:{default:()=>{}},customPadding:{default:"var(--spacing-sm)"},enableTooltip:{type:Boolean,default:!1}},emits:["click"],setup(t){return y(e=>({v54a7d969:e.customPadding})),(e,l)=>(o(),a(B,{class:"av-rich-button__tooltip",content:t.label,"trigger-class":"av-w-full",disabled:!t.enableTooltip},{default:v(()=>[s("button",R(e.$attrs,{"aria-label":t.label,class:"av-rich-button av-row av-w-full av-align-center av-justify-between",onClick:l[0]||(l[0]=g=>e.$emit("click",g))}),[s("div",_,[s("div",x,[t.iconLeft?(o(),a(i,{key:0,name:t.iconLeft,color:"var(--dark-background-primary1)",size:1.5},null,8,["name"])):r("",!0),A(e.$slots,"default",{},void 0,!0)]),t.iconRight?(o(),a(i,{key:0,name:t.iconRight,color:"var(--dark-background-primary1)",size:1.5},null,8,["name"])):r("",!0)])],16,w)]),_:3},8,["content","disabled"]))}}),h=k(f,[["__scopeId","data-v-ceabd43a"]]);f.__docgenInfo={exportName:"default",displayName:"AvRichButton",description:"",tags:{},props:[{name:"label",description:"Button aria label and title for accessibility.",required:!0,type:{name:"string"}},{name:"iconLeft",description:`Icon displayed on the left of the button.
