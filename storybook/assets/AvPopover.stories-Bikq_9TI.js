import{A as ke}from"./AvButton-CiN78I55.js";import{r as z,o as De,b as Pe,C as me,d as Re,s as Oe,Y as Ce,a as oe,f as Ie,j as Be,g as se,A as k,v as Le,O as xe,n as Ke,z as je,Z as ze,J as Me,e as $}from"./iframe-CILu2PJe.js";import{_ as Ue}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvIcon-61O7I4yJ.js";import"./iconify-DEvsZX8U.js";import"./icons-DLnh1uvi.js";import"./string-BZgCOP9D.js";import"./preload-helper-ILsKNznc.js";function Ye(r,e){const t=z(!1),a=z({top:0,left:0}),s=async()=>{if(t.value=!t.value,t.value&&r.value){await me();const c=r.value.getBoundingClientRect(),v=c.bottom+window.scrollY+4;let m=c.left+window.scrollX;if(e.value){const w=e.value.getBoundingClientRect(),f=window.innerWidth;m+w.width>f&&(m=f-w.width-16,m<0&&(m=16))}a.value={top:v/16,left:m/16}}},l=()=>{t.value=!1},n=c=>{r.value&&!r.value.contains(c.target)&&l()};return De(()=>{document.addEventListener("click",n)}),Pe(()=>{document.removeEventListener("click",n)}),{showPopover:t,popoverPosition:a,togglePopover:s,closePopover:l}}/*!
* tabbable 6.2.0
* @license MIT, https://github.com/focus-trap/tabbable/blob/master/LICENSE
*/var he=["input:not([inert])","select:not([inert])","textarea:not([inert])","a[href]:not([inert])","button:not([inert])","[tabindex]:not(slot):not([inert])","audio[controls]:not([inert])","video[controls]:not([inert])",'[contenteditable]:not([contenteditable="false"]):not([inert])',"details>summary:first-of-type:not([inert])","details:not([inert])"],M=he.join(","),ge=typeof Element>"u",P=ge?function(){}:Element.prototype.matches||Element.prototype.msMatchesSelector||Element.prototype.webkitMatchesSelector,U=!ge&&Element.prototype.getRootNode?function(r){var e;return r==null||(e=r.getRootNode)===null||e===void 0?void 0:e.call(r)}:function(r){return r==null?void 0:r.ownerDocument},Y=function r(e,t){var a;t===void 0&&(t=!0);var s=e==null||(a=e.getAttribute)===null||a===void 0?void 0:a.call(e,"inert"),l=s===""||s==="true",n=l||t&&e&&r(e.parentNode);return n},_e=function(e){var t,a=e==null||(t=e.getAttribute)===null||t===void 0?void 0:t.call(e,"contenteditable");return a===""||a==="true"},ye=function(e,t,a){if(Y(e))return[];var s=Array.prototype.slice.apply(e.querySelectorAll(M));return t&&P.call(e,M)&&s.unshift(e),s=s.filter(a),s},we=function r(e,t,a){for(var s=[],l=Array.from(e);l.length;){var n=l.shift();if(!Y(n,!1))if(n.tagName==="SLOT"){var c=n.assignedElements(),v=c.length?c:n.children,m=r(v,!0,a);a.flatten?s.push.apply(s,m):s.push({scopeParent:n,candidates:m})}else{var w=P.call(n,M);w&&a.filter(n)&&(t||!e.includes(n))&&s.push(n);var f=n.shadowRoot||typeof a.getShadowRoot=="function"&&a.getShadowRoot(n),A=!Y(f,!1)&&(!a.shadowRootFilter||a.shadowRootFilter(n));if(f&&A){var E=r(f===!0?n.children:f.children,!0,a);a.flatten?s.push.apply(s,E):s.push({scopeParent:n,candidates:E})}else l.unshift.apply(l,n.children)}}return s},Te=function(e){return!isNaN(parseInt(e.getAttribute("tabindex"),10))},D=function(e){if(!e)throw new Error("No node provided");return e.tabIndex<0&&(/^(AUDIO|VIDEO|DETAILS)$/.test(e.tagName)||_e(e))&&!Te(e)?0:e.tabIndex},Ge=function(e,t){var a=D(e);return a<0&&t&&!Te(e)?0:a},Ve=function(e,t){return e.tabIndex===t.tabIndex?e.documentOrder-t.documentOrder:e.tabIndex-t.tabIndex},Ae=function(e){return e.tagName==="INPUT"},qe=function(e){return Ae(e)&&e.type==="hidden"},$e=function(e){var t=e.tagName==="DETAILS"&&Array.prototype.slice.apply(e.children).some(function(a){return a.tagName==="SUMMARY"});return t},We=function(e,t){for(var a=0;a<e.length;a++)if(e[a].checked&&e[a].form===t)return e[a]},He=function(e){if(!e.name)return!0;var t=e.form||U(e),a=function(c){return t.querySelectorAll('input[type="radio"][name="'+c+'"]')},s;if(typeof window<"u"&&typeof window.CSS<"u"&&typeof window.CSS.escape=="function")s=a(window.CSS.escape(e.name));else try{s=a(e.name)}catch(n){return console.error("Looks like you have a radio button with a name attribute containing invalid CSS selector characters and need the CSS.escape polyfill: %s",n.message),!1}var l=We(s,e.form);return!l||l===e},Ze=function(e){return Ae(e)&&e.type==="radio"},Xe=function(e){return Ze(e)&&!He(e)},Je=function(e){var t,a=e&&U(e),s=(t=a)===null||t===void 0?void 0:t.host,l=!1;if(a&&a!==e){var n,c,v;for(l=!!((n=s)!==null&&n!==void 0&&(c=n.ownerDocument)!==null&&c!==void 0&&c.contains(s)||e!=null&&(v=e.ownerDocument)!==null&&v!==void 0&&v.contains(e));!l&&s;){var m,w,f;a=U(s),s=(m=a)===null||m===void 0?void 0:m.host,l=!!((w=s)!==null&&w!==void 0&&(f=w.ownerDocument)!==null&&f!==void 0&&f.contains(s))}}return l},le=function(e){var t=e.getBoundingClientRect(),a=t.width,s=t.height;return a===0&&s===0},Qe=function(e,t){var a=t.displayCheck,s=t.getShadowRoot;if(getComputedStyle(e).visibility==="hidden")return!0;var l=P.call(e,"details>summary:first-of-type"),n=l?e.parentElement:e;if(P.call(n,"details:not([open]) *"))return!0;if(!a||a==="full"||a==="legacy-full"){if(typeof s=="function"){for(var c=e;e;){var v=e.parentElement,m=U(e);if(v&&!v.shadowRoot&&s(v)===!0)return le(e);e.assignedSlot?e=e.assignedSlot:!v&&m!==e.ownerDocument?e=m.host:e=v}e=c}if(Je(e))return!e.getClientRects().length;if(a!=="legacy-full")return!0}else if(a==="non-zero-area")return le(e);return!1},et=function(e){if(/^(INPUT|BUTTON|SELECT|TEXTAREA)$/.test(e.tagName))for(var t=e.parentElement;t;){if(t.tagName==="FIELDSET"&&t.disabled){for(var a=0;a<t.children.length;a++){var s=t.children.item(a);if(s.tagName==="LEGEND")return P.call(t,"fieldset[disabled] *")?!0:!s.contains(e)}return!0}t=t.parentElement}return!1},_=function(e,t){return!(t.disabled||Y(t)||qe(t)||Qe(t,e)||$e(t)||et(t))},H=function(e,t){return!(Xe(t)||D(t)<0||!_(e,t))},tt=function(e){var t=parseInt(e.getAttribute("tabindex"),10);return!!(isNaN(t)||t>=0)},at=function r(e){var t=[],a=[];return e.forEach(function(s,l){var n=!!s.scopeParent,c=n?s.scopeParent:s,v=Ge(c,n),m=n?r(s.candidates):c;v===0?n?t.push.apply(t,m):t.push(c):a.push({documentOrder:l,tabIndex:v,item:s,isScope:n,content:m})}),a.sort(Ve).reduce(function(s,l){return l.isScope?s.push.apply(s,l.content):s.push(l.content),s},[]).concat(t)},rt=function(e,t){t=t||{};var a;return t.getShadowRoot?a=we([e],t.includeContainer,{filter:H.bind(null,t),flatten:!1,getShadowRoot:t.getShadowRoot,shadowRootFilter:tt}):a=ye(e,t.includeContainer,H.bind(null,t)),at(a)},nt=function(e,t){t=t||{};var a;return t.getShadowRoot?a=we([e],t.includeContainer,{filter:_.bind(null,t),flatten:!0,getShadowRoot:t.getShadowRoot}):a=ye(e,t.includeContainer,_.bind(null,t)),a},R=function(e,t){if(t=t||{},!e)throw new Error("No node provided");return P.call(e,M)===!1?!1:H(t,e)},it=he.concat("iframe").join(","),W=function(e,t){if(t=t||{},!e)throw new Error("No node provided");return P.call(e,it)===!1?!1:_(t,e)};/*!
* focus-trap 7.6.5
...
Provides the prop:
- close: function to close the popover`}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/overlay/popovers/AvPopover/AvPopover.vue"]};const Ot={title:"Components/Overlay/Popovers/AvPopover",component:Ne,tags:["autodocs"],argTypes:{width:{control:"text"},padding:{control:"text"}},args:{width:"12.5rem",padding:"var(--spacing-md)"},parameters:{docs:{description:{component:`<h1 class="n1">Popovers - <code>AvPopover</code></h1>
...
<ul>
  ...
  `}),O=At.bind({});O.args={};O.parameters={docs:{source:{code:`
    <AvPopover
      v-bind="args"
    >
      <template #trigger="{ toggle }">
  ...
  `}}};var fe,pe,be;O.parameters={...O.parameters,docs:{...(fe=O.parameters)==null?void 0:fe.docs,source:{originalSource:`args => ({
  components: {
    AvPopover,
    AvButton
  },
  ...
  \`
})`,...(be=(pe=O.parameters)==null?void 0:pe.docs)==null?void 0:be.source}}};const Ct=["Default"];export{O as Default,Ct as __namedExportsOrder,Ot as default};
