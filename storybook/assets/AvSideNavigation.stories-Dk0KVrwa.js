import{A as d}from"./AvSideNavigation-DLFo3zd7.js";import{M as i}from"./icons-DyiNu08W.js";import{r as e}from"./iframe-CUmNOF4m.js";import"./AvCheckboxListItem-LtgWb1Yr.js";import"./AvList-DMJ1rqRb.js";import"./AvIcon-BRiWnYCu.js";import"./icon-path-u9rVYwcY.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvCheckbox-CBIi_smP.js";import"./AvFieldsetElement-BbBINke4.js";import"./AvMessage-Cla_P9Hl.js";import"./AvIconText-67Jc2cO2.js";import"./AvSideMenu-BpWukfMr.js";import"./AvButton-Cq9FbOXN.js";import"./string-BZgCOP9D.js";import"./preload-helper-ILsKNznc.js";const R=[{id:"careers",label:"Career Information",icon:i.BRIEFCASE_VARIANT_OUTLINE},{id:"educations",label:"Educational Background",icon:i.SCHOOL_OUTLINE},{id:"experiences",label:"Professional Experience",icon:i.VECTOR_POLYGON_VARIANT},{id:"activities",label:"Activities & Projects",icon:i.TARGET_ARROW}],k=[{id:"default",label:"Default item",icon:i.BRIEFCASE_VARIANT_OUTLINE},{id:"menu-expanded",label:"Menu Expanded",icon:i.SCHOOL_OUTLINE,children:[{id:"subitem-1-1",label:"Subitem 1-1",icon:i.CHEVRON_RIGHT},{id:"subitem-1-2",label:"Subitem 1-2"},{id:"subitem-1-3",label:"Subitem 1-3",icon:i.CHEVRON_RIGHT}],expanded:!0},{id:"collapsed-menu",label:"Collapsed Menu",icon:i.VECTOR_POLYGON_VARIANT,children:[{id:"subitem-2-1",label:"Subitem 2-1",icon:i.CHEVRON_RIGHT},{id:"subitem-2-2",label:"Subitem 2-2",icon:i.CHEVRON_RIGHT}]}],q={title:"Components/Navigation/AvSideNavigation",component:d,tags:["autodocs"],argTypes:{items:{control:{type:"object"}},width:{control:{type:"text"}},collapsedWidth:{control:{type:"text"}},selectedItem:{control:{type:"object"}},isSideMenuCollapsed:{control:{type:"boolean"}}},args:{items:R,collapsedWidth:"3.5rem",width:"fit-content"},parameters:{docs:{description:{component:`<h1 class="n1">Navigation - <code>AvSideNavigation</code></h1>
