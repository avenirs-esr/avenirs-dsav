...
<p>
...
</p>`}}}},T=e=>({components:{AvFileUpload:x,AvIcon:b},setup(){return{args:e}},template:`
  ...
  `}),c=T.bind({});c.args={};const u=T.bind({});u.args={error:"This is an error message"};const m=T.bind({});m.args={validMessage:"This is a success message"};const Ae=e=>({components:{AvFileUpload:x,AvIcon:b},setup(){return{args:e}},template:`
    <AvFileUpload v-bind="args">
      <template #left>
        <img
  ...
  `}),f=Ae.bind({});f.args={leftImageSrc:ye};var D,L,V;c.parameters={...c.parameters,docs:{...(D=c.parameters)==null?void 0:D.docs,source:{originalSource:`args => ({
  components: {
    AvFileUpload,
    AvIcon
  },
  ...
  \`
})`,...(V=(L=c.parameters)==null?void 0:L.docs)==null?void 0:V.source}}};var C,E,S;u.parameters={...u.parameters,docs:{...(C=u.parameters)==null?void 0:C.docs,source:{originalSource:`args => ({
  components: {
    AvFileUpload,
    AvIcon
  },
