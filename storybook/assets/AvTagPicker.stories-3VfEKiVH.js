import{A as c}from"./AvTagPicker-BfKJiyxv.js";import"./iframe-DSlEl8eq.js";import"./preload-helper-ILsKNznc.js";import"./AvTag-bXOpBJYq.js";import"./AvIcon-D64V8ePC.js";import"./icon-path-u9rVYwcY.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvTooltip-RrE9taMo.js";import"./icons-BJ4bGiUf.js";const A={title:"Components/Interaction/Pickers/AvTagPicker",component:c,tags:["autodocs"],argTypes:{options:{type:{name:"AvTagPickerOption[]",required:!0},control:!1},label:{type:{name:"string"},control:"text"},labelColor:{type:{name:"string"},control:"text"},labelTypographyClass:{type:{name:"string"},control:"text"},multiple:{type:{name:"boolean"},control:"boolean"},selected:{type:{name:"AvTagPickerOption | AvTagPickerOption[]"},control:!1},handleSelectChange:{type:{name:"function",required:!0},control:!1,action:"select-change"}},args:{label:"Pick:"},parameters:{docs:{description:{component:`<h1 class="n1">Tag picker - <code>AvTagPicker</code></h1>
...
<ul>
  ...
  template: \`<AvTagPicker v-bind="args" />\`
})`,...(s=(r=n.parameters)==null?void 0:r.docs)==null?void 0:s.source}}};const k=["Default","Multiple"];export{e as Default,n as Multiple,k as __namedExportsOrder,A as default};
