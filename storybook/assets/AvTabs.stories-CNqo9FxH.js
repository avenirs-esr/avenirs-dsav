import{_ as Y}from"./AvTab-CpjSeRWd.js";import{m as Z,Y as j,Z as O}from"./vue-dsfr-IN64CnFq.js";import{d as Q,N as R,r as X,c as G,s as f,j as d,w as p,B as A,X as H,A as u,e as o,a as g,F as h,i as y,Q as J,l as K,t as M}from"./iframe-D7OPTHdM.js";import{_ as W}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./iconify-CG-Oriw0.js";import"./preload-helper-ILsKNznc.js";const C=Q({__name:"AvTabs",props:{ariaLabel:{},modelValue:{},compact:{type:Boolean,default:!1}},emits:["update:modelValue"],setup(n,{expose:L,emit:D}){const N=D,m=R(),e=X(n.modelValue),r=G(()=>{var a;return((a=m.default)==null?void 0:a.call(m))||[]});function v(a){const i=r.value.length;e.value=(e.value+a+i)%i}function $(){v(-1)}function B(){v(1)}function q(){e.value=0}function E(){e.value=r.value.length-1}return f(()=>n.modelValue,a=>{a!==void 0&&(e.value=a)}),f(e,a=>{N("update:modelValue",a)}),L({activeTab:e}),(a,i)=>{const z=O,P=j,U=Z;return o(),d(U,{modelValue:u(e),"onUpdate:modelValue":i[0]||(i[0]=s=>H(e)?e.value=s:null),class:A({compact:n.compact}),"tab-list-name":n.ariaLabel??"Liste d’onglets","tab-titles":[]},{"tab-items":p(()=>[(o(!0),g(h,null,y(u(r),(s,t)=>{var T;return o(),d(z,{key:t,class:A({compact:n.compact}),"tab-id":`tab-${t}`,"panel-id":`panel-${t}`,icon:(T=s.props)==null?void 0:T.icon,onClick:b=>e.value=t,onNext:B,onPrevious:$,onFirst:q,onLast:E},{default:p(()=>{var b;return[K(M((b=s.props)==null?void 0:b.title),1)]}),_:2},1032,["class","tab-id","panel-id","icon","onClick"])}),128))]),default:p(()=>[(o(!0),g(h,null,y(u(r),(s,t)=>(o(),d(P,{key:t,"panel-id":`panel-${t}`,"tab-id":`tab-${t}`},{default:p(()=>[(o(),d(J(s.children.default)))]),_:2},1032,["panel-id","tab-id"]))),128))]),_:1},8,["modelValue","class","tab-list-name"])}}}),F=W(C,[["__scopeId","data-v-dbd71c5f"]]);C.__docgenInfo={exportName:"default",displayName:"AvTabs",description:"",tags:{},expose:[{name:"activeTab"}],props:[{name:"ariaLabel",description:`Aria label for tab list.
