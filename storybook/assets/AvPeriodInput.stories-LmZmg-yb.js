import{_ as Xn}from"./AvRadioButtonSet-ChQ_US4i.js";import{_ as Yn}from"./AvRadioButton-ipDmuCdb.js";import{d as Zn,c as l,e as k,j as _n,l as w,u as i,n as x,O as B,f as W,i as N,k as T,P as ne,g as f}from"./iframe-ClCoZ6qS.js";import{c as A,t as Bn,A as O,p as ee,i as ae}from"./AvInput-vUSX1eLu.js";import{_ as te}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvFieldset-PpNGnsBR.js";import"./AvMessage-ByC_vN_g.js";import"./AvIconText-DA_D-JrW.js";import"./AvIcon-umASlqEW.js";import"./icon-path-u9rVYwcY.js";import"./icons-DbhiiYtW.js";import"./AvFieldsetElement-CzYe_O_L.js";import"./preload-helper-ILsKNznc.js";function re(n,s){let o,d=s==null?void 0:s.in;return n.forEach(t=>{!d&&typeof t=="object"&&(d=A.bind(null,t));const u=Bn(t,d);(!o||o<u||isNaN(+u))&&(o=u)}),A(d,o||NaN)}function oe(n,s){let o,d=s==null?void 0:s.in;return n.forEach(t=>{!d&&typeof t=="object"&&(d=A.bind(null,t));const u=Bn(t,d);(!o||o>u||isNaN(+u))&&(o=u)}),A(d,o||NaN)}const de=["for"],se={class:"b2-regular"},Wn=Zn({__name:"AvPeriodInput",props:{id:{},labelClass:{default:"b2-light"},startModelValue:{default:""},endModelValue:{default:""},width:{},startMinDate:{},startMaxDate:{},endMinDate:{},endMaxDate:{},stacked:{type:Boolean,default:!1},separatorSpacing:{default:"var(--spacing-sm)"},endDateDisabled:{type:Boolean,default:!1},startDateDisabled:{type:Boolean,default:!1},type:{default:"date"},labelVisible:{type:Boolean,default:!0},startErrorMessage:{},endErrorMessage:{},ongoingLabel:{},showEachInputLabel:{type:Boolean,default:!1},startLabel:{},endLabel:{},label:{}},emits:["update:startModelValue","update:endModelValue","change"],setup(n,{emit:s}){ne(e=>({v2187bf28:e.separatorSpacing}));const o=s,d=l(()=>n.id??`period-input-${crypto.randomUUID()}`),t=l(()=>`${d.value}__start`),u=l(()=>`${d.value}__end`);function L(e){if(!e)return;const a=ee(e);return ae(a)?a:void 0}function Tn(e,a){return e&&a?re([e,a]):e??a}function On(e,a){return e&&a?oe([e,a]):e??a}const jn=l(()=>L(n.startModelValue)),$n=l(()=>L(n.endModelValue)),Rn=l(()=>n.startMinDate),Fn=l(()=>On(n.startMaxDate,$n.value)),Hn=l(()=>Tn(n.endMinDate,jn.value)),zn=l(()=>n.endMaxDate),qn=l(()=>["av-label",{"av-sr-only":!n.labelVisible},n.labelClass]);function Gn(e){const a=(e==null?void 0:e.toString())??"";o("update:startModelValue",a),o("change",{start:a,end:n.endModelValue})}function Jn(e){const a=(e==null?void 0:e.toString())??"";o("update:endModelValue",a),o("change",{start:n.startModelValue,end:a})}return(e,a)=>{const Kn=Yn,Qn=Xn;return f(),k("div",{class:x(["av-period-input av-col av-gap-xxs",{"av-period-input--stacked":n.stacked}])},[n.showEachInputLabel?_n("",!0):(f(),k("label",{key:0,class:x(i(qn)),for:i(t),"data-testid":"common-label"},B(n.label),11,de)),w("div",{class:x(["av-period-input__row",{"av-row av-align-start":!n.stacked,"av-col av-align-stretch":n.stacked}])},[W(O,{id:i(t),type:n.type,"model-value":n.startModelValue,label:n.startLabel,"aria-label":n.startLabel,"label-visible":n.showEachInputLabel,disabled:n.startDateDisabled,width:n.width,"min-date":i(Rn),"max-date":i(Fn),"error-message":n.startErrorMessage,"data-testid":"start-date-input","onUpdate:modelValue":a[0]||(a[0]=P=>Gn(P))},null,8,["id","type","model-value","label","aria-label","label-visible","disabled","width","min-date","max-date","error-message"]),!n.endModelValue&&n.endDateDisabled&&n.ongoingLabel?(f(),N(Qn,{key:0,"model-value":"ongoing",name:"ongoing",inline:"",small:""},{default:T(()=>[W(Kn,{value:"ongoing",disabled:""},{default:T(()=>[w("div",null,[w("span",se,B(n.ongoingLabel),1)])]),_:1})]),_:1})):(f(),N(O,{key:1,id:i(u),type:n.type,"model-value":n.endModelValue,label:n.endLabel,"aria-label":n.endLabel,"label-visible":n.showEachInputLabel,disabled:n.endDateDisabled,width:n.width,"min-date":i(Hn),"max-date":i(zn),"error-message":n.endErrorMessage,"data-testid":"end-date-input","onUpdate:modelValue":a[1]||(a[1]=P=>Jn(P))},null,8,["id","type","model-value","label","aria-label","label-visible","disabled","width","min-date","max-date","error-message"]))],2)],2)}}}),Nn=te(Wn,[["__scopeId","data-v-9312dc75"]]);Wn.__docgenInfo={exportName:"default",displayName:"AvPeriodInput",description:"",tags:{},events:[{name:"update:startModelValue",type:{names:["string"]}},{name:"update:endModelValue",type:{names:["string"]}},{name:"change",type:{names:["{ start: string, end: string }"]}}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/inputs/AvPeriodInput/AvPeriodInput.vue"]};const Se={title:"Components/Interaction/Inputs/AvPeriodInput",component:Nn,tags:["autodocs"],argTypes:{id:{control:"text"},label:{control:"text"},labelClass:{control:"text"},labelVisible:{control:"boolean"},startModelValue:{control:"text"},endModelValue:{control:"text"},startErrorMessage:{control:"text"},endErrorMessage:{control:"text"},showEachInputLabel:{control:"boolean"},startLabel:{control:"text"},endLabel:{control:"text"},startDateDisabled:{control:"boolean"},endDateDisabled:{control:"boolean"},width:{control:"text"},startMinDate:{control:"object"},startMaxDate:{control:"object"},endMinDate:{control:"object"},endMaxDate:{control:"object"},stacked:{control:"boolean"},separatorSpacing:{control:"text"},type:{control:"select",options:["date","datetime-local","month","time","week"]}},args:{label:"Period",startModelValue:"",endModelValue:"",startErrorMessage:"",endErrorMessage:"",showEachInputLabel:!1,startDateDisabled:!1,endDateDisabled:!1,stacked:!1,separatorSpacing:"var(--spacing-sm)",type:"date",labelVisible:!0},parameters:{docs:{description:{component:`<h2 class="n2">✨ Introduction</h2>
...
<p>
  ...
  template: \`
    ...
    />
  \`
})`,...(fn=(Cn=D.parameters)==null?void 0:Cn.docs)==null?void 0:fn.source}}};var An,Pn,wn;I.parameters={...I.parameters,docs:{...(An=I.parameters)==null?void 0:An.docs,source:{originalSource:`args => ({
  components: {
    AvPeriodInput
  },
  setup() {
  ...
  template: \`
    ...
    />
  \`
})`,...(wn=(Pn=I.parameters)==null?void 0:Pn.docs)==null?void 0:wn.source}}};var xn,Ln,kn;C.parameters={...C.parameters,docs:{...(xn=C.parameters)==null?void 0:xn.docs,source:{originalSource:`args => ({
  components: {
    AvPeriodInput
  },
  setup() {
