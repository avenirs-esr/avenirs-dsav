import{d as i,k as l,J as c,U as p,B as m,i as u}from"./iframe-R8FOEziV.js";import{H as d}from"./vue-dsfr-BAvT4AfM.js";import"./preload-helper-ILsKNznc.js";const a=i({__name:"AvBreadcrumb",props:{links:{},navigationLabel:{},showBreadcrumbLabel:{}},setup(n){const o=n;return(b,h)=>(u(),l(m(d),c(p(o)),null,16))}});a.__docgenInfo={exportName:"default",displayName:"AvBreadcrumb",description:"",tags:{},props:[{name:"links",description:`A table of objects representing the links in the breadcrumb. Each object can
...
})`,...(s=(t=e.parameters)==null?void 0:t.docs)==null?void 0:s.source}}};const A=["Default"];export{e as Default,A as __namedExportsOrder,B as default};
