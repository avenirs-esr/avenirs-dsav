import{_ as s}from"./AvLanguageSelector-nVDOvUVM.js";import"./iframe-DG3pTfcg.js";import"./preload-helper-ILsKNznc.js";import"./use-collapsable-DDsccUe-.js";const p={title:"Components/Interaction/Buttons/AvLanguageSelector",component:s,tags:["autodocs"],argTypes:{languages:{control:!1},currentLanguage:{control:"select",options:["fr","en"]},title:{control:"text"}},args:{languages:[{codeIso:"fr",label:"Français"},{codeIso:"en",label:"English"}],currentLanguage:"fr",title:"Select a language"},parameters:{docs:{story:{height:"10rem"},description:{component:`<h2 class="n2">✨ Introduction</h2>
