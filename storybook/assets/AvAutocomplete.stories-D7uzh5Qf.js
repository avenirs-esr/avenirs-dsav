...
<p><span class="b2-regular">The autocomplete consists of an input field, dropdown with filterable options, and optional selected items section for multi-select mode.</span></p>`}}}},T=e=>({components:{AvAutocomplete:se},setup(){const l=L([]);return{args:e,modelValue:l,MDI_ICONS:N}},template:`
  ...
  template: \`
    ...
    />
  \`
})`,...(Ne=(Me=P.parameters)==null?void 0:Me.docs)==null?void 0:Ne.source}}};var Re,qe,Ee;U.parameters={...U.parameters,docs:{...(Re=U.parameters)==null?void 0:Re.docs,source:{originalSource:`args => ({
  components: {
    AvAutocomplete
  },
  setup() {
  ...
  template: \`
    ...
    />
  \`
})`,...(Ee=(qe=U.parameters)==null?void 0:qe.docs)==null?void 0:Ee.source}}};var je,Be,We;H.parameters={...H.parameters,docs:{...(je=H.parameters)==null?void 0:je.docs,source:{originalSource:`args => ({
  components: {
    AvAutocomplete
  },
  setup() {
