import{d as Pe,c as l,e as we,D as x,L as qe,u,E as C,f as A,M as Le,g as ke}from"./iframe-BBg84DrF.js";import{c as D,t as Me,A as P,p as Be,i as Ne}from"./AvInput-D1eCwy-J.js";import{_ as Te}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-ILsKNznc.js";import"./AvMessage-C025Kxy_.js";import"./AvIconText-BIIMCqgF.js";import"./AvIcon-BabwAM-T.js";import"./icons-CvJnIbum.js";function We(e,o){let d,r=o==null?void 0:o.in;return e.forEach(t=>{!r&&typeof t=="object"&&(r=D.bind(null,t));const i=Me(t,r);(!d||d<i||isNaN(+i))&&(d=i)}),D(r,d||NaN)}function Ye(e,o){let d,r=o==null?void 0:o.in;return e.forEach(t=>{!r&&typeof t=="object"&&(r=D.bind(null,t));const i=Me(t,r);(!d||d>i||isNaN(+i))&&(d=i)}),D(r,d||NaN)}const Oe=["for"],he=Pe({__name:"AvPeriodInput",props:{id:{},label:{},labelClass:{default:"b2-light"},startModelValue:{default:""},endModelValue:{default:""},startLabel:{},endLabel:{},width:{},startMinDate:{},startMaxDate:{},endMinDate:{},endMaxDate:{},stacked:{type:Boolean,default:!1},separatorSpacing:{default:"var(--spacing-sm)"},endDateDisabled:{type:Boolean,default:!1},startDateDisabled:{type:Boolean,default:!1},type:{default:"date"},labelVisible:{type:Boolean,default:!0}},emits:["update:startModelValue","update:endModelValue","change"],setup(e,{emit:o}){Le(n=>({v6e28445e:n.separatorSpacing}));const d=o,r=l(()=>e.id??`period-input-${crypto.randomUUID()}`),t=l(()=>`${r.value}__start`),i=l(()=>`${r.value}__end`);function I(n){if(!n)return;const a=Be(n);return Ne(a)?a:void 0}function Ve(n,a){return n&&a?We([n,a]):n??a}function fe(n,a){return n&&a?Ye([n,a]):n??a}const ye=l(()=>I(e.startModelValue)),Ue=l(()=>I(e.endModelValue)),Se=l(()=>e.startMinDate),De=l(()=>fe(e.startMaxDate,Ue.value)),Ee=l(()=>Ve(e.endMinDate,ye.value)),Ce=l(()=>e.endMaxDate),Ie=l(()=>["av-label",{"av-hidden":!e.labelVisible},e.labelClass]);function xe(n){const a=(n==null?void 0:n.toString())??"";d("update:startModelValue",a),d("change",{start:a,end:e.endModelValue})}function Ae(n){const a=(n==null?void 0:n.toString())??"";d("update:endModelValue",a),d("change",{start:e.startModelValue,end:a})}return(n,a)=>(ke(),we("div",{class:C(["av-period-input av-col av-gap-xxs",{"av-period-input--stacked":e.stacked}])},[x("label",{class:C(u(Ie)),for:u(t),"data-testid":"common-label"},qe(e.label),11,Oe),x("div",{class:C(["av-period-input__row",{"av-row av-align-end":!e.stacked,"av-col av-align-stretch":e.stacked}])},[A(P,{id:u(t),type:e.type,"model-value":e.startModelValue,label:e.startLabel,"aria-label":e.startLabel,"label-visible":!1,disabled:e.startDateDisabled,width:e.width,"min-date":u(Se),"max-date":u(De),"data-testid":"start-date-input","onUpdate:modelValue":a[0]||(a[0]=E=>xe(E))},null,8,["id","type","model-value","label","aria-label","disabled","width","min-date","max-date"]),A(P,{id:u(i),type:e.type,"model-value":e.endModelValue,label:e.endLabel,"aria-label":e.endLabel,"label-visible":!1,disabled:e.endDateDisabled,width:e.width,"min-date":u(Ee),"max-date":u(Ce),"data-testid":"end-date-input","onUpdate:modelValue":a[1]||(a[1]=E=>Ae(E))},null,8,["id","type","model-value","label","aria-label","disabled","width","min-date","max-date"])],2)],2))}}),ve=Te(he,[["__scopeId","data-v-da383c7b"]]);he.__docgenInfo={exportName:"default",displayName:"AvPeriodInput",description:"",tags:{},props:[{name:"id",description:"Unique id for the period input",tags:{default:[{description:"`period-input-${crypto.randomUUID()}`",title:"default"}]},required:!1,type:{name:"string"}},{name:"label",description:"Label displayed above the two inputs",required:!0,type:{name:"string"}},{name:"labelClass",description:"CSS class for the label",tags:{default:[{description:"'b2-light'",title:"default"}]},required:!1,type:{name:"string"}},{name:"startModelValue",description:"Start date value (ISO string: YYYY-MM-DD)",tags:{default:[{description:"''",title:"default"}]},required:!1,type:{name:"string"}},{name:"endModelValue",description:"End date value (ISO string: YYYY-MM-DD)",tags:{default:[{description:"''",title:"default"}]},required:!1,type:{name:"string"}},{name:"startLabel",description:`Label for the start input (optional).
...
<p>
  ...
  template: \`
    ...
    />
  \`
})`,...(L=(q=p.parameters)==null?void 0:q.docs)==null?void 0:L.source}}};var k,B,N;c.parameters={...c.parameters,docs:{...(k=c.parameters)==null?void 0:k.docs,source:{originalSource:`args => ({
  components: {
    AvPeriodInput
  },
  setup() {
  ...
  template: \`
    ...
    />
  \`
})`,...(N=(B=c.parameters)==null?void 0:B.docs)==null?void 0:N.source}}};var T,W,Y;g.parameters={...g.parameters,docs:{...(T=g.parameters)==null?void 0:T.docs,source:{originalSource:`args => ({
  components: {
    AvPeriodInput
  },
  setup() {
  ...
  template: \`
    ...
    />
  \`
})`,...($=(j=m.parameters)==null?void 0:j.docs)==null?void 0:$.source}}};var F,H,R;b.parameters={...b.parameters,docs:{...(F=b.parameters)==null?void 0:F.docs,source:{originalSource:`args => ({
  components: {
    AvPeriodInput
  },
  setup() {
  ...
  template: \`
    ...
    />
  \`
})`,...(R=(H=b.parameters)==null?void 0:H.docs)==null?void 0:R.source}}};var z,G,J;M.parameters={...M.parameters,docs:{...(z=M.parameters)==null?void 0:z.docs,source:{originalSource:`args => ({
  components: {
    AvPeriodInput
  },
  setup() {
  ...
  template: \`
    ...
    />
  \`
})`,...(J=(G=M.parameters)==null?void 0:G.docs)==null?void 0:J.source}}};var K,Q,X;h.parameters={...h.parameters,docs:{...(K=h.parameters)==null?void 0:K.docs,source:{originalSource:`args => ({
  components: {
    AvPeriodInput
  },
  setup() {
  ...
  template: \`
    ...
    />
  \`
})`,...(te=(ae=V.parameters)==null?void 0:ae.docs)==null?void 0:te.source}}};var de,re,se;f.parameters={...f.parameters,docs:{...(de=f.parameters)==null?void 0:de.docs,source:{originalSource:`args => ({
  components: {
    AvPeriodInput
  },
  setup() {
  ...
  template: \`
    ...
    />
  \`
})`,...(se=(re=f.parameters)==null?void 0:re.docs)==null?void 0:se.source}}};var oe,le,ie;y.parameters={...y.parameters,docs:{...(oe=y.parameters)==null?void 0:oe.docs,source:{originalSource:`args => ({
  components: {
    AvPeriodInput
  },
  setup() {
  ...
  template: \`
    ...
    />
  \`
})`,...(ce=(pe=U.parameters)==null?void 0:pe.docs)==null?void 0:ce.source}}};var ge,me,be;S.parameters={...S.parameters,docs:{...(ge=S.parameters)==null?void 0:ge.docs,source:{originalSource:`args => ({
  components: {
    AvPeriodInput
  },
  setup() {
