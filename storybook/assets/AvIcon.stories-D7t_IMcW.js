import{A as c}from"./AvIcon-D6WBB9X2.js";import"./iframe-D7OPTHdM.js";import"./preload-helper-ILsKNznc.js";import"./iconify-CG-Oriw0.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const h={title:"Components/Base/AvIcon",component:c,tags:["autodocs"],argTypes:{name:{control:"text",description:"Name of the icon (from Iconify naming convention)",type:{name:"string",required:!0}},size:{control:{type:"range",min:.5,max:5,step:.25},description:"Size in rem of the container and icon scale"},animation:{control:"select",options:["spin","wrench","pulse","spin-pulse","flash","float","ring",void 0]},speed:{control:"radio",options:["fast","slow",void 0]},flip:{control:"radio",options:["horizontal","vertical","both",void 0]},color:{control:"color"},label:{control:"text"},title:{control:"text"},ssr:{control:"boolean"}},args:{name:"mdi:check",size:2,animation:void 0,speed:void 0,flip:void 0,color:"var(--text1)",label:"Check icon",title:"Check",ssr:!0},parameters:{docs:{description:{component:`<h2 class="n2">✨ Introduction</h2>
