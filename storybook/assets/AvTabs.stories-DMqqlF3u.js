import{_ as P}from"./AvTab-DOeUGBvC.js";import{n as $,aa as qe,a6 as Ee,h as L,R as ze,B as F,L as p,a4 as $e,P as m,d as z,I as Ie,A as Q,a7 as Ne,e as H,$ as u,f as E,D as Be,z as X,g as Se,X as Re,ac as Ve,a3 as Me,a2 as Oe,N as He,K as Pe,F as J,Q as Y,E as Ue,y as Ke,a9 as je}from"./iframe-KRNHvQZU.js";import{_ as U}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{A as Ge}from"./AvIcon-pmmsrp9q.js";import{M as Qe}from"./icons-_H15CKU0.js";import"./preload-helper-ILsKNznc.js";import"./icon-path-u9rVYwcY.js";const Xe=["id","aria-labelledby","tabindex"],we=$({__name:"TabContent",props:{panelId:{},tabId:{},isVisible:{type:Boolean}},setup(e){return(s,n)=>qe((p(),L("div",{id:e.panelId,class:F(["av-tab-content",{"av-tab-content--selected":e.isVisible}]),role:"tabpanel","aria-labelledby":e.tabId,tabindex:e.isVisible?0:-1},[ze(s.$slots,"default",{},void 0,!0)],10,Xe)),[[Ee,e.isVisible]])}}),N=U(we,[["__scopeId","data-v-3bab28a1"]]);we.__docgenInfo={exportName:"default",displayName:"TabContent",description:"",tags:{},props:[{name:"panelId",description:"ID of the associated tab panel.",required:!0,type:{name:"string"}},{name:"tabId",description:"ID of the tab item.",required:!0,type:{name:"string"}},{name:"isVisible",description:"Whether the tab content is visible.",required:!0,type:{name:"boolean"}}],slots:[{name:"default",description:"Default slot for passing tab panel content."}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/tabs/AvTabs/components/TabContent.vue"]};const Je=["id","tabindex","aria-selected","aria-controls","disabled"],ke=$({inheritAttrs:!1,__name:"TabItem",props:{panelId:{},tabId:{},isSelected:{type:Boolean},title:{},icon:{},compact:{type:Boolean,default:!1},disabled:{type:Boolean,default:!1},isLoading:{type:Boolean,default:!1}},emits:["click","next","previous","first","last"],setup(e,{emit:s}){const n=s,o=$e("button"),c=m(!1),T=z(()=>e.isSelected?"s2-bold":"s2-regular"),d={name:Qe.LOADING,animation:"spin"},f=z(()=>{if(e.isLoading)return{...d,size:2};if(e.icon)return{name:e.icon,size:2}}),M={ArrowRight:"next",ArrowLeft:"previous",Home:"first",End:"last"};function g(b){const r=b==null?void 0:b.key,v=M[r];if(v)switch(v){case"next":n("next");break;case"previous":n("previous");break;case"first":n("first");break;case"last":n("last");break}}function W(){e.isSelected||e.disabled||e.isLoading||n("click",e.tabId)}return Ie(()=>{Q(()=>{c.value=!0})}),Ne(()=>e.isSelected,async b=>{var r;!c.value||!b||e.disabled||e.isLoading||(await Q(),(r=o.value)==null||r.focus())},{flush:"post"}),(b,r)=>{const v=Ge;return p(),L("li",{class:F(["av-tab-item av-py-xs",{"av-tab-item--compact av-no-before":e.compact,"av-flex-fill--md av-w-full":!e.compact}]),role:"presentation"},[H("button",X(b.$attrs,{id:e.tabId,ref:"button",class:["av-tab-item__tab av-row av-gap-xs av-align-center av-justify-center av-text-text2 av-w-full",{"av-tab-item--compact__tab av-radius-none av-m-none av-py-xs av-px-2xl":e.compact,"av-radius-lg":!e.compact}],tabindex:e.isSelected?0:-1,role:"tab",type:"button","aria-selected":e.isSelected,"aria-controls":e.panelId,disabled:e.disabled||e.isLoading,onClick:Ve(W,["prevent"]),onKeydown:r[0]||(r[0]=O=>g(O))}),[u(f)?(p(),E(v,Be(X({key:0},u(f))),null,16)):Se("",!0),H("span",{class:F(u(T))},Re(e.title),3)],16,Je)],2)}}}),B=U(ke,[["__scopeId","data-v-46cdc584"]]);ke.__docgenInfo={exportName:"default",displayName:"TabItem",description:"",tags:{},props:[{name:"panelId",description:"ID of the associated tab panel.",required:!0,type:{name:"string"}},{name:"tabId",description:"ID of the tab item.",required:!0,type:{name:"string"}},{name:"isSelected",description:"Whether the tab is currently selected.",required:!0,type:{name:"boolean"}},{name:"title",description:"Title of the tab displayed in the tab bar.",required:!0,type:{name:"string"}},{name:"icon",description:"Name of the icon to display in the tab.",required:!1,type:{name:"string"}},{name:"compact",description:"Whether the tab is displayed in compact mode.",tags:{default:[{description:"false",title:"default"}]},required:!1,type:{name:"boolean"}},{name:"disabled",description:"Whether the tab item is disabled.",tags:{default:[{description:"false",title:"default"}]},required:!1,type:{name:"boolean"}},{name:"isLoading",description:"Whether the tab item is in loading state.",tags:{default:[{description:"false",title:"default"}]},required:!1,type:{name:"boolean"}}],events:[{name:"click",type:{names:["string"]},description:"Emitted when the tab is clicked.",properties:[{type:{names:["mixed"]},name:"tabId",description:"The ID of the clicked tab."}],tags:[{title:"param",type:{name:"mixed"},name:"tabId",description:"The ID of the clicked tab."}]},{name:"next",description:"Emitted when the user navigates to the next tab."},{name:"previous",description:"Emitted when the user navigates to the previous tab."},{name:"first",description:"Emitted when the user navigates to the first tab."},{name:"last",description:"Emitted when the user navigates to the last tab."}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/tabs/AvTabs/components/TabItem.vue"]};const Ye=$({name:"TabPanelContent",props:{tab:{type:Object,required:!0}},setup(e){return()=>{var n;const s=e.tab.children;return((n=s==null?void 0:s.default)==null?void 0:n.call(s))??null}}});function Ze(e,s,n){const o=m({"--tabs-height":"100px"});function c(){if(n.value<0||!e.value||!e.value.offsetHeight)return;const T=e.value.offsetHeight,d=s.value[n.value];if(!d||!d.offsetHeight)return;const f=d.offsetHeight;o.value["--tabs-height"]=`${T+f}px`}return{tabsStyle:o,updateTabsStyle:c}}const _e=["aria-label"],xe=$({__name:"AvTabs",props:Ke({ariaLabel:{},compact:{type:Boolean,default:!1},lazyRender:{type:Boolean,default:!0}},{modelValue:{default:0},modelModifiers:{}}),emits:["update:modelValue"],setup(e){const s=Me(),n=z(()=>{var a;return((a=s.default)==null?void 0:a.call(s))||[]}),o=Oe(e,"modelValue"),c=m(null),T=m(null),d=He({}),{tabsStyle:f,updateTabsStyle:M}=Ze(T,z(()=>{var a;return Array.from(((a=c.value)==null?void 0:a.querySelectorAll(".av-tab-content"))||[])}),o);function g(a){if(d[a])return d[a];const l=`tab-${crypto.randomUUID()}`;return d[a]=l,l}function W(){for(let a=0;a<n.value.length;a++)if(!r(n.value[a]))return a;return 0}function b(){for(let a=n.value.length-1;a>=0;a--)if(!r(n.value[a]))return a;return n.value.length-1}function r(a){var i,I,S;const l=(i=a==null?void 0:a.props)==null?void 0:i.disabled,t=((I=a==null?void 0:a.props)==null?void 0:I["is-loading"])??((S=a==null?void 0:a.props)==null?void 0:S.isLoading);return l===!0||l===""||t===!0||t===""}function v(a){const l=n.value.length;let t=(o.value+a+l)%l;const i=o.value;for(;r(n.value[t])&&(t=(t+a+l)%l,t!==i););o.value=t}function O(){v(-1)}function Le(){v(1)}function Fe(){o.value=W()}function We(){o.value=b()}const q=m(null);return Ie(()=>{var a;window.ResizeObserver&&(q.value=new window.ResizeObserver(()=>{M()})),(a=c.value)==null||a.querySelectorAll(".av-tab-content").forEach(l=>{var t;l&&((t=q.value)==null||t.observe(l))}),r(n.value[o.value])&&(o.value=W())}),Pe(()=>{var a,l;(a=c.value)==null||a.querySelectorAll(".av-tab-content").forEach(t=>{var i;t&&((i=q.value)==null||i.unobserve(t))}),(l=q.value)==null||l.disconnect()}),(a,l)=>(p(),L("div",{ref_key:"$el",ref:c,class:F(["av-tabs",{"av-tabs--compact":e.compact}]),style:Ue(u(f))},[H("ul",{ref_key:"tablist",ref:T,class:F(["av-tabs__list av-col av-row--md av-px-xs av-py-none av-align-center av-gap-sm--md av-list-reset av-radius-lg",{"av-tabs__list--compact":e.compact,"av-w-full":!e.compact}]),role:"tablist","aria-label":e.ariaLabel??"Liste d’onglets"},[(p(!0),L(J,null,Y(u(n),(t,i)=>{var I,S,K,j,G;return p(),E(B,{key:i,"tab-id":g(i),"panel-id":`${g(i)}-panel`,title:(I=t.props)==null?void 0:I.title,icon:(S=t.props)==null?void 0:S.icon,disabled:(K=t.props)==null?void 0:K.disabled,"is-loading":(j=t.props)==null?void 0:j["is-loading"],"data-testid":(G=t.props)==null?void 0:G["data-testid"],compact:e.compact,"is-selected":o.value===i,onClick:ea=>o.value=i,onNext:Le,onPrevious:O,onFirst:Fe,onLast:We},null,8,["tab-id","panel-id","title","icon","disabled","is-loading","data-testid","compact","is-selected","onClick"])}),128))],10,_e),(p(!0),L(J,null,Y(u(n),(t,i)=>(p(),E(N,{key:i,"panel-id":`${g(i)}-panel`,"tab-id":g(i),"is-visible":o.value===i},{default:je(()=>[!e.lazyRender||o.value===i?(p(),E(u(Ye),{key:0,tab:t},null,8,["tab"])):Se("",!0)]),_:2},1032,["panel-id","tab-id","is-visible"]))),128))],6))}}),R=U(xe,[["__scopeId","data-v-5b7b057f"]]);xe.__docgenInfo={exportName:"default",displayName:"AvTabs",description:"",tags:{},props:[{name:"ariaLabel",description:`Aria label for tab list.
...
<p>
  ...
  `}),y=De.bind({});y.args={};y.parameters={docs:{source:{code:`
      ...
      `}}};const C=V.bind({});C.args={compact:!0,disabledTab:1};const D=De.bind({});D.args={compact:!0};var Z,_,ee;A.parameters={...A.parameters,docs:{...(Z=A.parameters)==null?void 0:Z.docs,source:{originalSource:`args => ({
  components: {
    AvTabs,
    AvTab,
    TabContent,
