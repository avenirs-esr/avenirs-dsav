import{A as Z}from"./AvButton-DLdv4SCV.js";import{d as ee,T as te,r as y,c as E,e as i,j as d,X as ae,O as x,n as k,u as n,p as C,i as ne,$ as re,_ as oe,N as le,g as l}from"./iframe-UbGyYdVx.js";import{M as w}from"./icons-DKmRMgWU.js";import{_ as se}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvIcon-CirFJexH.js";import"./icon-path-u9rVYwcY.js";import"./string-BZgCOP9D.js";import"./preload-helper-ILsKNznc.js";const ce=["id","aria-hidden"],ie={key:0,class:"av-card__body"},de={key:1,class:"av-card__footer"},P=ee({__name:"AvCard",props:{titleOnly:{type:Boolean,default:!1},backgroundColor:{default:"var(--card)"},borderColor:{default:"var(--stroke)"},titleBackground:{default:"var(--surface-background)"},titleHeight:{},collapsible:{type:Boolean,default:!1},collapsed:{type:Boolean,default:!1}},setup(t){le(e=>({v8ec400ce:e.borderColor}));const h=te(),o=y(t.collapsed),T=y(!1),S=E(()=>`av-card-${crypto.randomUUID()}`),s=y(null),G=E(()=>o.value?"av-card__title--collapsed av--m-sm":t.titleOnly?"av-card__title--title-only av--m-sm":"av--mt-sm av--mx-sm");function B(){o.value=!o.value}function J(e){const r=["A","BUTTON","INPUT","SELECT","TEXTAREA"],a=["button","link","checkbox","radio","textbox","tab","menuitem"];if(r.includes(e.tagName))return!0;const c=e.getAttribute("role");return!!(c&&a.includes(c)||e.hasAttribute("tabindex")&&e.getAttribute("tabindex")!=="-1")}function O(e,r){if(s.value&&(e===s.value.$el||s.value.$el.contains(e)))return null;let a=e;for(;a&&a!==r;){if(J(a))return a;a=a.parentElement}return null}function K(e){var c;const r=e.target;O(r,e.currentTarget)||t.collapsible&&(B(),(c=s.value)==null||c.$el.focus())}function Q(e){if(!t.collapsible)return;const r=e.target,a=O(r,e.currentTarget);T.value=!!a}return(e,r)=>{const a=Z;return l(),i("div",{class:k(["av-card av-col av-p-sm av-justify-start av-radius-2xl",{"av-card--collapsible":t.collapsible,"av-card--hovering-interactive":n(T)}]),style:x({borderColor:t.borderColor,background:t.backgroundColor}),onClick:K,onMousemove:Q},[h.title?(l(),i("header",{key:0,class:k(["av-card__title av-row av-align-center av-justify-between av-p-sm av-gap-sm",n(G)]),style:x({background:t.titleBackground,minHeight:t.titleHeight,maxHeight:t.titleHeight})},[C(e.$slots,"title",{},void 0,!0),t.collapsible?(l(),ne(a,{key:0,ref_key:"buttonRef",ref:s,"aria-controls":`${n(S)}-content`,"aria-expanded":!n(o),icon:n(o)?n(w).CHEVRON_DOWN:n(w).CHEVRON_LEFT,"icon-only":"",label:"Details",onClick:re(B,["stop"])},null,8,["aria-controls","aria-expanded","icon"])):d("",!0)],6)):d("",!0),t.titleOnly?d("",!0):ae((l(),i("div",{key:1,id:`${n(S)}-content`,"aria-hidden":t.collapsible&&n(o),class:k(["av-card__content-collapsible av-col av-justify-between av-h-full av-gap-sm",{"av-pt-sm":!!h.title}])},[C(e.$slots,"default",{},void 0,!0),h.body?(l(),i("div",ie,[C(e.$slots,"body",{},void 0,!0)])):d("",!0),h.footer?(l(),i("div",de,[C(e.$slots,"footer",{},void 0,!0)])):d("",!0)],10,ce)),[[oe,!t.collapsible||!n(o)]])],38)}}}),A=se(P,[["__scopeId","data-v-eab18775"]]);P.__docgenInfo={exportName:"default",displayName:"AvCard",description:"",tags:{},props:[{name:"titleOnly",description:"If true, the card will be displayed in title-only mode.",tags:{default:[{description:"false",title:"default"}]},required:!1,type:{name:"boolean"}},{name:"backgroundColor",description:"The background color of the card.",tags:{default:[{description:"'var(--card)'",title:"default"}]},required:!1,type:{name:"string"}},{name:"borderColor",description:"The border color of the card.",tags:{default:[{description:"'var(--stroke)'",title:"default"}]},required:!1,type:{name:"string"}},{name:"titleBackground",description:"The background color of the card title.",tags:{default:[{description:"'var(--surface-background)'",title:"default"}]},required:!1,type:{name:"string"}},{name:"titleHeight",description:"The height of the card title.",required:!1,type:{name:"string"}},{name:"collapsible",description:`Whether the card is collapsible. When collapsed, the title is still shown.
...
<p>
  ...
  `}),u=f.bind({});u.args={};const p=f.bind({});p.args={backgroundColor:"var(--surface-background)",borderColor:"var(--other-border-skill-card)",titleBackground:"var(--light-background-primary1)",titleHeight:"var(--dimension-5xl)"};const m=ue.bind({});m.args={backgroundColor:"#fff4e5",borderColor:"#ff9900"};const b=f.bind({});b.args={collapsible:!0};const g=f.bind({});g.args={collapsible:!0,collapsed:!0};const v=f.bind({});v.args={titleOnly:!0};var D,H,I;u.parameters={...u.parameters,docs:{...(D=u.parameters)==null?void 0:D.docs,source:{originalSource:`args => ({
  components: {
    AvCard
  },
  setup() {
  ...
  \`
})`,...($=(N=p.parameters)==null?void 0:N.docs)==null?void 0:$.source}}};var _,W,q;m.parameters={...m.parameters,docs:{...(_=m.parameters)==null?void 0:_.docs,source:{originalSource:`args => ({
  components: {
    AvCard
  },
  setup() {
  ...
  \`
})`,...(Y=(R=b.parameters)==null?void 0:R.docs)==null?void 0:Y.source}}};var j,U,V;g.parameters={...g.parameters,docs:{...(j=g.parameters)==null?void 0:j.docs,source:{originalSource:`args => ({
  components: {
    AvCard
  },
  setup() {
  ...
  \`
})`,...(V=(U=g.parameters)==null?void 0:U.docs)==null?void 0:V.source}}};var z,L,X;v.parameters={...v.parameters,docs:{...(z=v.parameters)==null?void 0:z.docs,source:{originalSource:`args => ({
  components: {
    AvCard
  },
  setup() {
