import{A as Ye,a as Re}from"./AvList-DhyK6TcD.js";import{D as Xe,d as Q,V as Y,r as w,c as V,w as Ze,a as ne,e as A,j as ee,u as r,Q as et,n as tt,i as U,f as M,l as Ee,p as N,k as D,m as We,g,R as te,S as $e,O as ot,a5 as J,N as Be,q as re,s as nt,o as at,L as lt}from"./iframe-C6-9vdnR.js";import{b as rt}from"./index-BbWLDikM.js";import{A as st}from"./AvIcon-yTYWBojl.js";import{M as q}from"./icons-8RiK4kYW.js";import{_ as X}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{A as ze}from"./AvButton-BqZjIJ6v.js";import{A as it}from"./AvInput-CU5nS6_b.js";import"./preload-helper-ILsKNznc.js";import"./icon-path-u9rVYwcY.js";import"./string-BZgCOP9D.js";import"./AvMessage-t8fHXCmS.js";import"./AvIconText-fRvKH9N5.js";var k=(e=>(e.LOADING="loading",e.NO_OPTIONS="no-options",e.HAS_OPTIONS="has-options",e))(k||{});const Fe=Symbol("AvAutocompleteContext");function ae(){const e=Xe(Fe);if(!e)throw new Error("useAutocompleteContext must be used within AvAutocomplete component");return e}var ct=typeof global=="object"&&global&&global.Object===Object&&global,dt=typeof self=="object"&&self&&self.Object===Object&&self,Pe=ct||dt||Function("return this")(),K=Pe.Symbol,He=Object.prototype,ut=He.hasOwnProperty,pt=He.toString,R=K?K.toStringTag:void 0;function mt(e){var n=ut.call(e,R),s=e[R];try{e[R]=void 0;var v=!0}catch{}var m=pt.call(e);return v&&(n?e[R]=s:delete e[R]),m}var ft=Object.prototype,vt=ft.toString;function gt(e){return vt.call(e)}var ht="[object Null]",bt="[object Undefined]",se=K?K.toStringTag:void 0;function yt(e){return e==null?e===void 0?bt:ht:se&&se in Object(e)?mt(e):gt(e)}function St(e){return e!=null&&typeof e=="object"}var At="[object Symbol]";function It(e){return typeof e=="symbol"||St(e)&&yt(e)==At}var Ot=/\s/;function _t(e){for(var n=e.length;n--&&Ot.test(e.charAt(n)););return n}var wt=/^\s+/;function xt(e){return e&&e.slice(0,_t(e)+1).replace(wt,"")}function oe(e){var n=typeof e;return e!=null&&(n=="object"||n=="function")}var ie=NaN,Ct=/^[-+]0x[0-9a-f]+$/i,Tt=/^0b[01]+$/i,Dt=/^0o[0-7]+$/i,Lt=parseInt;function ce(e){if(typeof e=="number")return e;if(It(e))return ie;if(oe(e)){var n=typeof e.valueOf=="function"?e.valueOf():e;e=oe(n)?n+"":n}if(typeof e!="string")return e===0?e:+e;e=xt(e);var s=Tt.test(e);return s||Dt.test(e)?Lt(e.slice(2),s?2:8):Ct.test(e)?ie:+e}var Z=function(){return Pe.Date.now()},kt="Expected a function",Vt=Math.max,Mt=Math.min;function Ue(e,n,s){var v,m,f,u,i,t,d=0,b=!1,y=!1,I=!0;if(typeof e!="function")throw new TypeError(kt);n=ce(n)||0,oe(s)&&(b=!!s.leading,y="maxWait"in s,f=y?Vt(ce(s.maxWait)||0,n):f,I="trailing"in s?!!s.trailing:I);function O(c){var h=v,T=m;return v=m=void 0,d=c,u=e.apply(T,h),u}function x(c){return d=c,i=setTimeout(S,n),b?O(c):u}function _(c){var h=c-t,T=c-d,j=n-h;return y?Mt(j,f-T):j}function C(c){var h=c-t,T=c-d;return t===void 0||h>=n||h<0||y&&T>=f}function S(){var c=Z();if(C(c))return p(c);i=setTimeout(S,_(c))}function p(c){return i=void 0,I&&v?O(c):(v=m=void 0,u)}function o(){i!==void 0&&clearTimeout(i),d=0,v=t=m=i=void 0}function a(){return i===void 0?u:p(Z())}function l(){var c=Z(),h=C(c);if(v=arguments,m=this,t=c,h){if(i===void 0)return x(t);if(y)return clearTimeout(i),i=setTimeout(S,n),O(t)}return i===void 0&&(i=setTimeout(S,n)),u}return l.cancel=o,l.flush=a,l}const Nt={key:0,class:"av-row av-align-center av-justify-center av-gap-xs av-p-md av-text-text2","data-testid":"av-autocomplete-dropdown__loading"},qt={key:1,class:"av-autocomplete-dropdown__empty av-p-md"},jt={key:1,class:"av-autocomplete-dropdown__empty-text av-text-text2"},Rt={key:0,class:"caption-light"},Ge=Q({__name:"AvAutocompleteDropdown",emits:["loadMore"],setup(e,{expose:n,emit:s}){const v=s,m=Y(),{selectedItems:f,searchQuery:u,isOpen:i,props:t,getOptionId:d,getDisplayLabel:b}=ae(),y=w(),I=w(),O=V(()=>{if(!t.options)return[];if(t.serverSideFiltering)return t.maxResults?t.options.slice(0,t.maxResults):t.options;const o=u.value.toLowerCase().trim();if(!o){const l=t.options;return t.maxResults?l.slice(0,t.maxResults):l}let a;return t.filterOptions?a=t.filterOptions(t.options,o):a=t.options.filter(l=>b(l).toLowerCase().includes(o)),t.maxResults?a.slice(0,t.maxResults):a}),x=V(()=>t.loading?k.LOADING:i.value&&t.options&&t.options.length>0&&O.value.length>0?k.HAS_OPTIONS:k.NO_OPTIONS);function _(o){return f.value.some(a=>d(a)===d(o))}function C(o){if(o.disabled)return;if(!t.multiSelect){f.value=[o],i.value=!1,u.value="";return}const a=f.value,l=d(o);a.some(h=>d(h)===l)?f.value=a.filter(h=>d(h)!==l):f.value=[...a,o]}const{arrivedState:S}=rt(I,{throttle:100}),p=Ue(()=>{v("loadMore")},t.loadMoreThrottleDelay);return Ze(()=>S.bottom,o=>{t.enableLoadMore&&o&&i.value&&p()}),ne(()=>{p.cancel()}),n({dropdownRef:y}),(o,a)=>r(i)?(g(),A("div",{key:0,ref_key:"dropdownRef",ref:y,class:tt(["av-autocomplete-dropdown av-mt-xxxs av-radius-lg",r(t).dropdownClass]),style:et({width:r(t).dropdownWidth,maxHeight:r(t).maxDropdownHeight})},[r(x)===r(k).LOADING?(g(),A("div",Nt,[M(st,{name:r(q).LOADING,size:1.5,animation:"spin"},null,8,["name"]),a[0]||(a[0]=Ee("span",{class:"av-autocomplete-dropdown__loading-text av-text-text2"},"Loading...",-1))])):r(x)===r(k).NO_OPTIONS?(g(),A("div",qt,[m.empty?N(o.$slots,"empty",{key:0},void 0,!0):(g(),A("div",jt," No results found "))])):(g(),U(Ye,We({key:2,ref_key:"listRef",ref:I},r(t).listOptions,{class:["av-autocomplete-dropdown__options",r(t).scrollbarClass]}),{default:D(()=>[(g(!0),A(te,null,$e(r(O),l=>(g(),A(te,{key:r(d)(l)},[m.item?N(o.$slots,"item",{key:0,option:l,isSelected:_(l),toggle:()=>C(l)},void 0,!0):(g(),U(Re,{key:1,title:r(b)(l),icon:_(l)?r(q).CHECK:void 0,selected:_(l),disabled:l.disabled,"hover-background-color":"var(--light-background-neutral)","color-on-hover":"var(--base)",onClick:()=>C(l)},{default:D(()=>[l.description?(g(),A("span",Rt,ot(l.description),1)):ee("",!0)]),_:2},1032,["title","icon","selected","disabled","onClick"]))],64))),128))]),_:3},16,["class"]))],6)):ee("",!0)}}),Et=X(Ge,[["__scopeId","data-v-acb6dc0c"]]);Ge.__docgenInfo={exportName:"default",displayName:"AvAutocompleteDropdown",description:"",tags:{},expose:[{name:"dropdownRef"}],events:[{name:"loadMore"}],slots:[{name:"empty"},{name:"item",scoped:!0,bindings:[{name:"option",title:"binding"},{name:"is-selected",title:"binding"},{name:"toggle",title:"binding"}]}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/selects/AvAutocomplete/AvAutocompleteDropdown.vue"]};const Wt={class:"av-autocomplete-input"},Je=Q({__name:"AvAutocompleteInput",emits:["search","clear"],setup(e,{expose:n,emit:s}){const v=s,m=Y(),{selectedItems:f,searchQuery:u,isOpen:i,props:t,inputId:d,handleBlur:b,getDisplayLabel:y}=ae(),I=w(),O=V(()=>{if(!t.multiSelect&&f.value.length>0)return y(f.value[0]);if(t.multiSelect){if(!t.displaySelectionInInput)return u.value;if(f.value.length>0)return t.showSelectedSection?t.selectedItemsCountLabel:f.value.map(y).join(", ")}return u.value}),x=V(()=>{var o;return((o=t.inputOptions)==null?void 0:o.placeholder)||"Search..."}),_=Ue(o=>{u.value=o,v("search",o)},t.debounceDelay);function C(o){u.value=String(o||""),_(u.value)}function S(){i.value=!0}function p(){f.value=[],u.value="",v("clear")}return ne(()=>{_.cancel()}),n({inputRef:I,searchQuery:V(()=>u.value)}),(o,a)=>(g(),A("div",Wt,[M(it,We({id:r(d),ref_key:"inputRef",ref:I,"model-value":r(O),placeholder:r(x)},r(t).inputOptions,{"onUpdate:modelValue":C,onFocus:S,onBlur:r(b),onClick:S}),J({_:2},[m.requiredTip?{name:"requiredTip",fn:D(()=>[(g(),U(Be(m.requiredTip)))]),key:"0"}:void 0,r(f).length>0?{name:"suffix",fn:D(()=>[M(ze,{label:"Clear selected items",icon:r(q).CLOSE_CIRCLE_OUTLINE,"icon-only":"","icon-scale":1.25,variant:"DEFAULT",theme:"SECONDARY",small:"",onClick:p},null,8,["icon"])]),key:"1"}:void 0]),1040,["id","model-value","placeholder","onBlur"])]))}}),$t=X(Je,[["__scopeId","data-v-5b57a510"]]);Je.__docgenInfo={exportName:"default",displayName:"AvAutocompleteInput",description:"",tags:{},expose:[{name:"inputRef"},{name:"searchQuery"}],events:[{name:"search",type:{names:["string"]}},{name:"clear"}],slots:[{name:"requiredTip"}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/selects/AvAutocomplete/AvAutocompleteInput.vue"]};const Bt={key:0,class:"av-autocomplete-selected-tags av-row av-wrap av-gap-xs av-mt-xs"},Ke=Q({__name:"AvAutocompleteSelectedTags",setup(e){const n=Y(),{selectedItems:s,props:v,getOptionId:m,getDisplayLabel:f}=ae();function u(i){const t=s.value,d=m(i);s.value=t.filter(b=>m(b)!==d)}return(i,t)=>r(v).multiSelect&&r(s).length>0&&r(v).showSelectedSection?(g(),A("div",Bt,[(g(!0),A(te,null,$e(r(s),d=>(g(),A("div",{key:r(m)(d),class:"av-autocomplete-selected-tags__item"},[n.selectedItem?N(i.$slots,"selectedItem",{key:0,option:d,remove:()=>u(d)},void 0,!0):(g(),U(ze,{key:1,label:r(f)(d),icon:r(q).CLOSE_CIRCLE_OUTLINE,"icon-right":"",size:"sm",variant:"OUTLINED",theme:"SECONDARY",onClick:()=>u(d)},null,8,["label","icon","onClick"]))]))),128))])):ee("",!0)}}),zt=X(Ke,[["__scopeId","data-v-19df692b"]]);Ke.__docgenInfo={exportName:"default",displayName:"AvAutocompleteSelectedTags",description:"",tags:{},slots:[{name:"selectedItem",scoped:!0,bindings:[{name:"option",title:"binding"},{name:"remove",title:"binding"}]}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/selects/AvAutocomplete/AvAutocompleteSelectedTags.vue"]};const Ft={class:"av-autocomplete av-col av-gap-xxs"},Qe=Q({__name:"AvAutocomplete",props:re({id:{},inputOptions:{default:()=>({})},options:{},multiSelect:{type:Boolean,default:!1},getOptionLabel:{},getOptionKey:{},filterOptions:{},dropdownWidth:{default:"100%"},maxDropdownHeight:{default:"20rem"},listOptions:{default:()=>({size:"small",ariaLabel:"Available options list"})},scrollbarClass:{default:"av-autocomplete__scrollbar--default"},dropdownClass:{default:"av-autocomplete__dropdown--default"},loading:{type:Boolean,default:!1},debounceDelay:{default:300},maxResults:{},enableLoadMore:{type:Boolean,default:!1},showSelectedSection:{type:Boolean,default:!1},displaySelectionInInput:{type:Boolean,default:!0},blurCloseDelay:{default:150},loadMoreThrottleDelay:{default:200},serverSideFiltering:{type:Boolean,default:!1},selectedItemsCountLabel:{default:"element(s) selected"}},{modelValue:{default:()=>[]},modelModifiers:{}}),emits:re(["search","loadMore","clear"],["update:modelValue"]),setup(e,{emit:n}){const s=e,v=n,m=Y(),f=nt(e,"modelValue"),u=w(!1),i=w(""),t=w(),d=w(),b=w(),y=V(()=>s.id||`av-autocomplete-${crypto.randomUUID()}`);function I(p){i.value=p,v("search",p)}function O(p){var o,a;(a=(o=b.value)==null?void 0:o.dropdownRef)!=null&&a.contains(p.relatedTarget)||setTimeout(()=>{u.value=!1},s.blurCloseDelay)}function x(p){return s.getOptionKey?s.getOptionKey(p):p.value}function _(p){return s.getOptionLabel?s.getOptionLabel(p):p.label}lt(Fe,{selectedItems:f,searchQuery:i,isOpen:u,props:s,inputId:y,handleBlur:O,getOptionId:x,getDisplayLabel:_});function S(p){var l,c,h,T,j;const o=p.target,a=(l=d.value)==null?void 0:l.inputRef;!((c=a==null?void 0:a.contains)!=null&&c.call(a,o))&&!((h=t.value)!=null&&h.contains(o))&&!((j=(T=b.value)==null?void 0:T.dropdownRef)!=null&&j.contains(o))&&(u.value=!1)}return at(()=>{document.addEventListener("click",S)}),ne(()=>{document.removeEventListener("click",S)}),(p,o)=>(g(),A("div",Ft,[Ee("div",{ref_key:"wrapperRef",ref:t,class:"av-autocomplete__wrapper"},[M($t,{ref_key:"inputRef",ref:d,onSearch:I,onClear:o[0]||(o[0]=a=>v("clear"))},J({_:2},[m.requiredTip?{name:"requiredTip",fn:D(()=>[(g(),U(Be(m.requiredTip)))]),key:"0"}:void 0]),1536),M(Et,{ref_key:"dropdownRef",ref:b,onLoadMore:o[1]||(o[1]=a=>v("loadMore"))},J({_:2},[m.item?{name:"item",fn:D(({option:a,isSelected:l,toggle:c})=>[N(p.$slots,"item",{option:a,isSelected:l,toggle:c},void 0,!0)]),key:"0"}:void 0,m.empty?{name:"empty",fn:D(()=>[N(p.$slots,"empty",{},void 0,!0)]),key:"1"}:void 0]),1536)],512),M(zt,null,J({_:2},[m.selectedItem?{name:"selectedItem",fn:D(({option:a,remove:l})=>[N(p.$slots,"selectedItem",{option:a,remove:l},void 0,!0)]),key:"0"}:void 0]),1024)]))}}),le=X(Qe,[["__scopeId","data-v-4a146ea2"]]);Qe.__docgenInfo={exportName:"default",displayName:"AvAutocomplete",description:"",tags:{},props:[{name:"inputOptions",defaultValue:{func:!1,value:"() => ({})"}},{name:"multiSelect",defaultValue:{func:!1,value:"false"}},{name:"dropdownWidth",defaultValue:{func:!1,value:"'100%'"}},{name:"maxDropdownHeight",defaultValue:{func:!1,value:"'20rem'"}},{name:"listOptions",defaultValue:{func:!1,value:`() => ({
  size: 'small',
