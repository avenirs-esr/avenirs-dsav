import{A as z}from"./AvButton-C86yuYRp.js";import{d as W,N as V,W as q,A as $,Y as j,a as m,k as g,y as l,f as u,g as f,z as G,G as H,e as w,r as _}from"./iframe-CXyHY9rM.js";import{_ as J}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvIcon-BfY_vSkK.js";import"./iconify-D5kMrd7u.js";import"./icons-ubxugSKv.js";import"./string-BZgCOP9D.js";import"./preload-helper-ILsKNznc.js";const K={key:0},Q={key:0,class:"av-drawer-backdrop"},X=["aria-label"],Z={class:"av-drawer__content-wrapper"},ee={class:"av-drawer__content"},ne={key:0,class:"footer-container"},S=W({__name:"AvDrawer",props:{show:{type:Boolean},position:{default:"right"},width:{default:"35rem"},backdrop:{type:Boolean,default:!0},padding:{default:"var(--spacing-md)"},ariaLabel:{default:"Menu latéral"}},emits:["escapePressed"],setup(n,{emit:e}){H(a=>({v52ac02d7:l(F),v5085de3c:l(M)}));const c=n,p=e,U=V(),{position:P,width:F,padding:M,show:D}=q(c);function v(a){a.key==="Escape"&&p("escapePressed")}return $(D,a=>{a?window.addEventListener("keydown",v):window.removeEventListener("keydown",v)},{immediate:!0}),j(()=>{window.removeEventListener("keydown",v)}),(a,re)=>l(D)?(w(),m("div",K,[n.backdrop?(w(),m("div",Q)):g("",!0),u("div",{class:G(["av-drawer",`av-drawer--${l(P)}`]),role:"dialog","aria-modal":"true","aria-label":n.ariaLabel},[u("div",Z,[u("div",ee,[f(a.$slots,"default",{},void 0,!0)]),U.footer?(w(),m("div",ne,[f(a.$slots,"footer",{},void 0,!0)])):g("",!0)])],10,X)])):g("",!0)}}),h=J(S,[["__scopeId","data-v-2f06b4d1"]]);S.__docgenInfo={exportName:"default",displayName:"AvDrawer",description:"",tags:{},props:[{name:"show",description:"Controls the visibility of the drawer",required:!0,type:{name:"boolean"}},{name:"position",description:"Position of the drawer on the screen",required:!1,type:{name:"union",elements:[{name:'"left"'},{name:'"right"'}]},defaultValue:{func:!1,value:"'right'"}},{name:"width",description:"Width of the drawer panel",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'35rem'"}},{name:"backdrop",description:"Whether to show the backdrop overlay, default true",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"padding",description:"Padding inside the drawer content area",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'var(--spacing-md)'"}},{name:"ariaLabel",description:"ARIA label for accessibility",tags:{default:[{description:"'Menu latéral'",title:"default"}]},required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'Menu latéral'"}}],events:[{name:"escapePressed",description:"Event triggered when escape is pressed."}],slots:[{name:"default",description:"Default slot for main content."},{name:"footer",description:"Footer slot for content under the main scrollable content."}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/overlay/drawers/AvDrawer/AvDrawer.vue"]};const ve={title:"Components/Overlay/Drawers/AvDrawer",component:h,tags:["autodocs"],argTypes:{show:{control:"boolean"},position:{control:"select",options:["left","right"]},width:{control:"text"},backdrop:{control:"boolean"},padding:{control:"text"}},args:{show:!0,position:"right",width:"35rem",backdrop:!0,padding:"var(--spacing-md)"},parameters:{docs:{story:{height:"20rem"},description:{component:`<h1 class="n1">Drawers - <code>AvDrawer</code></h1>
