import{A as nt,a as Pe}from"./AvList-BdM2YDeS.js";import{s as at,m as X,_ as Z,L as C,b as N,a2 as lt,G as ae,W as o,g as S,A as rt,y as st,k,f as K,d as He,N as R,R as ie,e as G,a4 as D,w as Ue,H as h,F as oe,M as Ge,i as Q,P as Je,Z as ce,D as it,v as de,I as ct}from"./iframe-CthDrYiS.js";import{A as le}from"./AvButton-mERv0ZSb.js";import{a as dt}from"./index-D4P9YIr1.js";import{A as ut}from"./AvIcon-DH4K7RpX.js";import{M as V}from"./icons-BJ4bGiUf.js";import{_ as ee}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{A as pt}from"./AvInput-AdVHZ-zw.js";import"./AvTooltip-CAqBASau.js";import"./preload-helper-ILsKNznc.js";import"./string-BZgCOP9D.js";import"./icon-path-u9rVYwcY.js";import"./AvMessage-DlmgQ4ZJ.js";import"./AvIconText-DGPj26vd.js";var M=(e=>(e.LOADING="loading",e.NO_OPTIONS="no-options",e.HAS_OPTIONS="has-options",e))(M||{});const Ke=Symbol("AvAutocompleteContext");function re(){const e=at(Ke);if(!e)throw new Error("useAutocompleteContext must be used within AvAutocomplete component");return e}var mt=typeof global=="object"&&global&&global.Object===Object&&global,ft=typeof self=="object"&&self&&self.Object===Object&&self,Qe=mt||ft||Function("return this")(),Y=Qe.Symbol,Ye=Object.prototype,vt=Ye.hasOwnProperty,gt=Ye.toString,E=Y?Y.toStringTag:void 0;function ht(e){var n=vt.call(e,E),r=e[E];try{e[E]=void 0;var g=!0}catch{}var m=gt.call(e);return g&&(n?e[E]=r:delete e[E]),m}var bt=Object.prototype,yt=bt.toString;function St(e){return yt.call(e)}var At="[object Null]",It="[object Undefined]",ue=Y?Y.toStringTag:void 0;function Ot(e){return e==null?e===void 0?It:At:ue&&ue in Object(e)?ht(e):St(e)}function wt(e){return e!=null&&typeof e=="object"}var _t="[object Symbol]";function Ct(e){return typeof e=="symbol"||wt(e)&&Ot(e)==_t}var xt=/\s/;function Lt(e){for(var n=e.length;n--&&xt.test(e.charAt(n)););return n}var Tt=/^\s+/;function Dt(e){return e&&e.slice(0,Lt(e)+1).replace(Tt,"")}function ne(e){var n=typeof e;return e!=null&&(n=="object"||n=="function")}var pe=NaN,kt=/^[-+]0x[0-9a-f]+$/i,Vt=/^0b[01]+$/i,Mt=/^0o[0-7]+$/i,Nt=parseInt;function me(e){if(typeof e=="number")return e;if(Ct(e))return pe;if(ne(e)){var n=typeof e.valueOf=="function"?e.valueOf():e;e=ne(n)?n+"":n}if(typeof e!="string")return e===0?e:+e;e=Dt(e);var r=Vt.test(e);return r||Mt.test(e)?Nt(e.slice(2),r?2:8):kt.test(e)?pe:+e}var te=function(){return Qe.Date.now()},Rt="Expected a function",qt=Math.max,Et=Math.min;function Xe(e,n,r){var g,m,f,u,s,t,c=0,b=!1,y=!1,O=!0;if(typeof e!="function")throw new TypeError(Rt);n=me(n)||0,ne(r)&&(b=!!r.leading,y="maxWait"in r,f=y?qt(me(r.maxWait)||0,n):f,O="trailing"in r?!!r.trailing:O);function _(l){var d=g,I=m;return g=m=void 0,c=l,u=e.apply(I,d),u}function L(l){return c=l,s=setTimeout(A,n),b?_(l):u}function w(l){var d=l-t,I=l-c,q=n-d;return y?Et(q,f-I):q}function T(l){var d=l-t,I=l-c;return t===void 0||d>=n||d<0||y&&I>=f}function A(){var l=te();if(T(l))return v(l);s=setTimeout(A,w(l))}function v(l){return s=void 0,O&&g?_(l):(g=m=void 0,u)}function i(){s!==void 0&&clearTimeout(s),c=0,g=t=m=s=void 0}function a(){return s===void 0?u:v(te())}function p(){var l=te(),d=T(l);if(g=arguments,m=this,t=l,d){if(s===void 0)return L(t);if(y)return clearTimeout(s),s=setTimeout(A,n),_(t)}return s===void 0&&(s=setTimeout(A,n)),u}return p.cancel=i,p.flush=a,p}const jt={key:0,class:"av-p-xs"},Bt={key:1,class:"av-row av-align-center av-justify-center av-gap-xs av-p-md av-text-text2","data-testid":"av-autocomplete-dropdown__loading"},Wt={key:2,class:"av-autocomplete-dropdown__empty av-p-md"},$t={key:1,class:"av-autocomplete-dropdown__empty-text av-text-text2"},Ft={key:0,class:"caption-light"},Ze=X({__name:"AvAutocompleteDropdown",emits:["loadMore","clearSelection"],setup(e,{expose:n,emit:r}){const g=r,m=Z(),{selectedItems:f,searchQuery:u,isOpen:s,props:t,getOptionId:c,getDisplayLabel:b}=re(),y=C(),O=C(),_=N(()=>{if(!t.options)return[];if(t.serverSideFiltering)return t.maxResults?t.options.slice(0,t.maxResults):t.options;const a=u.value.toLowerCase().trim();if(!a){const l=t.options;return t.maxResults?l.slice(0,t.maxResults):l}let p;return t.filterOptions?p=t.filterOptions(t.options,a):p=t.options.filter(l=>b(l).toLowerCase().includes(a)),t.maxResults?p.slice(0,t.maxResults):p}),L=N(()=>t.loading?M.LOADING:s.value&&t.options&&t.options.length>0&&_.value.length>0?M.HAS_OPTIONS:M.NO_OPTIONS);function w(a){return f.value.some(p=>c(p)===c(a))}function T(a){if(a.disabled)return;if(!t.multiSelect){f.value=[a],s.value=!1,u.value="";return}const p=f.value,l=c(a);p.some(I=>c(I)===l)?f.value=p.filter(I=>c(I)!==l):f.value=[...p,a]}function A(){f.value=[],g("clearSelection")}const{arrivedState:v}=dt(O,{throttle:100}),i=Xe(()=>{g("loadMore")},t.loadMoreThrottleDelay);return lt(()=>v.bottom,a=>{t.enableLoadMore&&a&&s.value&&i()}),ae(()=>{i.cancel()}),n({dropdownRef:y}),(a,p)=>{const l=le;return o(s)?(h(),S("div",{key:0,ref_key:"dropdownRef",ref:y,class:st(["av-autocomplete-dropdown av-mt-xxxs av-radius-lg",o(t).dropdownClass]),style:rt({width:o(t).dropdownWidth,maxHeight:o(t).maxDropdownHeight})},[o(t).showClearSelectionButton?(h(),S("div",jt,[k(l,{label:o(t).clearSelectionLabel??"Clear selection",icon:o(V).CLOSE_CIRCLE_OUTLINE,variant:"DEFAULT",theme:"SECONDARY",small:"",disabled:o(f).length===0,onClick:A},null,8,["label","icon","disabled"])])):K("",!0),o(L)===o(M).LOADING?(h(),S("div",Bt,[k(ut,{name:o(V).LOADING,size:1.5,animation:"spin"},null,8,["name"]),p[0]||(p[0]=He("span",{class:"av-autocomplete-dropdown__loading-text av-text-text2"},"Loading...",-1))])):o(L)===o(M).NO_OPTIONS?(h(),S("div",Wt,[m.empty?R(a.$slots,"empty",{key:0},void 0,!0):(h(),S("div",$t,ie(o(t).noResultsLabel??"No results found"),1))])):(h(),G(nt,Ue({key:3,ref_key:"listRef",ref:O},o(t).listOptions,{class:["av-autocomplete-dropdown__options",o(t).scrollbarClass]}),{default:D(()=>[(h(!0),S(oe,null,Ge(o(_),d=>(h(),S(oe,{key:o(c)(d)},[m.item?R(a.$slots,"item",{key:0,option:d,isSelected:w(d),toggle:()=>T(d)},void 0,!0):(h(),G(Pe,{key:1,title:o(b)(d),icon:w(d)?o(V).CHECK:void 0,selected:w(d),disabled:d.disabled,"hover-background-color":"var(--light-background-neutral)","color-on-hover":"var(--base)",onClick:()=>T(d)},{default:D(()=>[d.description?(h(),S("span",Ft,ie(d.description),1)):K("",!0)]),_:2},1032,["title","icon","selected","disabled","onClick"]))],64))),128))]),_:3},16,["class"]))],6)):K("",!0)}}}),zt=ee(Ze,[["__scopeId","data-v-caf1d2a8"]]);Ze.__docgenInfo={exportName:"default",displayName:"AvAutocompleteDropdown",description:"",tags:{},expose:[{name:"dropdownRef"}],events:[{name:"loadMore"},{name:"clearSelection"}],slots:[{name:"empty"},{name:"item",scoped:!0,bindings:[{name:"option",title:"binding"},{name:"is-selected",title:"binding"},{name:"toggle",title:"binding"}]}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/selects/AvAutocomplete/AvAutocompleteDropdown.vue"]};const Pt={class:"av-autocomplete-input"},et=X({__name:"AvAutocompleteInput",emits:["search","clear"],setup(e,{expose:n,emit:r}){const g=r,m=Z(),{selectedItems:f,searchQuery:u,isOpen:s,props:t,inputId:c,handleBlur:b,getDisplayLabel:y}=re(),O=C(),_=N(()=>{if(!t.multiSelect&&f.value.length>0)return y(f.value[0]);if(t.multiSelect){if(!t.displaySelectionInInput)return u.value;if(f.value.length>0)return t.showSelectedSection?t.selectedItemsCountLabel:f.value.map(y).join(", ")}return u.value}),L=N(()=>{var i;return((i=t.inputOptions)==null?void 0:i.placeholder)||"Search..."}),w=Xe(i=>{u.value=i},t.debounceDelay);function T(i){w(String(i||""))}function A(){s.value=!0}function v(){u.value="",w(u.value),g("clear")}return ae(()=>{w.cancel()}),n({inputRef:O,searchQuery:N(()=>u.value)}),(i,a)=>(h(),S("div",Pt,[k(pt,Ue({id:o(c),ref_key:"inputRef",ref:O,"model-value":o(_),placeholder:o(L)},o(t).inputOptions,{"onUpdate:modelValue":T,onFocus:A,onBlur:o(b),onClick:A}),Q({_:2},[m.requiredTip?{name:"requiredTip",fn:D(()=>[(h(),G(Je(m.requiredTip)))]),key:"0"}:void 0,o(u)&&o(u).length>0?{name:"suffix",fn:D(()=>[k(le,{label:o(t).clearLabel??"Clear search",icon:o(V).CLOSE_CIRCLE_OUTLINE,"icon-only":"","icon-scale":1.25,variant:"DEFAULT",theme:"SECONDARY",small:"",onClick:v},null,8,["label","icon"])]),key:"1"}:void 0]),1040,["id","model-value","placeholder","onBlur"])]))}}),Ht=ee(et,[["__scopeId","data-v-d3358c34"]]);et.__docgenInfo={exportName:"default",displayName:"AvAutocompleteInput",description:"",tags:{},expose:[{name:"inputRef"},{name:"searchQuery"}],events:[{name:"search",type:{names:["string"]}},{name:"clear"}],slots:[{name:"requiredTip"}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/selects/AvAutocomplete/AvAutocompleteInput.vue"]};const Ut={key:0,class:"av-autocomplete-selected-tags av-row av-wrap av-gap-xs av-mt-xs"},tt=X({__name:"AvAutocompleteSelectedTags",setup(e){const n=Z(),{selectedItems:r,props:g,getOptionId:m,getDisplayLabel:f}=re();function u(s){const t=r.value,c=m(s);r.value=t.filter(b=>m(b)!==c)}return(s,t)=>o(g).multiSelect&&o(r).length>0&&o(g).showSelectedSection?(h(),S("div",Ut,[(h(!0),S(oe,null,Ge(o(r),c=>(h(),S("div",{key:o(m)(c),class:"av-autocomplete-selected-tags__item"},[n.selectedItem?R(s.$slots,"selectedItem",{key:0,option:c,remove:()=>u(c)},void 0,!0):(h(),G(le,{key:1,label:o(f)(c),icon:o(V).CLOSE_CIRCLE_OUTLINE,"icon-right":"",size:"sm",variant:"OUTLINED",theme:"SECONDARY",onClick:()=>u(c)},null,8,["label","icon","onClick"]))]))),128))])):K("",!0)}}),Gt=ee(tt,[["__scopeId","data-v-19df692b"]]);tt.__docgenInfo={exportName:"default",displayName:"AvAutocompleteSelectedTags",description:"",tags:{},slots:[{name:"selectedItem",scoped:!0,bindings:[{name:"option",title:"binding"},{name:"remove",title:"binding"}]}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/selects/AvAutocomplete/AvAutocompleteSelectedTags.vue"]};const Jt={class:"av-autocomplete av-col av-gap-xxs"},ot=X({__name:"AvAutocomplete",props:de({id:{},inputOptions:{default:()=>({})},options:{},multiSelect:{type:Boolean,default:!1},getOptionLabel:{},getOptionKey:{},filterOptions:{},dropdownWidth:{default:"100%"},maxDropdownHeight:{default:"20rem"},listOptions:{default:()=>({size:"small",ariaLabel:"Available options list"})},scrollbarClass:{},dropdownClass:{default:"av-autocomplete__dropdown--default"},loading:{type:Boolean,default:!1},debounceDelay:{default:300},maxResults:{},enableLoadMore:{type:Boolean,default:!1},showSelectedSection:{type:Boolean,default:!1},displaySelectionInInput:{type:Boolean,default:!0},blurCloseDelay:{default:150},loadMoreThrottleDelay:{default:200},serverSideFiltering:{type:Boolean,default:!1},selectedItemsCountLabel:{default:"element(s) selected"},clearLabel:{default:"Clear search"},showClearSelectionButton:{type:Boolean,default:!1},clearSelectionLabel:{default:"Clear selection"},noResultsLabel:{}},{modelValue:{default:()=>[]},modelModifiers:{},search:{default:""},searchModifiers:{}}),emits:de(["loadMore","clear","clearSelection"],["update:modelValue","update:search"]),setup(e,{emit:n}){const r=e,g=n,m=Z(),f=ce(e,"modelValue"),u=ce(e,"search"),s=C(!1),t=C(),c=C(),b=C(),y=N(()=>r.id||`av-autocomplete-${crypto.randomUUID()}`);function O(v){u.value=v}function _(v){var i,a;(a=(i=b.value)==null?void 0:i.dropdownRef)!=null&&a.contains(v.relatedTarget)||setTimeout(()=>{s.value=!1},r.blurCloseDelay)}function L(v){return r.getOptionKey?r.getOptionKey(v):v.value}function w(v){return r.getOptionLabel?r.getOptionLabel(v):v.label}ct(Ke,{selectedItems:f,searchQuery:u,isOpen:s,props:r,inputId:y,handleBlur:_,getOptionId:L,getDisplayLabel:w});function A(v){var p,l,d,I,q;const i=v.target,a=(p=c.value)==null?void 0:p.inputRef;!((l=a==null?void 0:a.contains)!=null&&l.call(a,i))&&!((d=t.value)!=null&&d.contains(i))&&!((q=(I=b.value)==null?void 0:I.dropdownRef)!=null&&q.contains(i))&&(s.value=!1)}return it(()=>{document.addEventListener("click",A)}),ae(()=>{document.removeEventListener("click",A)}),(v,i)=>(h(),S("div",Jt,[He("div",{ref_key:"wrapperRef",ref:t,class:"av-autocomplete__wrapper"},[k(Ht,{ref_key:"inputRef",ref:c,onSearch:O,onClear:i[0]||(i[0]=a=>g("clear"))},Q({_:2},[m.requiredTip?{name:"requiredTip",fn:D(()=>[(h(),G(Je(m.requiredTip)))]),key:"0"}:void 0]),1536),k(zt,{ref_key:"dropdownRef",ref:b,"show-clear-selection-button":e.showClearSelectionButton,onClearSelection:i[1]||(i[1]=a=>g("clearSelection")),onLoadMore:i[2]||(i[2]=a=>g("loadMore"))},Q({_:2},[m.item?{name:"item",fn:D(({option:a,isSelected:p,toggle:l})=>[R(v.$slots,"item",{option:a,isSelected:p,toggle:l},void 0,!0)]),key:"0"}:void 0,m.empty?{name:"empty",fn:D(()=>[R(v.$slots,"empty",{},void 0,!0)]),key:"1"}:void 0]),1032,["show-clear-selection-button"])],512),k(Gt,null,Q({_:2},[m.selectedItem?{name:"selectedItem",fn:D(({option:a,remove:p})=>[R(v.$slots,"selectedItem",{option:a,remove:p},void 0,!0)]),key:"0"}:void 0]),1024)]))}}),se=ee(ot,[["__scopeId","data-v-d8eda11b"]]);ot.__docgenInfo={exportName:"default",displayName:"AvAutocomplete",description:"",tags:{},props:[{name:"inputOptions",defaultValue:{func:!1,value:"() => ({})"}},{name:"multiSelect",defaultValue:{func:!1,value:"false"}},{name:"dropdownWidth",defaultValue:{func:!1,value:"'100%'"}},{name:"maxDropdownHeight",defaultValue:{func:!1,value:"'20rem'"}},{name:"listOptions",defaultValue:{func:!1,value:`() => ({
  size: 'small',
