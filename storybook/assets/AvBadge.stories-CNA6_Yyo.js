import{n as H,d as K,P as $,f as F,a9 as G,$ as u,a1 as Y,L as Z,e as v,z as j,B as J,X as Q}from"./iframe-D1cPLT2k.js";import{A as ee}from"./AvTooltip-DE8dt9Rq.js";import{u as ae}from"./use-text-truncation-CAu6pqGy.js";import{g as ne}from"./icon-path-u9rVYwcY.js";import{_ as re}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{I as p}from"./icons-CS5vb1aa.js";import{h as f,b as oe}from"./storybook-Bli9j8YZ.js";import"./preload-helper-ILsKNznc.js";const V=H({inheritAttrs:!1,__name:"AvBadge",props:{color:{},backgroundColor:{},borderColor:{default:"transparent"},icon:{},label:{},small:{type:Boolean,default:!1},ellipsis:{type:Boolean,default:!1}},setup(e){Y(n=>({v23fa1d81:n.color,v3d865773:n.backgroundColor,v01f8e635:n.borderColor}));const X=K(()=>ne(e.icon)),m=$(),{isTruncated:b}=ae(m);return(n,te)=>(Z(),F(ee,{content:e.label,disabled:!u(b),"force-focusable":u(b)},{default:G(()=>[v("span",j(n.$attrs,{role:"status",class:["av-badge av-row av-align-center av-py-none av-m-none av-radius-sm",{"av-badge--sm av-px-xxs":e.small,"av-px-xs":!e.small,"av-badge--custom-icon":e.icon,"av-badge--no-icon":!e.icon}],style:u(X)}),[v("span",{ref_key:"labelRef",ref:m,class:J({"av-max-lines":e.ellipsis,"caption-regular":e.small,"b2-regular":!e.small})},Q(e.label),3)],16)]),_:1},8,["content","disabled","force-focusable"]))}}),g=re(V,[["__scopeId","data-v-700d4674"]]);V.__docgenInfo={exportName:"default",displayName:"AvBadge",description:"",tags:{},props:[{name:"color",description:"The color of the text to display in the badge.",required:!0,type:{name:"string"}},{name:"backgroundColor",description:"The background color of the badge.",required:!0,type:{name:"string"}},{name:"borderColor",description:"The color of the badge border.",required:!1,type:{name:"string"}},{name:"icon",description:"The name of the icon or the base64 icon to be displayed.\nYou can use the `XXX_ICONS` and `ICONS_DATA_URL` constants from DSAV.",required:!1,type:{name:"string"}},{name:"label",description:"The text to display in the badge.",required:!0,type:{name:"string"}},{name:"small",description:"If true, displays a reduced-size badge.",tags:{default:[{description:"false",title:"default"}]},required:!1,type:{name:"union",elements:[{name:"boolean"},{name:"undefined"}]}},{name:"ellipsis",description:"If true, the text is truncated with an ellipsis if it is too long.",tags:{default:[{description:"false",title:"default"}]},required:!1,type:{name:"union",elements:[{name:"boolean"},{name:"undefined"}]}}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/badges/AvBadge/AvBadge.vue"]};const be={title:"Components/Badges/AvBadge",component:g,tags:["autodocs"],argTypes:{label:{type:{name:"string",required:!0},control:"text"},color:{control:"color"},backgroundColor:{control:"color"},borderColor:{control:"color"},icon:{control:"select",options:["",...f],mapping:{"":"",...oe}},small:{control:"boolean"},ellipsis:{control:"boolean"}},args:{label:"A super badge",color:"var(--dark-background-primary1)",backgroundColor:"var(--light-background-primary2)",borderColor:"",icon:f[0],small:!1,ellipsis:!1},parameters:{docs:{description:{component:`<h1 class="n1">Badges - <code>AvBadge</code></h1>
...
<ul>
  ...
  template: \`
    <AvBadge v-bind="args" />
  \`
})`,...(R=(w=i.parameters)==null?void 0:w.docs)==null?void 0:R.source}}};var q,U,P;d.parameters={...d.parameters,docs:{...(q=d.parameters)==null?void 0:q.docs,source:{originalSource:`args => ({
  components: {
    AvBadge
  },
  setup() {
  ...
  template: \`
    <AvBadge v-bind="args" />
  \`
})`,...(P=(U=d.parameters)==null?void 0:U.docs)==null?void 0:P.source}}};var W,z,M;c.parameters={...c.parameters,docs:{...(W=c.parameters)==null?void 0:W.docs,source:{originalSource:`args => ({
  components: {
    AvBadge
  },
  setup() {
  ...
  template: \`
    <AvBadge v-bind="args" />
  \`
})`,...(M=(z=c.parameters)==null?void 0:z.docs)==null?void 0:M.source}}};const ve=["Default","WithoutIcon","SmallEllipsis","EllipsisNotTruncated","StatusNotStarted","StatusInProgress","StatusSubmitted","StatusCompleted"];export{r as Default,t as EllipsisNotTruncated,s as SmallEllipsis,c as StatusCompleted,i as StatusInProgress,l as StatusNotStarted,d as StatusSubmitted,o as WithoutIcon,ve as __namedExportsOrder,be as default};
