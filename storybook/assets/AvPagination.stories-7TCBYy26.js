...
<p class="b2-regular">
...
</p>`}}}},c=e=>({components:{AvPagination:ae},setup(){return{args:e}},template:'<AvPagination v-bind="args" />'}),p=c.bind({});p.args={};const P=c.bind({});P.args={currentPage:4};const v=c.bind({});v.args={currentPage:9};const f=c.bind({});f.args={truncLimit:1};const b=c.bind({});b.args={compact:!0};const h=c.bind({});h.args={compact:!0,currentPage:4,compactCurrentPageLabel:"Page 5"};const L=c.bind({});L.args={compact:!0,currentPage:9,compactCurrentPageLabel:"Page 10"};var D,E,O;p.parameters={...p.parameters,docs:{...(D=p.parameters)==null?void 0:D.docs,source:{originalSource:`args => ({
  components: {
    AvPagination
  },
  setup() {
...
})`,...(O=(E=p.parameters)==null?void 0:E.docs)==null?void 0:O.source}}};var $,V,B;P.parameters={...P.parameters,docs:{...($=P.parameters)==null?void 0:$.docs,source:{originalSource:`args => ({
  components: {
    AvPagination
  },
  setup() {
  ...
  template: \`<AvPagination v-bind="args" />\`
})`,...(B=(V=P.parameters)==null?void 0:V.docs)==null?void 0:B.source}}};var F,z,G;v.parameters={...v.parameters,docs:{...(F=v.parameters)==null?void 0:F.docs,source:{originalSource:`args => ({
  components: {
    AvPagination
  },
  setup() {
  ...
  template: \`<AvPagination v-bind="args" />\`
})`,...(G=(z=v.parameters)==null?void 0:z.docs)==null?void 0:G.source}}};var R,j,Q;f.parameters={...f.parameters,docs:{...(R=f.parameters)==null?void 0:R.docs,source:{originalSource:`args => ({
  components: {
    AvPagination
  },
  setup() {
  ...
  template: \`<AvPagination v-bind="args" />\`
})`,...(Q=(j=f.parameters)==null?void 0:j.docs)==null?void 0:Q.source}}};var X,H,J;b.parameters={...b.parameters,docs:{...(X=b.parameters)==null?void 0:X.docs,source:{originalSource:`args => ({
  components: {
    AvPagination
  },
  setup() {
  ...
  template: \`<AvPagination v-bind="args" />\`
})`,...(J=(H=b.parameters)==null?void 0:H.docs)==null?void 0:J.source}}};var K,U,W;h.parameters={...h.parameters,docs:{...(K=h.parameters)==null?void 0:K.docs,source:{originalSource:`args => ({
  components: {
    AvPagination
  },
  setup() {
  ...
  template: \`<AvPagination v-bind="args" />\`
})`,...(_=(Z=L.parameters)==null?void 0:Z.docs)==null?void 0:_.source}}};const Ue=["Default","DefaultMiddlePage","DefaultLastPage","DefaultTruncated","Compact","CompactMiddlePage","CompactLastPage"];export{b as Compact,L as CompactLastPage,h as CompactMiddlePage,p as Default,v as DefaultLastPage,P as DefaultMiddlePage,f as DefaultTruncated,Ue as __namedExportsOrder,Ke as default};
