...
<ul class="b2-regular">
...
</ul>`}}}},e=b=>({components:{AvCheckbox:u},setup(){const p=K([]);return{args:b,model:p}},template:'<AvCheckbox v-bind="args" v-model="model" />'}),Q=b=>({components:{AvCheckbox:u},setup(){const p=K([]);return{args:b,model:p}},template:`
  ...
  template: \`<AvCheckbox v-bind="args" v-model="model" />\`
})`,...(N=(G=m.parameters)==null?void 0:G.docs)==null?void 0:N.source}}};var O,P,Y;i.parameters={...i.parameters,docs:{...(O=i.parameters)==null?void 0:O.docs,source:{originalSource:`args => ({
  components: {
    AvCheckbox
  },
  setup() {
  ...
  template: \`<AvCheckbox v-bind="args" v-model="model" />\`
})`,...(Y=(P=i.parameters)==null?void 0:P.docs)==null?void 0:Y.source}}};var j,z,J;d.parameters={...d.parameters,docs:{...(j=d.parameters)==null?void 0:j.docs,source:{originalSource:`args => ({
  components: {
    AvCheckbox
  },
  setup() {
...
})`,...(J=(z=d.parameters)==null?void 0:z.docs)==null?void 0:J.source}}};const me=["Default","WithIcon","Required","Disabled","Error","Valid","Hint","Small","SmallWithIcon","SmallRequired","LabelSlot"];export{o as Default,s as Disabled,a as Error,c as Hint,d as LabelSlot,r as Required,l as Small,i as SmallRequired,m as SmallWithIcon,t as Valid,n as WithIcon,me as __namedExportsOrder,le as default};
