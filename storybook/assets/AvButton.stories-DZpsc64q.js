import{A as se}from"./AvButton-TNQ4kLrc.js";import{i as ie,g as ue}from"./storybook-Bli9j8YZ.js";import"./AvTooltip-ClvpBT6t.js";import"./iframe-w6PSbEoS.js";import"./preload-helper-ILsKNznc.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvIcon-Bec1qqnI.js";import"./icon-path-u9rVYwcY.js";import"./icons-CS5vb1aa.js";import"./string-BZgCOP9D.js";const ye={title:"Components/Interaction/Buttons/AvButton",component:se,argTypes:{label:{type:{name:"string",required:!0},control:"text"},icon:{control:"select",options:ue,mapping:ie},variant:{control:{type:"radio"},options:["DEFAULT","OUTLINED","FLAT"]},theme:{control:{type:"radio"},options:["PRIMARY","SECONDARY","TERTIARY"]},small:{control:"boolean"},iconOnly:{control:"boolean"},isLoading:{control:"boolean"},iconScale:{control:"number"},noRadius:{control:"boolean"},disabled:{control:"boolean"},disabledTooltip:{control:"text"},noSentenceCase:{control:"boolean"},href:{control:"text"},to:{control:"text"}},args:{label:"Click me",icon:"",variant:"DEFAULT",theme:"PRIMARY",small:!1,iconOnly:!1,isLoading:!1,iconScale:void 0,noRadius:!1,disabled:!1,disabledTooltip:void 0,noSentenceCase:!1,href:void 0,to:void 0},parameters:{docs:{description:{component:`<h1 class="n1">Buttons - <code>AvButton</code></h1>
...
<ul>
...
})`,...(F=(E=r.parameters)==null?void 0:E.docs)==null?void 0:F.source}}};var N,x,Y;o.parameters={...o.parameters,docs:{...(N=o.parameters)==null?void 0:N.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(Y=(x=o.parameters)==null?void 0:x.docs)==null?void 0:Y.source}}};var U,C,w;s.parameters={...s.parameters,docs:{...(U=s.parameters)==null?void 0:U.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(w=(C=s.parameters)==null?void 0:C.docs)==null?void 0:w.source}}};var M,P,G;c.parameters={...c.parameters,docs:{...(M=c.parameters)==null?void 0:M.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(Z=(X=e.parameters)==null?void 0:X.docs)==null?void 0:Z.source}}};var $,nn,en;l.parameters={...l.parameters,docs:{...($=l.parameters)==null?void 0:$.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(en=(nn=l.parameters)==null?void 0:nn.docs)==null?void 0:en.source}}};var tn,an,rn;p.parameters={...p.parameters,docs:{...(tn=p.parameters)==null?void 0:tn.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(rn=(an=p.parameters)==null?void 0:an.docs)==null?void 0:rn.source}}};var on,sn,cn;m.parameters={...m.parameters,docs:{...(on=m.parameters)==null?void 0:on.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(cn=(sn=m.parameters)==null?void 0:sn.docs)==null?void 0:cn.source}}};var un,dn,ln;g.parameters={...g.parameters,docs:{...(un=g.parameters)==null?void 0:un.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(ln=(dn=g.parameters)==null?void 0:dn.docs)==null?void 0:ln.source}}};var pn,mn,gn;v.parameters={...v.parameters,docs:{...(pn=v.parameters)==null?void 0:pn.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(yn=(On=t.parameters)==null?void 0:On.docs)==null?void 0:yn.source}}};var Tn,hn,Dn;A.parameters={...A.parameters,docs:{...(Tn=A.parameters)==null?void 0:Tn.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(Dn=(hn=A.parameters)==null?void 0:hn.docs)==null?void 0:Dn.source}}};var Ln,Sn,Rn;B.parameters={...B.parameters,docs:{...(Ln=B.parameters)==null?void 0:Ln.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(Un=(Yn=T.parameters)==null?void 0:Yn.docs)==null?void 0:Un.source}}};var Cn,wn,Mn;h.parameters={...h.parameters,docs:{...(Cn=h.parameters)==null?void 0:Cn.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(Mn=(wn=h.parameters)==null?void 0:wn.docs)==null?void 0:Mn.source}}};var Pn,Gn,Wn;a.parameters={...a.parameters,docs:{...(Pn=a.parameters)==null?void 0:Pn.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(Wn=(Gn=a.parameters)==null?void 0:Gn.docs)==null?void 0:Wn.source}}};var _n,jn,qn;D.parameters={...D.parameters,docs:{...(_n=D.parameters)==null?void 0:_n.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(qn=(jn=D.parameters)==null?void 0:jn.docs)==null?void 0:qn.source}}};var zn,Vn,Hn;L.parameters={...L.parameters,docs:{...(zn=L.parameters)==null?void 0:zn.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(te=(ee=f.parameters)==null?void 0:ee.docs)==null?void 0:te.source}}};var ae,re,oe;k.parameters={...k.parameters,docs:{...(ae=k.parameters)==null?void 0:ae.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(oe=(re=k.parameters)==null?void 0:re.docs)==null?void 0:oe.source}}};const Te=["Default","DefaultIconOnly","DefaultLoading","DefaultDisabled","DefaultDisabledWithTooltip","DefaultNoRadius","DefaultSecondary","TertiaryOnDarkBackground","Outlined","OutlinedIconOnly","OutlinedLoading","OutlinedDisabled","OutlinedNoRadius","OutlinedSecondary","OutlinedTertiaryOnDarkBackground","Flat","FlatIconOnly","FlatLoading","FlatDisabled","FlatNoRadius","FlatSecondary","FlatTertiaryOnDarkBackground","ExternalLinkButton","LinkButton","LinkButtonOutlined","LinkButtonSecondary","LinkButtonIconOnly","ExternalLinkButtonIconOnly"];export{r as Default,c as DefaultDisabled,i as DefaultDisabledWithTooltip,o as DefaultIconOnly,s as DefaultLoading,u as DefaultNoRadius,d as DefaultSecondary,D as ExternalLinkButton,k as ExternalLinkButtonIconOnly,A as Flat,y as FlatDisabled,B as FlatIconOnly,O as FlatLoading,T as FlatNoRadius,h as FlatSecondary,a as FlatTertiaryOnDarkBackground,L as LinkButton,f as LinkButtonIconOnly,S as LinkButtonOutlined,R as LinkButtonSecondary,l as Outlined,g as OutlinedDisabled,p as OutlinedIconOnly,m as OutlinedLoading,v as OutlinedNoRadius,b as OutlinedSecondary,t as OutlinedTertiaryOnDarkBackground,e as TertiaryOnDarkBackground,Te as __namedExportsOrder,ye as default};
