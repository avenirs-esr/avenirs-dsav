...
<p><span class="b2-regular">None.</span></p>`}}}},C=e=>({components:{AvToggle:c},setup(){return{args:e}},template:'<AvToggle v-bind="args" v-model="args.modelValue" />'}),o=C.bind({});o.args={};const s=C.bind({});s.args={modelValue:!0};const M=e=>({components:{AvToggle:c},setup(){return{args:e}},template:`<div :style="{width: '100px'}"><AvToggle v-bind="args" v-model="args.modelValue" /></div>`}),i=M.bind({});i.args={description:"A long description to see how this works"};var v,h,f;o.parameters={...o.parameters,docs:{...(v=o.parameters)==null?void 0:v.docs,source:{originalSource:`args => ({
  components: {
    AvToggle
  },
  setup() {
...
})`,...(A=(w=i.parameters)==null?void 0:w.docs)==null?void 0:A.source}}};const G=["Default","InitActive","WidthRestrict"];export{o as Default,s as InitActive,i as WidthRestrict,G as __namedExportsOrder,z as default};
