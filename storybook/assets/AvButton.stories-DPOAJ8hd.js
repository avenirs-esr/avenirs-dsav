import{A as te}from"./AvButton-Bhj760nZ.js";import{i as ae,g as oe}from"./storybook-uSYNO3Bs.js";import"./AvTooltip-Dm57a0_W.js";import"./iframe-DnxxszEz.js";import"./preload-helper-ILsKNznc.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvIcon-DEMXgWn8.js";import"./icon-path-u9rVYwcY.js";import"./icons-B0BGqEX0.js";import"./string-BZgCOP9D.js";const be={title:"Components/Interaction/Buttons/AvButton",component:te,argTypes:{label:{type:{name:"string",required:!0},control:"text"},icon:{control:"select",options:oe,mapping:ae},variant:{control:{type:"radio"},options:["DEFAULT","OUTLINED","FLAT"]},theme:{control:{type:"radio"},options:["PRIMARY","SECONDARY","TERTIARY"]},small:{control:"boolean"},iconOnly:{control:"boolean"},isLoading:{control:"boolean"},noRadius:{control:"boolean"},disabled:{control:"boolean"},href:{control:"text"},to:{control:"text"}},args:{label:"Click me",icon:"",variant:"DEFAULT",theme:"PRIMARY",small:!1,iconOnly:!1,isLoading:!1,noRadius:!1,disabled:!1,href:void 0,to:void 0},parameters:{docs:{description:{component:`<h1 class="n1">Buttons - <code>AvButton</code></h1>
...
<ul>
  ...
  <li>
    ...
    `})];const b=n.bind({});b.args={variant:"FLAT"};const A=n.bind({});A.args={variant:"FLAT",iconOnly:!0,icon:"mdi:home-variant-outline",label:"Settings"};const B=n.bind({});B.args={variant:"FLAT",isLoading:!0};const O=n.bind({});O.args={variant:"FLAT",disabled:!0};const y=n.bind({});y.args={variant:"FLAT",noRadius:!0};const L=n.bind({});L.args={variant:"FLAT",theme:"SECONDARY"};const r=n.bind({});r.args={variant:"FLAT",theme:"TERTIARY"};r.decorators=[()=>({template:`
      <div style="background: var(--dark-background-primary1); padding: 24px; display: inline-block;">
        <story />
      </div>
    `})];const h=n.bind({});h.args={href:"https://example.com",label:"Go to external site",variant:"DEFAULT",theme:"PRIMARY"};const D=n.bind({});D.args={to:"/some-route",label:"Go to some route",variant:"DEFAULT",theme:"PRIMARY"};const T=n.bind({});T.args={to:"/some-route",label:"Go to some route",variant:"OUTLINED",theme:"PRIMARY"};const S=n.bind({});S.args={to:"/some-route",label:"Go to some route",variant:"DEFAULT",theme:"SECONDARY"};const R=n.bind({});R.args={to:"/some-route",iconOnly:!0,icon:"mdi:home-variant-outline",label:"Go to some route",variant:"DEFAULT",theme:"PRIMARY"};const k=n.bind({});k.args={href:"https://example.com",iconOnly:!0,icon:"mdi:home-variant-outline",label:"Go to external site",variant:"DEFAULT",theme:"PRIMARY"};var I,f,E;a.parameters={...a.parameters,docs:{...(I=a.parameters)==null?void 0:I.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(On=(Bn=b.parameters)==null?void 0:Bn.docs)==null?void 0:On.source}}};var yn,Ln,hn;A.parameters={...A.parameters,docs:{...(yn=A.parameters)==null?void 0:yn.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(hn=(Ln=A.parameters)==null?void 0:Ln.docs)==null?void 0:hn.source}}};var Dn,Tn,Sn;B.parameters={...B.parameters,docs:{...(Dn=B.parameters)==null?void 0:Dn.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(Fn=(En=y.parameters)==null?void 0:En.docs)==null?void 0:Fn.source}}};var Nn,Yn,xn;L.parameters={...L.parameters,docs:{...(Nn=L.parameters)==null?void 0:Nn.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(xn=(Yn=L.parameters)==null?void 0:Yn.docs)==null?void 0:xn.source}}};var Un,wn,Mn;r.parameters={...r.parameters,docs:{...(Un=r.parameters)==null?void 0:Un.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(Mn=(wn=r.parameters)==null?void 0:wn.docs)==null?void 0:Mn.source}}};var Cn,Pn,Gn;h.parameters={...h.parameters,docs:{...(Cn=h.parameters)==null?void 0:Cn.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(Gn=(Pn=h.parameters)==null?void 0:Pn.docs)==null?void 0:Gn.source}}};var _n,jn,qn;D.parameters={...D.parameters,docs:{...(_n=D.parameters)==null?void 0:_n.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
  ...
  template: \`<AvButton v-bind="args" />\`
})`,...(qn=(jn=D.parameters)==null?void 0:jn.docs)==null?void 0:qn.source}}};var zn,Vn,Hn;T.parameters={...T.parameters,docs:{...(zn=T.parameters)==null?void 0:zn.docs,source:{originalSource:`args => ({
  components: {
    AvButton
  },
  setup() {
