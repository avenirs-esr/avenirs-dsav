import{_ as m}from"./AvNotice-DDfO1r5v.js";import"./iframe-BurKI1QA.js";import"./preload-helper-ILsKNznc.js";import"./string-BZgCOP9D.js";const A={title:"Components/Base/AvNotice",component:m,tags:["autodocs"],argTypes:{title:{control:"text"},text:{control:"text"},type:{control:"radio",options:["info","warning","alert"],description:"The type of notice"}},args:{title:"Attention",text:"Please **read carefully** the instructions.",type:"warning"},parameters:{docs:{description:{component:`<h1 class="n1">Important information banner - <code>AvNotice</code></h1>
