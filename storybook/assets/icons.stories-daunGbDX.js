import"./AvFieldset-C0NEvAOH.js";import"./AvFieldsetElement-pVDmuUNR.js";import{A as c}from"./AvIcon-D_k_tlEE.js";import"./AvIconText-uMYtT1Rx.js";import"./AvNotice-Cte1egCt.js";import{M as u,R as O,I as _}from"./icons-CvJnIbum.js";import"./AvMessage-DCfuRLAw.js";import"./iframe-Dc-nSAC4.js";import"./preload-helper-ILsKNznc.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./string-BZgCOP9D.js";const L={title:"Foundations/3. DSAV icons"},r=()=>({components:{AvIcon:c},setup(){const e=Object.entries(u).map(([t,i])=>[`MDI_ICONS.${t}`,i]),n=Object.entries(O).map(([t,i])=>[`RI_ICONS.${t}`,i]),A=Object.entries(_).map(([t,i])=>[`ICONS_DATA_URL.${t}`,i]);return{icons:[...e,...n,...A]}},template:`
