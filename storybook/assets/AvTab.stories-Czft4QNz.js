import{_ as s}from"./AvTab-fzq25WDC.js";import"./iframe-DuBRBV4Y.js";import"./preload-helper-ILsKNznc.js";const i={title:"Components/Interaction/Tabs/AvTab",component:s,tags:["autodocs"],argTypes:{title:{control:"text"},icon:{control:"text"}},args:{title:"Tab 1",icon:""},parameters:{docs:{description:{component:`<h1 class="n1">Tabs - <code>AvTab</code></h1>
