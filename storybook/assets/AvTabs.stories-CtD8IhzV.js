import{_ as Z}from"./AvTab-FbK77Bqy.js";import{c as I,j as $,X as ee,E as A,G as H,$ as te,L as ae,u as f,m as u,T as ne,v as C,A as w,k as se,W as oe,r as T,a0 as ie,w as R,l as S,K as M,C as re,H as le,y as ce,R as de,O as be,S as ue,e as me,o as pe,q as ve,F as E,B as F,z as fe,J as Te}from"./iframe-Bz6wi0gG.js";import{_ as x}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{A as he}from"./AvIcon-C74a2Zn7.js";import"./preload-helper-ILsKNznc.js";function ge(e){const n={true:"100%",false:"-100%"},s=I(()=>e.value?n.true:n.false),a=I(()=>e.value?n.false:n.true);return{translateValueFrom:s,translateValueTo:a}}const ye=["id","aria-labelledby","tabindex"],O=$({__name:"TabContent",props:{panelId:{},tabId:{},isVisible:{type:Boolean},asc:{type:Boolean}},setup(e){ae(r=>({v669d671c:f(s),v4357d543:f(a)}));const n=e,{translateValueFrom:s,translateValueTo:a}=ge(ee(n,"asc"));return(r,d)=>(u(),A(te,{name:"slide-fade",mode:"in-out"},{default:H(()=>[ne(C("div",{id:e.panelId,class:w(["av-tab-content",{"av-tab-content--selected":e.isVisible}]),role:"tabpanel","aria-labelledby":e.tabId,tabindex:e.isVisible?0:-1},[se(r.$slots,"default",{},void 0,!0)],10,ye),[[oe,e.isVisible]])]),_:3}))}}),U=x(O,[["__scopeId","data-v-41de8f25"]]);O.__docgenInfo={exportName:"default",displayName:"TabContent",description:"",tags:{},props:[{name:"panelId",description:"ID of the associated tab panel.",required:!0,type:{name:"string"}},{name:"tabId",description:"ID of the tab item.",required:!0,type:{name:"string"}},{name:"isVisible",description:"Whether the tab content is visible.",required:!0,type:{name:"boolean"}},{name:"asc",description:`Direction of the tab transition animation.
True for ascending (left to right), false for descending (right to left).`,required:!0,type:{name:"boolean"}}],slots:[{name:"default",description:"Default slot for passing tab panel content."}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/tabs/AvTabs/components/TabContent.vue"]};const Ae=["id","data-testid","tabindex","aria-selected","aria-controls"],W=$({__name:"TabItem",props:{panelId:{},tabId:{},isSelected:{type:Boolean},title:{},icon:{},compact:{type:Boolean,default:!1}},emits:["click","next","previous","first","last"],setup(e,{emit:n}){const s=n,a=T(null),r=ie("button"),d=I(()=>e.isSelected?"s2-bold":"s2-regular"),m={ArrowRight:"next",ArrowLeft:"previous",Home:"first",End:"last"};function v(l){const p=l==null?void 0:l.key,b=m[p];if(b)switch(b){case"next":s("next");break;case"previous":s("previous");break;case"first":s("first");break;case"last":s("last");break}}return R(()=>e.isSelected,()=>{var l;e.isSelected&&((l=r.value)==null||l.focus())}),(l,p)=>{const b=he;return u(),S("li",{class:w(["av-tab-item",{"av-tab-item--compact":e.compact}]),role:"presentation"},[C("button",le(l.$attrs,{id:e.tabId,ref_key:"button",ref:a,"data-testid":`test-${e.tabId}`,class:["av-tab-item__tab",{"av-tab-item--compact__tab":e.compact}],tabindex:e.isSelected?0:-1,role:"tab",type:"button","aria-selected":e.isSelected,"aria-controls":e.panelId,onClick:p[0]||(p[0]=ce(y=>l.$emit("click",e.tabId),["prevent"])),onKeydown:p[1]||(p[1]=y=>v(y))}),[e.icon?(u(),A(b,{key:0,name:e.icon,size:2},null,8,["name"])):M("",!0),C("span",{class:w(f(d))},re(e.title),3)],16,Ae)],2)}}}),K=x(W,[["__scopeId","data-v-e92501ec"]]);W.__docgenInfo={exportName:"default",displayName:"TabItem",description:"",tags:{},props:[{name:"panelId",description:"ID of the associated tab panel.",required:!0,type:{name:"string"}},{name:"tabId",description:"ID of the tab item.",required:!0,type:{name:"string"}},{name:"isSelected",description:"Whether the tab is currently selected.",required:!0,type:{name:"boolean"}},{name:"title",description:"Title of the tab displayed in the tab bar.",required:!0,type:{name:"string"}},{name:"icon",description:"Name of the icon to display in the tab.",required:!1,type:{name:"string"}},{name:"compact",description:"Whether the tab is displayed in compact mode.",tags:{default:[{description:"false",title:"default"}]},required:!1,type:{name:"boolean"}}],events:[{name:"click",type:{names:["string"]},description:"Emitted when the tab is clicked.",properties:[{type:{names:["mixed"]},name:"tabId",description:"The ID of the clicked tab."}],tags:[{title:"param",type:{name:"mixed"},name:"tabId",description:"The ID of the clicked tab."}]},{name:"next",description:"Emitted when the user navigates to the next tab."},{name:"previous",description:"Emitted when the user navigates to the previous tab."},{name:"first",description:"Emitted when the user navigates to the first tab."},{name:"last",description:"Emitted when the user navigates to the last tab."}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/tabs/AvTabs/components/TabItem.vue"]};function Ie(e,n,s){const a=T({"--tabs-height":"100px"});function r(){if(s.value<0||!e.value||!e.value.offsetHeight)return;const d=e.value.offsetHeight,m=n.value[s.value];if(!m||!m.offsetHeight)return;const v=m.offsetHeight;a.value["--tabs-height"]=`${d+v}px`}return{tabsStyle:a,updateTabsStyle:r}}const we=["aria-label"],P=$({__name:"AvTabs",props:de({ariaLabel:{},compact:{type:Boolean,default:!1}},{modelValue:{default:0},modelModifiers:{}}),emits:["update:modelValue"],setup(e){const n=be(),s=I(()=>{var t;return((t=n.default)==null?void 0:t.call(n))||[]}),a=ue(e,"modelValue"),r=T(!1),d=T(null),m=T(null),v=me({}),{tabsStyle:l,updateTabsStyle:p}=Ie(m,I(()=>{var t;return Array.from(((t=d.value)==null?void 0:t.querySelectorAll(".av-tab-content"))||[])}),a);function b(t){if(v[t])return v[t];const o=`tab-${crypto.randomUUID()}`;return v[t]=o,o}function y(t){const o=s.value.length;a.value=(a.value+t+o)%o}function J(){r.value=!1,y(-1)}function X(){r.value=!0,y(1)}function Q(){a.value=0}function Y(){a.value=s.value.length-1}const k=T(null);return pe(()=>{var t;window.ResizeObserver&&(k.value=new window.ResizeObserver(()=>{p()})),(t=d.value)==null||t.querySelectorAll(".av-tab-content").forEach(o=>{var c;o&&((c=k.value)==null||c.observe(o))})}),ve(()=>{var t,o;(t=d.value)==null||t.querySelectorAll(".av-tab-content").forEach(c=>{var i;c&&((i=k.value)==null||i.unobserve(c))}),(o=k.value)==null||o.disconnect()}),R(a,(t,o)=>{r.value=t>o}),(t,o)=>(u(),S("div",{ref_key:"$el",ref:d,class:w(["av-tabs",{"av-tabs--compact":e.compact}]),style:fe(f(l))},[C("ul",{ref_key:"tablist",ref:m,class:w(["av-tabs__list",{"av-tabs__list--compact":e.compact}]),role:"tablist","aria-label":e.ariaLabel??"Liste d’onglets"},[(u(!0),S(E,null,F(f(s),(c,i)=>{var D,q;return u(),A(K,{key:i,"tab-id":b(i),"panel-id":`${b(i)}-panel`,title:(D=c.props)==null?void 0:D.title,icon:(q=c.props)==null?void 0:q.icon,compact:e.compact,"is-selected":a.value===i,onClick:ke=>a.value=i,onNext:X,onPrevious:J,onFirst:Q,onLast:Y},null,8,["tab-id","panel-id","title","icon","compact","is-selected","onClick"])}),128))],10,we),(u(!0),S(E,null,F(f(s),(c,i)=>(u(),A(U,{key:i,"panel-id":`${b(i)}-panel`,"tab-id":b(i),"is-visible":a.value===i,asc:f(r)},{default:H(()=>[a.value===i?(u(),A(Te(c.children.default),{key:0})):M("",!0)]),_:2},1032,["panel-id","tab-id","is-visible","asc"]))),128))],6))}}),j=x(P,[["__scopeId","data-v-7799e79a"]]);P.__docgenInfo={exportName:"default",displayName:"AvTabs",description:"",tags:{},props:[{name:"ariaLabel",description:`Aria label for tab list.
...
<p>
...
</p>`}}}},G=e=>({components:{AvTabs:j,AvTab:Z,TabContent:U,TabItem:K},setup(){const n=T(0);return{args:e,activeTab:n}},template:`
  ...
  `}),h=G.bind({});h.args={};h.parameters={docs:{source:{code:`
      ...
      `}}};const g=G.bind({});g.args={compact:!0};g.parameters={docs:{source:{code:`
