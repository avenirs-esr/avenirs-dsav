import"./AvFieldset-B9bgAm_0.js";import"./AvFieldsetElement-CUDGhyDA.js";import{A as c}from"./AvIcon-49-Fyb5m.js";import"./AvIconText-YadecgPS.js";import"./AvNotice-CKptAJqF.js";import{M as u,R as O,I as _}from"./icons-BZJLfc_p.js";import"./AvMessage-BfrOVeLa.js";import"./iframe-Brfx2YmW.js";import"./preload-helper-ILsKNznc.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./string-BZgCOP9D.js";const L={title:"Foundations/3. DSAV icons"},r=()=>({components:{AvIcon:c},setup(){const e=Object.entries(u).map(([t,i])=>[`MDI_ICONS.${t}`,i]),n=Object.entries(O).map(([t,i])=>[`RI_ICONS.${t}`,i]),A=Object.entries(_).map(([t,i])=>[`ICONS_DATA_URL.${t}`,i]);return{icons:[...e,...n,...A]}},template:`
