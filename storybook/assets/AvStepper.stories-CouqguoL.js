import{d as G,W as H,a,f as s,A as e,F as b,i as f,J as K,e as p,B as g,t as _}from"./iframe-CILu2PJe.js";import{_ as M}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-ILsKNznc.js";const Q={class:"custom-width-container"},U={class:"block-container"},X={class:"main-container"},Y=["aria-current"],Z=["aria-current"],$={class:"b1-regular"},ee={class:"main-labels-container"},R=G({__name:"AvStepper",props:{steps:{},currentStep:{},width:{default:"100%"}},setup(m){K(P=>({v06d1bdf1:e(O)}));const J=m,{steps:v,currentStep:r,width:O}=H(J);return(P,S)=>(p(),a("div",Q,[s("div",U,[s("div",X,[s("div",{class:"step step--active","aria-current":e(r)===0?"step":void 0},[...S[0]||(S[0]=[s("span",{class:"b1-regular"},"1",-1)])],8,Y),(p(!0),a(b,null,f(e(v).slice(1,e(v).length),(h,t)=>(p(),a("div",{key:t,class:"steps-container"},[s("div",{class:g(["separator",{"separator--active":t+1<=e(r)}])},null,2),s("div",{class:g(["step",{"step--active":t+1<=e(r)}]),"aria-current":t+1===e(r)?"step":void 0},[s("span",$,_(t+2),1)],10,Z)]))),128))]),s("div",ee,[(p(!0),a(b,null,f(e(v),(h,t)=>(p(),a("div",{key:t,class:"label-container"},[s("span",{class:g(["label",{"b1-bold":t<=e(r),"b1-light":t>e(r)}])},_(h),3)]))),128))])])]))}}),j=M(R,[["__scopeId","data-v-26a5b40e"]]);R.__docgenInfo={exportName:"default",displayName:"AvStepper",description:"",tags:{},props:[{name:"steps",description:"List of steps to display in the stepper.",required:!0,type:{name:"Array",elements:[{name:"string"}]}},{name:"currentStep",description:"Index of the current step (starts at 0).",required:!0,type:{name:"number"}},{name:"width",description:"Width of the stepper.",tags:{default:[{description:"'100%'",title:"default"}]},required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'100%'"}}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/navigation/AvStepper/AvStepper.vue"]};const ne={title:"Components/Navigation/AvStepper",component:j,tags:["autodocs"],argTypes:{steps:{control:{type:"object",required:!0}},currentStep:{control:{type:"number",required:!0}},width:{control:"text"}},args:{steps:["Step 1: Init","Step 2: Develop a feature","Step 3: Deploy"],currentStep:0},parameters:{docs:{description:{component:`<h2 class="n2">✨ Introduction</h2>
...
<ul>
  ...
  template: \`<AvStepper v-bind="args" />\`
})`,...(B=(I=l.parameters)==null?void 0:I.docs)==null?void 0:B.source}}};var N,V,x;u.parameters={...u.parameters,docs:{...(N=u.parameters)==null?void 0:N.docs,source:{originalSource:`args => ({
  components: {
    AvStepper
  },
  setup() {
  ...
  template: \`<AvStepper v-bind="args" />\`
})`,...(x=(V=u.parameters)==null?void 0:V.docs)==null?void 0:x.source}}};var z,E,L;d.parameters={...d.parameters,docs:{...(z=d.parameters)==null?void 0:z.docs,source:{originalSource:`args => ({
  components: {
    AvStepper
  },
  setup() {
