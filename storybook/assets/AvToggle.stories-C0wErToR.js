...
<p><span class="b2-regular">None.</span></p>`}}}},V=e=>({components:{AvToggle:v},setup(){return{args:e}},template:'<AvToggle v-bind="args" v-model="args.modelValue" />'}),l=V.bind({});l.args={};const d=V.bind({});d.args={modelValue:!0};const ee=e=>({components:{AvToggle:v},setup(){return{args:e}},template:`<div :style="{width: '10px'}"><AvToggle v-bind="args" v-model="args.modelValue" /></div>`}),r=ee.bind({});r.args={description:"A long description to see how this works"};var f,x,b;l.parameters={...l.parameters,docs:{...(f=l.parameters)==null?void 0:f.docs,source:{originalSource:`args => ({
  ...
  template: \`<AvToggle v-bind="args" v-model="args.modelValue" />\`
})`,...(y=(T=d.parameters)==null?void 0:T.docs)==null?void 0:y.source}}};var C,A,I;r.parameters={...r.parameters,docs:{...(C=r.parameters)==null?void 0:C.docs,source:{originalSource:`args => ({
  components: {
    AvToggle
  },
  setup() {
...
})`,...(I=(A=r.parameters)==null?void 0:A.docs)==null?void 0:I.source}}};const oe=["Default","InitActive","WidthRestrict"];export{l as Default,d as InitActive,r as WidthRestrict,oe as __namedExportsOrder,ne as default};
