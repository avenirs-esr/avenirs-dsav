import{A as w}from"./AvIcon-CX97yXwg.js";import{A as y}from"./AvIconText-BEEX3yYy.js";import{g as a,i as A}from"./storybook-BXgy7yVt.js";import"./iframe-Bngxkj9X.js";import"./preload-helper-ILsKNznc.js";import"./icon-path-u9rVYwcY.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvTooltip-DT1cL-14.js";import"./use-text-truncation-CpnyAgz1.js";import"./icons-0dWeWY1j.js";const I=["n1","n2","n3","n4","n5","n6","s1-bold","s1-regular","s1-light","s2-bold","s2-regular","s2-light","b1-bold","b1-regular","b1-light","b2-bold","b2-regular","b2-light","caption-bold","caption-regular","caption-light"],M={title:"Components/Base/AvIconText",component:y,tags:["autodocs"],argTypes:{textColor:{control:"color"},iconColor:{control:"color"},icon:{control:"select",options:a,mapping:A},text:{control:"text",type:{name:"string",required:!0}},typographyClass:{control:"select",options:["",...I]},gap:{control:"text"},inline:{control:"boolean"},wrapAnywhere:{control:"boolean"}},args:{textColor:"var(--text1)",iconColor:"var(--text1)",icon:a[0],text:"Example text with icon",typographyClass:"b2-regular",gap:"var(--spacing-xs)",inline:!1,wrapAnywhere:!1},parameters:{docs:{description:{component:`<h1 class="n1">Texts with icon - <code>AvIconText</code></h1>
...
<ul>
  ...
  \`
})`,...(d=(p=e.parameters)==null?void 0:p.docs)==null?void 0:d.source}}};var m,g,u;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`args => ({
  components: {
    AvIconText,
    AvIcon
  },
  ...
  \`
})`,...(u=(g=o.parameters)==null?void 0:g.docs)==null?void 0:u.source}}};var h,v,x;t.parameters={...t.parameters,docs:{...(h=t.parameters)==null?void 0:h.docs,source:{originalSource:`args => ({
  components: {
    AvIconText,
    AvIcon
  },
  ...
  \`
})`,...(x=(v=t.parameters)==null?void 0:v.docs)==null?void 0:x.source}}};const N=["Default","InlineNoEllipsis","CustomColors","WrapAnywhere"];export{o as CustomColors,n as Default,e as InlineNoEllipsis,t as WrapAnywhere,N as __namedExportsOrder,M as default};
