...
<ul>
  ...
  \`
})`,...(B=(C=o.parameters)==null?void 0:C.docs)==null?void 0:B.source}}};var S,k,I;s.parameters={...s.parameters,docs:{...(S=s.parameters)==null?void 0:S.docs,source:{originalSource:`args => ({
  components: {
    AvBadge
  },
  setup() {
  ...
  template: \`
    <AvBadge v-bind="args" />
  \`
})`,...(I=(k=s.parameters)==null?void 0:k.docs)==null?void 0:I.source}}};var T,N,x;t.parameters={...t.parameters,docs:{...(T=t.parameters)==null?void 0:T.docs,source:{originalSource:`args => ({
  components: {
    AvBadge
  },
  setup() {
  ...
  template: \`
    <AvBadge v-bind="args" />
  \`
})`,...(E=(_=l.parameters)==null?void 0:_.docs)==null?void 0:E.source}}};var L,O,w;i.parameters={...i.parameters,docs:{...(L=i.parameters)==null?void 0:L.docs,source:{originalSource:`args => ({
  components: {
    AvBadge
  },
  setup() {
  ...
  template: \`
    <AvBadge v-bind="args" />
  \`
})`,...(w=(O=i.parameters)==null?void 0:O.docs)==null?void 0:w.source}}};const se=["Default","WithoutIcon","SmallEllipsis","StatusNotStarted","StatusInProgress","StatusSubmitted","StatusCompleted"];export{n as Default,o as SmallEllipsis,i as StatusCompleted,t as StatusInProgress,s as StatusNotStarted,l as StatusSubmitted,r as WithoutIcon,se as __namedExportsOrder,oe as default};
