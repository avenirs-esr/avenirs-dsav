import{A as o}from"./AvVIcon-8vmFNpku.js";import{d as f,b as g,e as i,k as c,f as l,a as b,C as v,i as a}from"./iframe-CM3fYS2g.js";import{_ as y}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./vue-dsfr-keweR0Qw.js";import"./preload-helper-ILsKNznc.js";const k=["title","aria-label"],R={class:"av-rich-button__line"},B={class:"av-rich-button__left"},p=f({__name:"AvRichButton",props:{label:{},iconLeft:{default:()=>{}},iconRight:{default:()=>{}},customPadding:{default:"var(--spacing-sm)"},onClick:{type:Function}},setup(t){return v(e=>({v4a373320:e.customPadding})),(e,s)=>(a(),g("button",{class:"av-rich-button",title:t.label,"aria-label":t.label,onClick:s[0]||(s[0]=(...h)=>t.onClick&&t.onClick(...h))},[i("div",R,[i("div",B,[t.iconLeft?(a(),c(o,{key:0,name:t.iconLeft,color:"var(--dark-background-primary1)",size:1.5},null,8,["name"])):l("",!0),b(e.$slots,"default",{},void 0,!0)]),t.iconRight?(a(),c(o,{key:0,name:t.iconRight,color:"var(--dark-background-primary1)",size:1.5},null,8,["name"])):l("",!0)])],8,k))}}),m=y(p,[["__scopeId","data-v-f0871dc1"]]);p.__docgenInfo={exportName:"default",displayName:"AvRichButton",description:"",tags:{},props:[{name:"label",description:"Button aria label and title for accessibility.",required:!0,type:{name:"string"}},{name:"iconLeft",description:`Icon displayed on the left of the button.
...
</ul>`}}}},A=t=>({components:{AvRichButton:m,AvVIcon:o},setup(){return{args:t}},template:`
