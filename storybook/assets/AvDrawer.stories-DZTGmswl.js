import{A as k}from"./AvButton-B38MxCq9.js";import{A as l}from"./AvDrawer-CyV3nJLH.js";import{P as x}from"./iframe-T1PdNDhM.js";import"./AvTooltip-DVbJ7XaX.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvIcon-sXUIOxgk.js";import"./icon-path-u9rVYwcY.js";import"./icons-CS5vb1aa.js";import"./theme.types-DKH7g3eH.js";import"./string-BZgCOP9D.js";import"./index-DKreFUEA.js";import"./focus-trap-vue.esm-browser-qDNRcd9z.js";import"./focus-trap.esm-CPw4bcQR.js";import"./preload-helper-ILsKNznc.js";const _={title:"Components/Overlay/Drawers/AvDrawer",component:l,tags:["autodocs"],argTypes:{show:{control:"boolean"},position:{control:"select",options:["left","right"]},width:{control:"text"},backdrop:{control:"boolean"},padding:{control:"text"}},args:{show:!0,position:"right",width:"35rem",backdrop:!0,padding:"var(--spacing-md)"},parameters:{docs:{story:{height:"25rem"},description:{component:`<h1 class="n1">Drawers - <code>AvDrawer</code></h1>
...
<ul>
...
</ul>`}}}},s=e=>({components:{AvDrawer:l,AvButton:k},setup(){const n=x(e.show);return{args:e,isDrawerOpen:n,toggleDrawer:()=>{n.value=!n.value},closeDrawer:()=>{n.value=!1}}},template:`
    <div>
      <AvButton
        label="Toggle Drawer"
        @click="toggleDrawer"
  ...
  `}),r=s.bind({});r.args={};const a=s.bind({});a.args={position:"left"};const t=s.bind({});t.args={backdrop:!1};const o=s.bind({});o.args={width:"25rem"};const E=e=>({components:{AvDrawer:l,AvButton:k},setup(){const n=x(e.show);return{args:e,isDrawerOpen:n,toggleDrawer:()=>{n.value=!n.value},closeDrawer:()=>{n.value=!1}}},template:`
    <div>
      <AvButton
        label="Toggle Drawer"
        @click="toggleDrawer"
  ...
  `}),i=E.bind({});i.args={};var c,p,d;r.parameters={...r.parameters,docs:{...(c=r.parameters)==null?void 0:c.docs,source:{originalSource:`args => ({
  components: {
    AvDrawer,
    AvButton
  },
  ...
  \`
})`,...(d=(p=r.parameters)==null?void 0:p.docs)==null?void 0:d.source}}};var g,m,v;a.parameters={...a.parameters,docs:{...(g=a.parameters)==null?void 0:g.docs,source:{originalSource:`args => ({
  components: {
    AvDrawer,
    AvButton
  },
  ...
  \`
})`,...(O=(b=i.parameters)==null?void 0:b.docs)==null?void 0:O.source}}};const q=["Default","LeftPosition","WithoutBackdrop","CustomWidth","WithFooter"];export{o as CustomWidth,r as Default,a as LeftPosition,i as WithFooter,t as WithoutBackdrop,q as __namedExportsOrder,_ as default};
