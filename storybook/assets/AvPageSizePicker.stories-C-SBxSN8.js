...
</p>`}}}},S=e=>({components:{AvPageSizePicker:a},setup(){return{args:e}},template:'<AvPageSizePicker v-bind="args" />'}),n=S.bind({});n.args={};var s,i,p;n.parameters={...n.parameters,docs:{...(s=n.parameters)==null?void 0:s.docs,source:{originalSource:`args => ({
  components: {
    AvPageSizePicker
  },
  setup() {
