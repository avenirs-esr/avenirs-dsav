import{A as p}from"./AvIcon-DyEyqkTx.js";import{M as m}from"./icons-sccjonKC.js";import{h as n,b as u}from"./storybook-CubYrWDl.js";import"./iframe-zT1H-5pF.js";import"./preload-helper-ILsKNznc.js";import"./icon-path-u9rVYwcY.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const y={title:"Components/Base/AvIcon",component:p,tags:["autodocs"],argTypes:{name:{control:"select",options:n,mapping:u},size:{control:{type:"range",min:.5,max:5,step:.25},description:"Size in rem of the container and icon scale"},animation:{control:"select",options:["spin","wrench","pulse","spin-pulse","flash","float","ring",void 0]},speed:{control:"radio",options:["fast","slow",void 0]},flip:{control:"radio",options:["horizontal","vertical","both",void 0]},color:{control:"color"},title:{control:"text"}},args:{name:n[0],size:2,animation:void 0,speed:void 0,flip:void 0,color:"var(--text1)",title:"Some icon"},parameters:{docs:{description:{component:`<h1 class="n1">Messages - <code>AvMessage</code></h1>
