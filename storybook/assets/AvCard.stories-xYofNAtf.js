import{A as Z}from"./AvButton-CxiOnB0K.js";import{d as G,S as J,r as k,c as K,e as i,i as d,W as Q,N as E,E as A,u as r,F as y,h as ee,Z as te,M as ae,g as c}from"./iframe-BzX4UFBz.js";import{M as O}from"./icons-CvJnIbum.js";import{_ as ne}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvIcon-CT6v9gSI.js";import"./string-BZgCOP9D.js";import"./preload-helper-ILsKNznc.js";const re=["id","aria-hidden"],oe={key:0,class:"av-card__body"},le={key:1,class:"av-card__footer"},L=G({__name:"AvCard",props:{titleOnly:{type:Boolean,default:!1},backgroundColor:{default:"var(--card)"},borderColor:{default:"var(--stroke)"},titleBackground:{default:"var(--surface-background)"},titleHeight:{},collapsible:{type:Boolean,default:!1},collapsed:{type:Boolean,default:!1}},setup(e){ae(t=>({v0b2ce2f9:t.borderColor}));const h=J(),o=k(e.collapsed),C=k(!1),S=K(()=>`av-card-${crypto.randomUUID()}`),l=k(null);function B(t){const n=["A","BUTTON","INPUT","SELECT","TEXTAREA"],a=["button","link","checkbox","radio","textbox","tab","menuitem"];if(n.includes(t.tagName))return!0;const s=t.getAttribute("role");return!!(s&&a.includes(s)||t.hasAttribute("tabindex")&&t.getAttribute("tabindex")!=="-1")}function P(t){var s;const n=t.target;if(l.value&&(n===l.value.$el||l.value.$el.contains(n)))return;let a=n;for(;a&&a!==t.currentTarget;){if(B(a))return;a=a.parentElement}e.collapsible&&(o.value=!o.value,(s=l.value)==null||s.$el.focus())}function X(t){if(!e.collapsible)return;const n=t.target;if(l.value&&(n===l.value.$el||l.value.$el.contains(n))){C.value=!1;return}let a=n;for(;a&&a!==t.currentTarget;){if(B(a)){C.value=!0;return}a=a.parentElement}C.value=!1}return(t,n)=>{const a=Z;return c(),i("div",{class:A(["av-card av-col av-p-sm av-justify-start",{"av-card--collapsible":e.collapsible,"av-card--hovering-interactive":r(C)}]),style:E({borderColor:e.borderColor,background:e.backgroundColor}),onClick:P,onMousemove:X},[h.title?(c(),i("header",{key:0,class:A(["av-card__title av-row av-align-center av-justify-between av-p-sm av-gap-sm",{"av-card__title--collapsed":r(o),"av-card__title--title-only":e.titleOnly}]),style:E({background:e.titleBackground,minHeight:e.titleHeight,maxHeight:e.titleHeight})},[y(t.$slots,"title",{},void 0,!0),e.collapsible?(c(),ee(a,{key:0,ref_key:"buttonRef",ref:l,"aria-controls":`${r(S)}-content`,"aria-expanded":!r(o),icon:r(o)?r(O).CHEVRON_DOWN:r(O).CHEVRON_LEFT,"icon-only":"",label:"Details",onClick:n[0]||(n[0]=s=>o.value=!r(o))},null,8,["aria-controls","aria-expanded","icon"])):d("",!0)],6)):d("",!0),e.titleOnly?d("",!0):Q((c(),i("div",{key:1,id:`${r(S)}-content`,"aria-hidden":e.collapsible&&r(o),class:A(["av-card__content-collapsible av-col av-justify-between av-h-full av-gap-sm",{"av-pt-sm":!!h.title}])},[y(t.$slots,"default",{},void 0,!0),h.body?(c(),i("div",oe,[y(t.$slots,"body",{},void 0,!0)])):d("",!0),h.footer?(c(),i("div",le,[y(t.$slots,"footer",{},void 0,!0)])):d("",!0)],10,re)),[[te,!e.collapsible||!r(o)]])],38)}}}),T=ne(L,[["__scopeId","data-v-f24c73d5"]]);L.__docgenInfo={exportName:"default",displayName:"AvCard",description:"",tags:{},props:[{name:"titleOnly",description:"If true, the card will be displayed in title-only mode.",tags:{default:[{description:"false",title:"default"}]},required:!1,type:{name:"boolean"}},{name:"backgroundColor",description:"The background color of the card.",tags:{default:[{description:"'var(--card)'",title:"default"}]},required:!1,type:{name:"string"}},{name:"borderColor",description:"The border color of the card.",tags:{default:[{description:"'var(--stroke)'",title:"default"}]},required:!1,type:{name:"string"}},{name:"titleBackground",description:"The background color of the card title.",tags:{default:[{description:"'var(--surface-background)'",title:"default"}]},required:!1,type:{name:"string"}},{name:"titleHeight",description:"The height of the card title.",required:!1,type:{name:"string"}},{name:"collapsible",description:`Whether the card is collapsible. When collapsed, the title is still shown.
...
<p>
  ...
  \`
})`,...($=(D=u.parameters)==null?void 0:D.docs)==null?void 0:$.source}}};var x,H,M;p.parameters={...p.parameters,docs:{...(x=p.parameters)==null?void 0:x.docs,source:{originalSource:`args => ({
  components: {
    AvCard
  },
  setup() {
  ...
  \`
})`,...(M=(H=p.parameters)==null?void 0:H.docs)==null?void 0:M.source}}};var I,N,W;m.parameters={...m.parameters,docs:{...(I=m.parameters)==null?void 0:I.docs,source:{originalSource:`args => ({
  components: {
    AvCard
  },
  setup() {
  ...
  \`
})`,...(W=(N=m.parameters)==null?void 0:N.docs)==null?void 0:W.source}}};var F,q,_;b.parameters={...b.parameters,docs:{...(F=b.parameters)==null?void 0:F.docs,source:{originalSource:`args => ({
  components: {
    AvCard
  },
  setup() {
  ...
  \`
})`,...(_=(q=b.parameters)==null?void 0:q.docs)==null?void 0:_.source}}};var R,Y,U;g.parameters={...g.parameters,docs:{...(R=g.parameters)==null?void 0:R.docs,source:{originalSource:`args => ({
  components: {
    AvCard
  },
  setup() {
