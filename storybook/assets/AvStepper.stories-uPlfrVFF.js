import{d as G,X as H,b as a,e as s,B as e,F as b,j as _,C as J,i as p,n as g,t as f}from"./iframe-CCrYptT9.js";import{_ as K}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-ILsKNznc.js";const M={class:"custom-width-container"},Q={class:"block-container"},U={class:"main-container"},Y=["aria-current"],Z=["aria-current"],$={class:"b1-regular"},ee={class:"main-labels-container"},L=G({__name:"AvStepper",props:{steps:{},currentStep:{},width:{default:"100%"}},setup(m){J(X=>({v06d1bdf1:e(P)}));const O=m,{steps:v,currentStep:r,width:P}=H(O);return(X,S)=>(p(),a("div",M,[s("div",Q,[s("div",U,[s("div",{class:"step step--active","aria-current":e(r)===0?"step":void 0},[...S[0]||(S[0]=[s("span",{class:"b1-regular"},"1",-1)])],8,Y),(p(!0),a(b,null,_(e(v).slice(1,e(v).length),(h,t)=>(p(),a("div",{key:t,class:"steps-container"},[s("div",{class:g(["separator",{"separator--active":t+1<=e(r)}])},null,2),s("div",{class:g(["step",{"step--active":t+1<=e(r)}]),"aria-current":t+1===e(r)?"step":void 0},[s("span",$,f(t+2),1)],10,Z)]))),128))]),s("div",ee,[(p(!0),a(b,null,_(e(v),(h,t)=>(p(),a("div",{key:t,class:"label-container"},[s("span",{class:g(["label",{"b1-bold":t<=e(r),"b1-light":t>e(r)}])},f(h),3)]))),128))])])]))}}),R=K(L,[["__scopeId","data-v-26a5b40e"]]);L.__docgenInfo={exportName:"default",displayName:"AvStepper",description:"",tags:{},props:[{name:"steps",description:"List of steps to display in the stepper.",required:!0,type:{name:"Array",elements:[{name:"string"}]}},{name:"currentStep",description:"Index of the current step (starts at 0).",required:!0,type:{name:"number"}},{name:"width",description:"Width of the stepper.",tags:{default:[{description:"'100%'",title:"default"}]},required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'100%'"}}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/navigation/AvStepper/AvStepper.vue"]};const ne={title:"Components/Navigation/AvStepper",component:R,tags:["autodocs"],argTypes:{steps:{control:{type:"object",required:!0}},currentStep:{control:{type:"number",required:!0}},width:{control:"text"}},args:{steps:["Step 1: Init","Step 2: Develop a feature","Step 3: Deploy"],currentStep:0},parameters:{docs:{description:{component:`<h2 class="n2">✨ Introduction</h2>
