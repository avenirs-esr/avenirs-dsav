import{d as ue,c as o,e as pe,z as S,I as ce,u as i,A as y,f as D,K as ge,g as me}from"./iframe-BrPawN0u.js";import{c as f,t as Q,A as x,p as be,i as Me}from"./AvInput-DQc2f8H8.js";import{_ as he}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-ILsKNznc.js";import"./AvMessage-px8Gq9A5.js";import"./AvIconText-DQT8H-Pw.js";import"./AvIcon-nhEBg3lp.js";import"./icons-CvJnIbum.js";function ve(e,s){let d,r=s==null?void 0:s.in;return e.forEach(t=>{!r&&typeof t=="object"&&(r=f.bind(null,t));const l=Q(t,r);(!d||d<l||isNaN(+l))&&(d=l)}),f(r,d||NaN)}function fe(e,s){let d,r=s==null?void 0:s.in;return e.forEach(t=>{!r&&typeof t=="object"&&(r=f.bind(null,t));const l=Q(t,r);(!d||d>l||isNaN(+l))&&(d=l)}),f(r,d||NaN)}const Ve=["for"],X=ue({__name:"AvPeriodInput",props:{id:{},label:{},labelClass:{default:"b2-light"},startModelValue:{default:""},endModelValue:{default:""},startLabel:{},endLabel:{},disabled:{type:Boolean,default:!1},width:{},startMinDate:{},startMaxDate:{},endMinDate:{},endMaxDate:{},stacked:{type:Boolean,default:!1},separatorSpacing:{default:"var(--spacing-sm)"}},emits:["update:startModelValue","update:endModelValue","change"],setup(e,{emit:s}){const d=s,r=o(()=>e.id??`period-input-${crypto.randomUUID()}`),t=o(()=>`${r.value}__start`),l=o(()=>`${r.value}__end`),_=o(()=>e.stacked?{height:e.separatorSpacing}:{width:e.separatorSpacing});function U(n){if(!n)return;const a=be(n);return Me(a)?a:void 0}function ee(n,a){return n&&a?ve([n,a]):n??a}function ae(n,a){return n&&a?fe([n,a]):n??a}const ne=o(()=>U(e.startModelValue)),te=o(()=>U(e.endModelValue)),de=o(()=>e.startMinDate),re=o(()=>ae(e.startMaxDate,te.value)),se=o(()=>ee(e.endMinDate,ne.value)),oe=o(()=>e.endMaxDate);function le(n){const a=(n==null?void 0:n.toString())??"";d("update:startModelValue",a),d("change",{start:a,end:e.endModelValue})}function ie(n){const a=(n==null?void 0:n.toString())??"";d("update:endModelValue",a),d("change",{start:e.startModelValue,end:a})}return(n,a)=>(me(),pe("div",{class:y(["av-period-input av-col av-gap-xxs",{"av-period-input--stacked":e.stacked}])},[S("label",{class:y(e.labelClass),for:i(t),"data-testid":"common-label"},ce(e.label),11,Ve),S("div",{class:y(["av-period-input__row",{"av-row av-align-end":!e.stacked,"av-col av-align-stretch":e.stacked}])},[D(x,{id:i(t),type:"date","model-value":e.startModelValue,label:e.startLabel,"label-visible":!1,disabled:e.disabled,"aria-disabled":e.disabled,width:e.width,"min-date":i(de),"max-date":i(re),"data-testid":"start-date-input","onUpdate:modelValue":a[0]||(a[0]=V=>le(V))},null,8,["id","model-value","label","disabled","aria-disabled","width","min-date","max-date"]),S("div",{class:"av-period-input__separator","aria-hidden":"true",style:ge(i(_))},null,4),D(x,{id:i(l),type:"date","model-value":e.endModelValue,label:e.endLabel,"label-visible":!1,disabled:e.disabled,"aria-disabled":e.disabled,width:e.width,"min-date":i(se),"max-date":i(oe),"data-testid":"end-date-input","onUpdate:modelValue":a[1]||(a[1]=V=>ie(V))},null,8,["id","model-value","label","disabled","aria-disabled","width","min-date","max-date"])],2)],2))}}),Z=he(X,[["__scopeId","data-v-37655fcc"]]);X.__docgenInfo={exportName:"default",displayName:"AvPeriodInput",description:"",tags:{},props:[{name:"id",description:"Unique id for the period input",tags:{default:[{description:"`period-input-${crypto.randomUUID()}`",title:"default"}]},required:!1,type:{name:"string"}},{name:"label",description:"Label displayed above the two inputs",required:!0,type:{name:"string"}},{name:"labelClass",description:"CSS class for the label",tags:{default:[{description:"'b2-light'",title:"default"}]},required:!1,type:{name:"string"}},{name:"startModelValue",description:"Start date value (ISO string: YYYY-MM-DD)",tags:{default:[{description:"''",title:"default"}]},required:!1,type:{name:"string"}},{name:"endModelValue",description:"End date value (ISO string: YYYY-MM-DD)",tags:{default:[{description:"''",title:"default"}]},required:!1,type:{name:"string"}},{name:"startLabel",description:`Label for the start input (optional).
...
<p>
  <span class="b2-regular">
    ...
    <AvPeriodInput
      ...
      @change="onChange"
    />
  `}),p=u.bind({});p.args={};const c=u.bind({});c.args={startModelValue:"2026-01-10",endModelValue:"2026-01-20"};const g=u.bind({});g.args={width:"14.875rem"};const m=u.bind({});m.args={width:"14.875rem",separatorSpacing:"1rem"};const b=u.bind({});b.args={disabled:!0,startModelValue:"2026-01-10",endModelValue:"2026-01-20",width:"14.875rem"};const M=u.bind({});M.args={stacked:!0,width:"14.875rem",separatorSpacing:"1rem"};const h=u.bind({});h.args={width:"14.875rem",startMinDate:new Date("2026-01-01"),endMaxDate:new Date("2026-12-31")};const v=u.bind({});v.args={startModelValue:"2026-01-10",endModelValue:"2026-01-20",width:"14.875rem"};var I,C,E;p.parameters={...p.parameters,docs:{...(I=p.parameters)==null?void 0:I.docs,source:{originalSource:`args => ({
  components: {
    AvPeriodInput
  },
  setup() {
  ...
  template: \`
    ...
    />
  \`
})`,...(E=(C=p.parameters)==null?void 0:C.docs)==null?void 0:E.source}}};var w,A,P;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:`args => ({
  components: {
    AvPeriodInput
  },
  setup() {
  ...
  template: \`
    ...
    />
  \`
})`,...(W=(B=m.parameters)==null?void 0:B.docs)==null?void 0:W.source}}};var Y,O,j;b.parameters={...b.parameters,docs:{...(Y=b.parameters)==null?void 0:Y.docs,source:{originalSource:`args => ({
  components: {
    AvPeriodInput
  },
  setup() {
  ...
  template: \`
    ...
    />
  \`
})`,...(j=(O=b.parameters)==null?void 0:O.docs)==null?void 0:j.source}}};var T,$,z;M.parameters={...M.parameters,docs:{...(T=M.parameters)==null?void 0:T.docs,source:{originalSource:`args => ({
  components: {
    AvPeriodInput
  },
  setup() {
  ...
  template: \`
    ...
    />
  \`
})`,...(z=($=M.parameters)==null?void 0:$.docs)==null?void 0:z.source}}};var F,R,K;h.parameters={...h.parameters,docs:{...(F=h.parameters)==null?void 0:F.docs,source:{originalSource:`args => ({
  components: {
    AvPeriodInput
  },
  setup() {
  ...
  template: \`
    ...
    />
  \`
})`,...(K=(R=h.parameters)==null?void 0:R.docs)==null?void 0:K.source}}};var G,H,J;v.parameters={...v.parameters,docs:{...(G=v.parameters)==null?void 0:G.docs,source:{originalSource:`args => ({
  components: {
    AvPeriodInput
  },
  setup() {
  ...
  template: \`
    ...
    />
  \`
})`,...(J=(H=v.parameters)==null?void 0:H.docs)==null?void 0:J.source}}};const Ae=["Default","Prefilled","WithWidth","WithCustomSpacing","Disabled","Stacked","WithExternalBounds","WithRangeBehavior"];export{p as Default,b as Disabled,c as Prefilled,M as Stacked,m as WithCustomSpacing,h as WithExternalBounds,v as WithRangeBehavior,g as WithWidth,Ae as __namedExportsOrder,we as default};
