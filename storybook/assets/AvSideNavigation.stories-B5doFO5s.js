import{M as o}from"./icons-CAbb_h1G.js";import{d as L,M as g,N as v,H as f,I as h,o as p,E as O,u as S,a as R,F as B,g as D,n as q,r as a}from"./iframe-C_qbK98L.js";import{A as z,a as F}from"./AvListItem-ZIGN6f7t.js";import{A as V}from"./AvSideMenu-BAx6Pn6o.js";import{_ as P}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-ILsKNznc.js";import"./AvIcon-C3XddoTO.js";import"./AvButton-CL1z587w.js";import"./string-BZgCOP9D.js";const W=L({__name:"AvSideNavigation",props:g({items:{},selectedItem:{},isSideMenuCollapsed:{type:Boolean},collapsedWidth:{default:"3.5rem"},selectedItemColor:{}},{selectedItem:{default:""},selectedItemModifiers:{},isSideMenuCollapsed:{type:Boolean,default:!1},isSideMenuCollapsedModifiers:{}}),emits:g(["update:selectedItem","update:isSideMenuCollapsed"],["update:selectedItem","update:isSideMenuCollapsed"]),setup(e){const t=v(e,"selectedItem"),s=v(e,"isSideMenuCollapsed");function E(m){t.value=m}return(m,u)=>(p(),f(V,{collapsed:s.value,"onUpdate:collapsed":u[0]||(u[0]=i=>s.value=i),"collapsed-width":e.collapsedWidth,color:e.selectedItemColor},{default:h(()=>[O(S(z),{size:"small",role:"menu"},{default:h(()=>[(p(!0),R(B,null,D(e.items,i=>(p(),f(S(F),{key:i.id,title:s.value?void 0:i.label,icon:i.icon,"icon-size":1.8,selected:t.value===i.id,"hover-background-color":e.selectedItemColor,tag:"button",role:"menuitem",class:q(["av-side-navigation__menu-item",{"av-side-navigation__menu-item--collapsed":s.value}]),clickable:"",onClick:j=>E(i.id)},null,8,["title","icon","selected","hover-background-color","class","onClick"]))),128))]),_:1})]),_:1},8,["collapsed","collapsed-width","color"]))}}),n=P(W,[["__scopeId","data-v-3c5a1abd"]]);W.__docgenInfo={exportName:"default",displayName:"AvSideNavigation",description:"",tags:{},props:[{name:"items",description:"List of items to display in the side navigation.",required:!0,type:{name:"Array",elements:[{name:"AvSideNavigationItem"}]}},{name:"selectedItem",description:"The currently selected item ID.",required:!1,type:{name:"string"}},{name:"isSideMenuCollapsed",description:"Whether the side menu is collapsed or not.",required:!1,type:{name:"boolean"}},{name:"collapsedWidth",description:"Width of the side menu when collapsed.",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'3.5rem'"}},{name:"selectedItemColor",description:"Color of selected item background and icon.",required:!1,type:{name:"string"}}],events:[{name:"update:selectedItem",type:{names:["string"]},description:"Emitted when the selected item changes.",properties:[{type:{names:["mixed"]},name:"value",description:"The ID of the newly selected item"}],tags:[{title:"param",type:{name:"mixed"},name:"value",description:"The ID of the newly selected item"}]},{name:"update:isSideMenuCollapsed",type:{names:["boolean"]},description:"Emitted when the side menu collapse state changes.",properties:[{type:{names:["mixed"]},name:"value",description:"New collapsed state (true for collapsed, false for expanded)"}],tags:[{title:"param",type:{name:"mixed"},name:"value",description:"New collapsed state (true for collapsed, false for expanded)"}]}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/navigation/AvSideNavigation/AvSideNavigation.vue"]};const U=[{id:"careers",label:"Career Information",icon:o.BRIEFCASE_VARIANT_OUTLINE},{id:"educations",label:"Educational Background",icon:o.SCHOOL_OUTLINE},{id:"experiences",label:"Professional Experience",icon:o.VECTOR_POLYGON_VARIANT},{id:"activities",label:"Activities & Projects",icon:o.TARGET_ARROW}],ee={title:"Components/Navigation/AvSideNavigation",component:n,tags:["autodocs"],argTypes:{items:{description:"Array of navigation items with id, label, and icon",control:{type:"object"}},collapsedWidth:{description:"Width of the side menu when collapsed",control:{type:"text"}},selectedItem:{description:"Currently selected item ID (v-model)",control:{type:"text"}},isSideMenuCollapsed:{description:"Whether the side menu is collapsed (v-model)",control:{type:"boolean"}}},args:{items:U,collapsedWidth:"3.5rem"},parameters:{docs:{description:{component:`<h1 class="n1">Navigation - <code>AvSideNavigation</code></h1>
...
<ul>
  ...
  <li><span class="b2-regular">Responsive design with customizable widths</span></li>
</ul>`}}}},l={render:e=>({components:{AvSideNavigation:n},setup(){const t=a("careers"),s=a(!1);return{args:e,selectedItem:t,isSideMenuCollapsed:s}},template:`
    ...
    `})},d={render:e=>({components:{AvSideNavigation:n},setup(){const t=a("educations"),s=a(!0);return{args:e,selectedItem:t,isSideMenuCollapsed:s}},template:`
      <div style="height: 400px; display: flex;">
        <AvSideNavigation 
          v-bind="args"
          v-model:selected-item="selectedItem"
    ...
    `})},r={render:e=>({components:{AvSideNavigation:n},setup(){const t=a("experiences"),s=a(!1);return{args:e,selectedItem:t,isSideMenuCollapsed:s}},template:`
      <div style="height: 400px; display: flex;">
        <AvSideNavigation 
          v-bind="args"
          v-model:selected-item="selectedItem"
    ...
    `}),args:{collapsedWidth:"5rem"}},c={render:e=>({components:{AvSideNavigation:n},setup(){const t=a("activities"),s=a(!1);return{args:e,selectedItem:t,isSideMenuCollapsed:s}},template:`
      <div style="height: 400px; display: flex;">
        <AvSideNavigation 
          v-bind="args"
          v-model:selected-item="selectedItem"
...
}`,...(_=(k=c.parameters)==null?void 0:k.docs)==null?void 0:_.source}}};const se=["Default","Collapsed","CustomWidth","CustomColor"];export{d as Collapsed,c as CustomColor,r as CustomWidth,l as Default,se as __namedExportsOrder,ee as default};
