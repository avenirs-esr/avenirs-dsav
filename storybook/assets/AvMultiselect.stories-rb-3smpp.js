...
<ul>
...
</ul>`}}}},u=d=>({components:{AvMultiselect:E},setup(){return{args:d}},template:'<AvMultiselect v-bind="args" v-model="args.modelValue" />'}),o=u.bind({});o.args={label:"Select"};const r=u.bind({});r.args={dense:!0,label:"Dense Select"};const i=u.bind({});i.args={options:[{value:"1",label:"Choice 1",icon:n.ATTACH_FILE},{value:"2",label:"Choice 2",icon:n.CHAT_ALERT},{value:"3",label:"Choice 3",icon:n.CONTENT_SAVE_OUTLINE},{value:"4",label:"Choice 4",icon:n.ELECTRON_FRAMEWORK},{value:"5",label:"Choice 5",icon:n.IMAGE_OUTLINE}],label:"Options with icon"};var A,M,x;o.parameters={...o.parameters,docs:{...(A=o.parameters)==null?void 0:A.docs,source:{originalSource:`args => ({
  components: {
    AvMultiselect
  },
  setup() {
...
})`,...(x=(M=o.parameters)==null?void 0:M.docs)==null?void 0:x.source}}};var C,V,_;r.parameters={...r.parameters,docs:{...(C=r.parameters)==null?void 0:C.docs,source:{originalSource:`args => ({
  components: {
    AvMultiselect
  },
  setup() {
  ...
  template: \`<AvMultiselect v-bind="args" v-model="args.modelValue" />\`
})`,...(_=(V=r.parameters)==null?void 0:V.docs)==null?void 0:_.source}}};var T,I,O;i.parameters={...i.parameters,docs:{...(T=i.parameters)==null?void 0:T.docs,source:{originalSource:`args => ({
  components: {
    AvMultiselect
  },
  setup() {
