import{A as m}from"./AvSideMenu-DWwCFMIU.js";import{M as n}from"./icons-jAutzxlg.js";import{L as g,a2 as C}from"./iframe-B_YSsmfE.js";import"./AvButton-B1ubh-Uf.js";import"./AvIcon-Ch7tBmpB.js";import"./icon-path-u9rVYwcY.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./string-BZgCOP9D.js";import"./preload-helper-ILsKNznc.js";const le={title:"Components/Navigation/AvSideMenu",component:m,tags:["autodocs"],argTypes:{collapsible:{control:"boolean"},width:{control:"text"},collapsedWidth:{control:"text"},sticky:{control:"boolean"},stickyOffset:{control:"text"}},args:{collapsible:!0,width:"16rem",collapsedWidth:"5rem"},parameters:{docs:{description:{component:`<h1 class="n1">Navigation - <code>AvSideMenu</code></h1>
...
<ul>
...
</ul>`}}}},u=e=>({components:{AvSideMenu:m},setup(){const a=g(e.collapsed??!1);return C(()=>e.collapsed,i=>{a.value=i??!1}),{args:e,isCollapsed:a,handleCollapseChange:i=>{a.value=i},MDI_ICONS:n}},template:`
  ...
  `}),o=u.bind({});o.args={};const t=u.bind({});t.args={collapsed:!0};const r=u.bind({});r.args={collapsed:!0,hideContentWhenCollapsed:!0};const d=u.bind({});d.args={collapsible:!1};const p=u.bind({});p.args={width:"20rem",collapsedWidth:"3rem"};const D=e=>({components:{AvSideMenu:m},setup(){const a=g(e.collapsed??!1),l=g("/");C(()=>e.collapsed,s=>{a.value=s??!1});const i=[{path:"/",label:"Mon parcours",icon:n.HOME_VARIANT_OUTLINE},{path:"/formations",label:"Mes formations",icon:n.BOOK_LOCATION_OUTLINE},{path:"/experiences",label:"Mes expériences",icon:n.BRIEFCASE_VARIANT_OUTLINE},{path:"/activities",label:"Mes activités",icon:n.STAR_SHOOTING_OUTLINE}];return{args:e,isCollapsed:a,activeRoute:l,navigationItems:i,handleCollapseChange:s=>{a.value=s},setActiveRoute:s=>{l.value=s}}},template:`
    <div style="height: 600px; display: flex; border: 1px solid var(--divider); border-radius: var(--radius-md);">
      <AvSideMenu
        v-bind="args"
        v-model:collapsed="isCollapsed"
  ...
  `,methods:{getIconPath(a){const l={[n.HOME_VARIANT_OUTLINE]:"M9 14h6v7h5v-8h3L12 3 2 12h3v9h4z",[n.BOOK_LOCATION_OUTLINE]:"M19 2L13 8l6 6 5-6-5-6zM9 4c0-1.11-.89-2-2-2S5 2.89 5 4s.89 2 2 2 2-.89 2-2zm9 13c0-1.11-.89-2-2-2s-2 .89-2 2 .89 2 2 2 2-.89 2-2z",[n.BRIEFCASE_VARIANT_OUTLINE]:"M10 2h4a2 2 0 0 1 2 2v2h4a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4V4a2 2 0 0 1 2-2zm4 4V4h-4v2h4zm6 3H4v10h16V9z",[n.STAR_SHOOTING_OUTLINE]:"M14.84 13.5l-1.91 1.91L12 16.34l-.93-.93-1.91-1.91L7.34 12l1.82-1.82L12 8.34l2.84 2.84L16.66 12l-1.82 1.5z"};return l[a]||l[n.HOME_VARIANT_OUTLINE]}}}),c=D.bind({});c.args={};const W=e=>({components:{AvSideMenu:m},setup(){const a=g(e.collapsed??!1);return C(()=>e.collapsed,l=>{a.value=l??!1}),{args:e,isCollapsed:a}},template:`
  ...
  \`
})`,...(Z=(U=h.parameters)==null?void 0:U.docs)==null?void 0:Z.source}}};const ne=["Default","Collapsed","HiddenContentCollapsed","NonCollapsible","CustomWidth","StudentNavigation","Minimal","Sticky"];export{t as Collapsed,p as CustomWidth,o as Default,r as HiddenContentCollapsed,v as Minimal,d as NonCollapsible,h as Sticky,c as StudentNavigation,ne as __namedExportsOrder,le as default};
