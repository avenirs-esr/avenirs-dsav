import{A as d}from"./AvSideNavigation-vAnZflwM.js";import{M as i}from"./icons-DoXnPNNW.js";import{r as e}from"./iframe-CHZpZ21y.js";import"./AvCheckboxListItem-DrFmW6oC.js";import"./AvList-CUpAs56w.js";import"./AvIcon-DFOePn3O.js";import"./icon-path-u9rVYwcY.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./AvCheckbox-XIzWvUeL.js";import"./AvFieldsetElement-CNdbFHe7.js";import"./AvMessage-7YqaYKHv.js";import"./AvIconText-ChKqnHVL.js";import"./AvSideMenu-B9boX94q.js";import"./AvButton-D4eILf6n.js";import"./string-BZgCOP9D.js";import"./preload-helper-ILsKNznc.js";const _=[{id:"careers",label:"Career Information",icon:i.BRIEFCASE_VARIANT_OUTLINE},{id:"educations",label:"Educational Background",icon:i.SCHOOL_OUTLINE},{id:"experiences",label:"Professional Experience",icon:i.VECTOR_POLYGON_VARIANT},{id:"activities",label:"Activities & Projects",icon:i.TARGET_ARROW}],L=[{id:"default",label:"Default item",icon:i.BRIEFCASE_VARIANT_OUTLINE},{id:"menu-expanded",label:"Menu Expanded",icon:i.SCHOOL_OUTLINE,children:[{id:"subitem-1-1",label:"Subitem 1-1",icon:i.CHEVRON_RIGHT},{id:"subitem-1-2",label:"Subitem 1-2"},{id:"subitem-1-3",label:"Subitem 1-3",icon:i.CHEVRON_RIGHT}],expanded:!0},{id:"collapsed-menu",label:"Collapsed Menu",icon:i.VECTOR_POLYGON_VARIANT,children:[{id:"subitem-2-1",label:"Subitem 2-1",icon:i.CHEVRON_RIGHT},{id:"subitem-2-2",label:"Subitem 2-2",icon:i.CHEVRON_RIGHT}]}],Z={title:"Components/Navigation/AvSideNavigation",component:d,tags:["autodocs"],argTypes:{items:{control:{type:"object"}},width:{control:{type:"text"}},collapsedWidth:{control:{type:"text"}},selectedItem:{control:{type:"object"}},isSideMenuCollapsed:{control:{type:"boolean"}}},args:{items:_,collapsedWidth:"3.5rem",width:"fit-content"},parameters:{docs:{description:{component:`<h1 class="n1">Navigation - <code>AvSideNavigation</code></h1>
...
<ul>
  ...
  <li><span class="b2-regular">Responsive design with customizable widths</span></li>
    ...
    `})},a={render:t=>({components:{AvSideNavigation:d},setup(){const s=e({itemId:"subitem-1-1",parentId:"menu-expanded"}),n=e(!1);return{args:{...t,items:L},selectedItem:s,isSideMenuCollapsed:n}},template:`
    ...
    `}),args:{selectedItemColor:"var(--dark-background-warn)"}};var g,u,v;o.parameters={...o.parameters,docs:{...(g=o.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: args => ({
    components: {
      AvSideNavigation
    },
...
}`,...(v=(u=o.parameters)==null?void 0:u.docs)==null?void 0:v.source}}};var I,f,h;a.parameters={...a.parameters,docs:{...(I=a.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: args => ({
    components: {
      AvSideNavigation
    },
...
}`,...(h=(f=a.parameters)==null?void 0:f.docs)==null?void 0:h.source}}};var S,b,C;l.parameters={...l.parameters,docs:{...(S=l.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: args => ({
    components: {
      AvSideNavigation
    },
...
}`,...(C=(b=l.parameters)==null?void 0:b.docs)==null?void 0:C.source}}};var y,M,x;r.parameters={...r.parameters,docs:{...(y=r.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: args => ({
    components: {
      AvSideNavigation
    },
...
}`,...(x=(M=r.parameters)==null?void 0:M.docs)==null?void 0:x.source}}};var A,N,w;p.parameters={...p.parameters,docs:{...(A=p.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: args => ({
    components: {
      AvSideNavigation
    },
...
}`,...(w=(N=p.parameters)==null?void 0:N.docs)==null?void 0:w.source}}};var T,k,O;c.parameters={...c.parameters,docs:{...(T=c.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: args => ({
    components: {
      AvSideNavigation
    },
...
}`,...(O=(k=c.parameters)==null?void 0:k.docs)==null?void 0:O.source}}};var R,E,P;m.parameters={...m.parameters,docs:{...(R=m.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: args => ({
    components: {
      AvSideNavigation
    },
...
}`,...(P=(E=m.parameters)==null?void 0:E.docs)==null?void 0:P.source}}};const $=["Default","MenuItems","Collapsed","HiddenContentCollapsed","CustomdWidth","CustomCollapsedWidth","CustomColor"];export{l as Collapsed,c as CustomCollapsedWidth,m as CustomColor,p as CustomdWidth,o as Default,r as HiddenContentCollapsed,a as MenuItems,$ as __namedExportsOrder,Z as default};
