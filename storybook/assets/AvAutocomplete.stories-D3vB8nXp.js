import{A as vt,a as Ye}from"./AvList-B0Aw9hyK.js";import{M as $}from"./icons-DLnh1uvi.js";import{q as gt,o as pe,G as ht,x as me,a1 as Ze,a2 as bt,a3 as yt,V as St,a4 as x,a5 as oe,c as M,l as we,B as v,d as ae,U as se,r as V,g as fe,b as D,f as ve,p as At,n as Ot,k as Z,y as W,e as et,a as F,w as R,z as tt,i as I,F as ue,j as ot,a6 as ne,M as nt,O as Ie,P as _t,S as wt}from"./iframe-CM3fYS2g.js";import{A as It}from"./AvVIcon-8vmFNpku.js";import{_ as ie}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{A as lt}from"./AvButton-BM5d_lLZ.js";import{A as Tt}from"./AvInput-BmWrhSN-.js";import"./preload-helper-ILsKNznc.js";import"./vue-dsfr-keweR0Qw.js";const rt=Symbol("AvAutocompleteContext");function ge(){const e=gt(rt);if(!e)throw new Error("useAutocompleteContext must be used within AvAutocomplete component");return e}function at(e){return bt()?(yt(e),!0):!1}const xt=typeof window<"u"&&typeof document<"u";typeof WorkerGlobalScope<"u"&&globalThis instanceof WorkerGlobalScope;const Lt=e=>e!=null,Dt=Object.prototype.toString,kt=e=>Dt.call(e)==="[object Object]",P=()=>{};function st(e,o){function n(...r){return new Promise((c,i)=>{Promise.resolve(e(()=>o.apply(this,r),{fn:o,thisArg:this,args:r})).then(c).catch(i)})}return n}function Ct(e,o={}){let n,r,c=P;const i=t=>{clearTimeout(t),c(),c=P};let d;return t=>{const a=x(e),p=x(o.maxWait);return n&&i(n),a<=0||p!==void 0&&p<=0?(r&&(i(r),r=void 0),Promise.resolve(t())):new Promise((y,S)=>{c=o.rejectOnCancel?S:y,d=t,p&&!r&&(r=setTimeout(()=>{n&&i(n),r=void 0,y(d())},p)),n=setTimeout(()=>{r&&i(r),r=void 0,y(t())},a)})}}function Mt(...e){let o=0,n,r=!0,c=P,i,d,l,t,a;!St(e[0])&&typeof e[0]=="object"?{delay:d,trailing:l=!0,leading:t=!0,rejectOnCancel:a=!1}=e[0]:[d,l=!0,t=!0,a=!1]=e;const p=()=>{n&&(clearTimeout(n),n=void 0,c(),c=P)};return S=>{const b=x(d),O=Date.now()-o,_=()=>i=S();return p(),b<=0?(o=Date.now(),_()):(O>b&&(t||!r)?(o=Date.now(),_()):l&&(i=new Promise((T,w)=>{c=a?w:T,n=setTimeout(()=>{o=Date.now(),r=!0,T(_()),p()},Math.max(0,b-O))})),!t&&!n&&(n=setTimeout(()=>r=!0,b)),r=!1,i)}}function le(e){return Array.isArray(e)?e:[e]}function Vt(e){return Ze()}function qt(e,o=200,n={}){return st(Ct(o,n),e)}function Et(e,o=200,n=!1,r=!0,c=!1){return st(Mt(o,n,r,c),e)}function Nt(e,o=!0,n){Vt()?pe(e,n):o?e():ht(e)}function jt(e,o,n){return me(e,o,{...n,immediate:!0})}const he=xt?window:void 0;function be(e){var o;const n=x(e);return(o=n==null?void 0:n.$el)!=null?o:n}function Te(...e){const o=[],n=()=>{o.forEach(l=>l()),o.length=0},r=(l,t,a,p)=>(l.addEventListener(t,a,p),()=>l.removeEventListener(t,a,p)),c=M(()=>{const l=le(x(e[0])).filter(t=>t!=null);return l.every(t=>typeof t!="string")?l:void 0}),i=jt(()=>{var l,t;return[(t=(l=c.value)==null?void 0:l.map(a=>be(a)))!=null?t:[he].filter(a=>a!=null),le(x(c.value?e[1]:e[0])),le(v(c.value?e[2]:e[1])),x(c.value?e[3]:e[2])]},([l,t,a,p])=>{if(n(),!(l!=null&&l.length)||!(t!=null&&t.length)||!(a!=null&&a.length))return;const y=kt(p)?{...p}:p;o.push(...l.flatMap(S=>t.flatMap(b=>a.map(O=>r(S,b,O,y)))))},{flush:"post"}),d=()=>{i(),n()};return at(n),d}function Rt(){const e=oe(!1),o=Ze();return o&&pe(()=>{e.value=!0},o),e}function Wt(e){const o=Rt();return M(()=>(o.value,!!e()))}function Ft(e,o,n={}){const{window:r=he,...c}=n;let i;const d=Wt(()=>r&&"MutationObserver"in r),l=()=>{i&&(i.disconnect(),i=void 0)},t=M(()=>{const S=x(e),b=le(S).map(be).filter(Lt);return new Set(b)}),a=me(t,S=>{l(),d.value&&S.size&&(i=new MutationObserver(o),S.forEach(b=>i.observe(b,c)))},{immediate:!0,flush:"post"}),p=()=>i==null?void 0:i.takeRecords(),y=()=>{a(),l()};return at(y),{isSupported:d,stop:y,takeRecords:p}}const xe=1;function $t(e,o={}){const{throttle:n=0,idle:r=200,onStop:c=P,onScroll:i=P,offset:d={left:0,right:0,top:0,bottom:0},observe:l={mutation:!1},eventListenerOptions:t={capture:!1,passive:!0},behavior:a="auto",window:p=he,onError:y=m=>{console.error(m)}}=o,S=typeof l=="boolean"?{mutation:l}:l,b=oe(0),O=oe(0),_=M({get(){return b.value},set(m){w(m,void 0)}}),T=M({get(){return O.value},set(m){w(void 0,m)}});function w(m,E){var L,B,H,ee;if(!p)return;const C=x(e);if(!C)return;(H=C instanceof Document?p.document.body:C)==null||H.scrollTo({top:(L=x(E))!=null?L:T.value,left:(B=x(m))!=null?B:_.value,behavior:x(a)});const q=((ee=C==null?void 0:C.document)==null?void 0:ee.documentElement)||(C==null?void 0:C.documentElement)||C;_!=null&&(b.value=q.scrollLeft),T!=null&&(O.value=q.scrollTop)}const g=oe(!1),s=we({left:!0,right:!1,top:!0,bottom:!1}),u=we({left:!1,right:!1,top:!1,bottom:!1}),f=m=>{g.value&&(g.value=!1,u.left=!1,u.right=!1,u.top=!1,u.bottom=!1,c(m))},h=qt(f,n+r),A=m=>{var E;if(!p)return;const L=((E=m==null?void 0:m.document)==null?void 0:E.documentElement)||(m==null?void 0:m.documentElement)||be(m),{display:B,flexDirection:H,direction:ee}=getComputedStyle(L),C=ee==="rtl"?-1:1,q=L.scrollLeft;u.left=q<b.value,u.right=q>b.value;const Se=Math.abs(q*C)<=(d.left||0),Ae=Math.abs(q*C)+L.clientWidth>=L.scrollWidth-(d.right||0)-xe;B==="flex"&&H==="row-reverse"?(s.left=Ae,s.right=Se):(s.left=Se,s.right=Ae),b.value=q;let N=L.scrollTop;m===p.document&&!N&&(N=p.document.body.scrollTop),u.top=N<O.value,u.bottom=N>O.value;const Oe=Math.abs(N)<=(d.top||0),_e=Math.abs(N)+L.clientHeight>=L.scrollHeight-(d.bottom||0)-xe;B==="flex"&&H==="column-reverse"?(s.top=_e,s.bottom=Oe):(s.top=Oe,s.bottom=_e),O.value=N},k=m=>{var E;if(!p)return;const L=(E=m.target.documentElement)!=null?E:m.target;A(L),g.value=!0,h(m),i(m)};return Te(e,"scroll",n?Et(k,n,!0,!1):k,t),Nt(()=>{try{const m=x(e);if(!m)return;A(m)}catch(m){y(m)}}),S!=null&&S.mutation&&e!=null&&e!==p&&e!==document&&Ft(e,()=>{const m=x(e);m&&A(m)},{attributes:!0,childList:!0,subtree:!0}),Te(e,"scrollend",f,t),{x:_,y:T,isScrolling:g,arrivedState:s,directions:u,measure(){const m=x(e);p&&m&&A(m)}}}var Pt=typeof global=="object"&&global&&global.Object===Object&&global,zt=typeof self=="object"&&self&&self.Object===Object&&self,it=Pt||zt||Function("return this")(),re=it.Symbol,ct=Object.prototype,Bt=ct.hasOwnProperty,Ht=ct.toString,U=re?re.toStringTag:void 0;function Ut(e){var o=Bt.call(e,U),n=e[U];try{e[U]=void 0;var r=!0}catch{}var c=Ht.call(e);return r&&(o?e[U]=n:delete e[U]),c}var Gt=Object.prototype,Kt=Gt.toString;function Jt(e){return Kt.call(e)}var Qt="[object Null]",Xt="[object Undefined]",Le=re?re.toStringTag:void 0;function Yt(e){return e==null?e===void 0?Xt:Qt:Le&&Le in Object(e)?Ut(e):Jt(e)}function Zt(e){return e!=null&&typeof e=="object"}var eo="[object Symbol]";function to(e){return typeof e=="symbol"||Zt(e)&&Yt(e)==eo}var oo=/\s/;function no(e){for(var o=e.length;o--&&oo.test(e.charAt(o)););return o}var lo=/^\s+/;function ro(e){return e&&e.slice(0,no(e)+1).replace(lo,"")}function de(e){var o=typeof e;return e!=null&&(o=="object"||o=="function")}var De=NaN,ao=/^[-+]0x[0-9a-f]+$/i,so=/^0b[01]+$/i,io=/^0o[0-7]+$/i,co=parseInt;function ke(e){if(typeof e=="number")return e;if(to(e))return De;if(de(e)){var o=typeof e.valueOf=="function"?e.valueOf():e;e=de(o)?o+"":o}if(typeof e!="string")return e===0?e:+e;e=ro(e);var n=so.test(e);return n||io.test(e)?co(e.slice(2),n?2:8):ao.test(e)?De:+e}var ce=function(){return it.Date.now()},uo="Expected a function",po=Math.max,mo=Math.min;function ut(e,o,n){var r,c,i,d,l,t,a=0,p=!1,y=!1,S=!0;if(typeof e!="function")throw new TypeError(uo);o=ke(o)||0,de(n)&&(p=!!n.leading,y="maxWait"in n,i=y?po(ke(n.maxWait)||0,o):i,S="trailing"in n?!!n.trailing:S);function b(h){var A=r,k=c;return r=c=void 0,a=h,d=e.apply(k,A),d}function O(h){return a=h,l=setTimeout(w,o),p?b(h):d}function _(h){var A=h-t,k=h-a,m=o-A;return y?mo(m,i-k):m}function T(h){var A=h-t,k=h-a;return t===void 0||A>=o||A<0||y&&k>=i}function w(){var h=ce();if(T(h))return g(h);l=setTimeout(w,_(h))}function g(h){return l=void 0,S&&r?b(h):(r=c=void 0,d)}function s(){l!==void 0&&clearTimeout(l),a=0,r=t=c=l=void 0}function u(){return l===void 0?d:g(ce())}function f(){var h=ce(),A=T(h);if(r=arguments,c=this,t=h,A){if(l===void 0)return O(t);if(y)return clearTimeout(l),l=setTimeout(w,o),b(t)}return l===void 0&&(l=setTimeout(w,o)),d}return f.cancel=s,f.flush=u,f}var j=(e=>(e.LOADING="loading",e.NO_OPTIONS="no-options",e.HAS_OPTIONS="has-options",e))(j||{});const fo={key:0,class:"av-autocomplete-dropdown__loading"},vo={key:1,class:"av-autocomplete-dropdown__empty"},go={key:1,class:"av-autocomplete-dropdown__empty-text"},dt=ae({__name:"AvAutocompleteDropdown",emits:["loadMore"],setup(e,{expose:o,emit:n}){const r=n,c=se(),{selectedItems:i,searchQuery:d,isOpen:l,props:t,getOptionId:a,getDisplayLabel:p}=ge(),y=V(),S=V(),b=M(()=>{if(!t.options)return[];if(t.serverSideFiltering)return t.maxResults?t.options.slice(0,t.maxResults):t.options;const s=d.value.toLowerCase().trim();if(!s){const f=t.options;return t.maxResults?f.slice(0,t.maxResults):f}let u;return t.filterOptions?u=t.filterOptions(t.options,s):u=t.options.filter(f=>p(f).toLowerCase().includes(s)),t.maxResults?u.slice(0,t.maxResults):u}),O=M(()=>t.loading?j.LOADING:l.value&&t.options&&t.options.length>0&&b.value.length>0?j.HAS_OPTIONS:j.NO_OPTIONS);function _(s){return i.value.some(u=>a(u)===a(s))}function T(s){if(!t.multiSelect){i.value=[s],l.value=!1,d.value="";return}const u=i.value,f=a(s);u.some(A=>a(A)===f)?i.value=u.filter(A=>a(A)!==f):i.value=[...u,s]}const{arrivedState:w}=$t(S,{throttle:100}),g=ut(()=>{r("loadMore")},t.loadMoreThrottleDelay);return me(()=>w.bottom,s=>{t.enableLoadMore&&s&&l.value&&g()}),fe(()=>{g.cancel()}),o({dropdownRef:y}),(s,u)=>v(l)?(I(),D("div",{key:0,ref_key:"dropdownRef",ref:y,class:Ot(["av-autocomplete-dropdown",v(t).dropdownClass]),style:At({width:v(t).dropdownWidth,maxHeight:v(t).maxDropdownHeight})},[v(O)===v(j).LOADING?(I(),D("div",fo,[W(It,{name:v($).LOADING_OUTLINE,size:1.5,class:"av-autocomplete-dropdown__spinner"},null,8,["name"]),u[0]||(u[0]=et("span",{class:"av-autocomplete-dropdown__loading-text"},"Loading...",-1))])):v(O)===v(j).NO_OPTIONS?(I(),D("div",vo,[c.empty?F(s.$slots,"empty",{key:0},void 0,!0):(I(),D("div",go," No results found "))])):(I(),Z(vt,tt({key:2,ref_key:"listRef",ref:S},v(t).listOptions,{class:["av-autocomplete-dropdown__options",v(t).scrollbarClass]}),{default:R(()=>[(I(!0),D(ue,null,ot(v(b),f=>(I(),D(ue,{key:v(a)(f)},[c.item?F(s.$slots,"item",{key:0,option:f,isSelected:_(f),toggle:()=>T(f)},void 0,!0):(I(),Z(Ye,{key:1,title:v(p)(f),icon:_(f)?v($).CHECK:void 0,selected:_(f),clickable:"","on-click":()=>T(f),"hover-background-color":"var(--light-background-neutral)","color-on-hover":"var(--base)"},null,8,["title","icon","selected","on-click"]))],64))),128))]),_:3},16,["class"]))],6)):ve("",!0)}}),ho=ie(dt,[["__scopeId","data-v-b59b9163"]]);dt.__docgenInfo={exportName:"default",displayName:"AvAutocompleteDropdown",description:"",tags:{},expose:[{name:"dropdownRef"}],events:[{name:"loadMore"}],slots:[{name:"empty"},{name:"item",scoped:!0,bindings:[{name:"option",title:"binding"},{name:"is-selected",title:"binding"},{name:"toggle",title:"binding"}]}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/selects/AvAutocomplete/AvAutocompleteDropdown.vue"]};const bo={class:"av-autocomplete-input"},yo={key:0,class:"av-autocomplete-input__suffix"},pt=ae({__name:"AvAutocompleteInput",emits:["search","clear"],setup(e,{expose:o,emit:n}){const r=n,c=se(),{selectedItems:i,searchQuery:d,isOpen:l,props:t,inputId:a,handleBlur:p,getDisplayLabel:y}=ge(),S=V(),b=M(()=>!t.multiSelect&&i.value.length>0?y(i.value[0]):t.multiSelect&&i.value.length>0?t.showSelectedSection?`${i.value.length} element(s) selected`:i.value.map(y).join(", "):d.value),O=M(()=>{var s;return((s=t.inputOptions)==null?void 0:s.placeholder)||"Search..."}),_=ut(s=>{d.value=s,r("search",s)},t.debounceDelay);function T(s){d.value=String(s||""),_(d.value)}function w(){l.value=!0}function g(){i.value=[],d.value="",r("clear")}return fe(()=>{_.cancel()}),o({inputRef:S,searchQuery:M(()=>d.value)}),(s,u)=>(I(),D("div",bo,[W(Tt,tt({id:v(a),ref_key:"inputRef",ref:S,"model-value":v(b),placeholder:v(O)},v(t).inputOptions,{"onUpdate:modelValue":T,onFocus:w,onBlur:v(p),onClick:w}),ne({_:2},[c.requiredTip?{name:"requiredTip",fn:R(()=>[(I(),Z(nt(c.requiredTip)))]),key:"0"}:void 0]),1040,["id","model-value","placeholder","onBlur"]),v(i).length>0?(I(),D("div",yo,[W(lt,{label:"Clear selected items",icon:v($).CLOSE_CIRCLE_OUTLINE,"icon-only":"","icon-scale":.8,size:"sm",variant:"DEFAULT",theme:"SECONDARY","on-click":g},null,8,["icon"])])):ve("",!0)]))}}),So=ie(pt,[["__scopeId","data-v-24fd377c"]]);pt.__docgenInfo={exportName:"default",displayName:"AvAutocompleteInput",description:"",tags:{},expose:[{name:"inputRef"},{name:"searchQuery"}],events:[{name:"search",type:{names:["string"]}},{name:"clear"}],slots:[{name:"requiredTip"}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/selects/AvAutocomplete/AvAutocompleteInput.vue"]};const Ao={key:0,class:"av-autocomplete-selected-tags"},mt=ae({__name:"AvAutocompleteSelectedTags",setup(e){const o=se(),{selectedItems:n,props:r,getOptionId:c,getDisplayLabel:i}=ge();function d(l){const t=n.value,a=c(l);n.value=t.filter(p=>c(p)!==a)}return(l,t)=>v(r).multiSelect&&v(n).length>0&&v(r).showSelectedSection?(I(),D("div",Ao,[(I(!0),D(ue,null,ot(v(n),a=>(I(),D("div",{key:v(c)(a),class:"av-autocomplete-selected-tags__item"},[o.selectedItem?F(l.$slots,"selectedItem",{key:0,option:a,remove:()=>d(a)},void 0,!0):(I(),Z(lt,{key:1,label:v(i)(a),icon:v($).CLOSE_CIRCLE_OUTLINE,"icon-right":"",size:"sm",variant:"OUTLINED",theme:"SECONDARY","on-click":()=>d(a)},null,8,["label","icon","on-click"]))]))),128))])):ve("",!0)}}),Oo=ie(mt,[["__scopeId","data-v-c00c128b"]]);mt.__docgenInfo={exportName:"default",displayName:"AvAutocompleteSelectedTags",description:"",tags:{},slots:[{name:"selectedItem",scoped:!0,bindings:[{name:"option",title:"binding"},{name:"remove",title:"binding"}]}],sourceFiles:["/home/runner/work/avenirs-dsav/avenirs-dsav/src/components/interaction/selects/AvAutocomplete/AvAutocompleteSelectedTags.vue"]};const _o={class:"av-autocomplete"},ft=ae({__name:"AvAutocomplete",props:Ie({id:{},inputOptions:{default:()=>({})},options:{},multiSelect:{type:Boolean,default:!1},getOptionLabel:{},getOptionKey:{},filterOptions:{},dropdownWidth:{default:"100%"},maxDropdownHeight:{default:"20rem"},listOptions:{default:()=>({size:"small",ariaLabel:"Available options list"})},scrollbarClass:{default:"av-autocomplete__scrollbar--default"},dropdownClass:{default:"av-autocomplete__dropdown--default"},loading:{type:Boolean,default:!1},debounceDelay:{default:300},maxResults:{},enableLoadMore:{type:Boolean,default:!1},showSelectedSection:{type:Boolean,default:!1},blurCloseDelay:{default:150},loadMoreThrottleDelay:{default:200},serverSideFiltering:{type:Boolean,default:!1}},{modelValue:{default:()=>[]},modelModifiers:{}}),emits:Ie(["search","loadMore","clear"],["update:modelValue"]),setup(e,{emit:o}){const n=e,r=o,c=se(),i=_t(e,"modelValue"),d=V(!1),l=V(""),t=V(),a=V(),p=V(),y=M(()=>n.id||`av-autocomplete-${crypto.randomUUID()}`);function S(g){l.value=g,r("search",g)}function b(g){var s,u;(u=(s=p.value)==null?void 0:s.dropdownRef)!=null&&u.contains(g.relatedTarget)||setTimeout(()=>{d.value=!1},n.blurCloseDelay)}function O(g){return n.getOptionKey?n.getOptionKey(g):g.value}function _(g){return n.getOptionLabel?n.getOptionLabel(g):g.label}wt(rt,{selectedItems:i,searchQuery:l,isOpen:d,props:n,inputId:y,handleBlur:b,getOptionId:O,getDisplayLabel:_});function w(g){var f,h,A,k,m;const s=g.target,u=(f=a.value)==null?void 0:f.inputRef;!((h=u==null?void 0:u.contains)!=null&&h.call(u,s))&&!((A=t.value)!=null&&A.contains(s))&&!((m=(k=p.value)==null?void 0:k.dropdownRef)!=null&&m.contains(s))&&(d.value=!1)}return pe(()=>{document.addEventListener("click",w)}),fe(()=>{document.removeEventListener("click",w)}),(g,s)=>(I(),D("div",_o,[et("div",{ref_key:"wrapperRef",ref:t,class:"av-autocomplete__wrapper"},[W(So,{ref_key:"inputRef",ref:a,onSearch:S,onClear:s[0]||(s[0]=u=>r("clear"))},ne({_:2},[c.requiredTip?{name:"requiredTip",fn:R(()=>[(I(),Z(nt(c.requiredTip)))]),key:"0"}:void 0]),1536),W(ho,{ref_key:"dropdownRef",ref:p,onLoadMore:s[1]||(s[1]=u=>r("loadMore"))},ne({_:2},[c.item?{name:"item",fn:R(({option:u,isSelected:f,toggle:h})=>[F(g.$slots,"item",{option:u,isSelected:f,toggle:h},void 0,!0)]),key:"0"}:void 0,c.empty?{name:"empty",fn:R(()=>[F(g.$slots,"empty",{},void 0,!0)]),key:"1"}:void 0]),1536)],512),W(Oo,null,ne({_:2},[c.selectedItem?{name:"selectedItem",fn:R(({option:u,remove:f})=>[F(g.$slots,"selectedItem",{option:u,remove:f},void 0,!0)]),key:"0"}:void 0]),1024)]))}}),ye=ie(ft,[["__scopeId","data-v-fd810890"]]);ft.__docgenInfo={exportName:"default",displayName:"AvAutocomplete",description:"",tags:{},props:[{name:"id",description:"ID of the input element",required:!1,type:{name:"string"}},{name:"inputOptions",description:"Input-related options and configuration",required:!1,type:{name:"Omit",elements:[{name:"AvInputProps"},{name:"union",elements:[{name:'"id"'},{name:'"modelValue"'}]}]},defaultValue:{func:!1,value:"() => ({})"}},{name:"options",description:"Options available for selection",required:!1,type:{name:"Array",elements:[{name:"T"}]}},{name:"multiSelect",description:"Whether to allow multi-selection",tags:{default:[{description:"true",title:"default"}]},required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"getOptionLabel",description:"Function to get display text from option",required:!1,type:{name:"TSFunctionType"}},{name:"getOptionKey",description:"Function to get unique key from option",required:!1,type:{name:"TSFunctionType"}},{name:"filterOptions",description:"Function to filter options based on query",required:!1,type:{name:"TSFunctionType"}},{name:"dropdownWidth",description:"Width of the dropdown",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'100%'"}},{name:"maxDropdownHeight",description:"Maximum height of the dropdown",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'20rem'"}},{name:"listOptions",description:"Props to pass to the AvList component",required:!1,type:{name:"AvListProps"},defaultValue:{func:!1,value:`() => ({
  size: 'small',
...
}`,...(Xe=(Qe=te.parameters)==null?void 0:Qe.docs)==null?void 0:Xe.source}}};const qo=["Default","MultiSelect","WithCustomInput","Loading","WithLoadMore","CustomDropdownSize","WithCustomItemSlotExample"];export{Y as CustomDropdownSize,G as Default,Q as Loading,K as MultiSelect,J as WithCustomInput,te as WithCustomItemSlotExample,X as WithLoadMore,qo as __namedExportsOrder,Vo as default};
