import"./AvFieldset-C6D3BXIF.js";import"./AvFieldsetElement-CFWdvAxN.js";import{A as c}from"./AvIcon-DU4ymJCY.js";import"./AvIconText-zNT_PX12.js";import"./AvNotice-0t8g0H2D.js";import{M as u,R as O,I as _}from"./icons-Ce2dNHmt.js";import"./AvMessage-DCiE2l-n.js";import"./iframe-BV1nipZz.js";import"./preload-helper-ILsKNznc.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./string-BZgCOP9D.js";const L={title:"Foundations/3. DSAV icons"},r=()=>({components:{AvIcon:c},setup(){const e=Object.entries(u).map(([t,i])=>[`MDI_ICONS.${t}`,i]),n=Object.entries(O).map(([t,i])=>[`RI_ICONS.${t}`,i]),A=Object.entries(_).map(([t,i])=>[`ICONS_DATA_URL.${t}`,i]);return{icons:[...e,...n,...A]}},template:`
