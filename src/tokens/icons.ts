...
export const MDI_ICONS = {
  ...
  CLAPPERBOARD_OUTLINE: 'mdi:clapperboard-outline',
  CLOCK_ARROW: 'mdi:clock-arrow',
  ...
  FORMAT_HEADING_1: 'mdi:format-heading-1',
  FORMAT_HEADING_2: 'mdi:format-heading-2',
  FORMAT_HEADING_3: 'mdi:format-heading-3',
  FORMAT_HEADING_4: 'mdi:format-heading-4',
  FORMAT_HEADING_5: 'mdi:format-heading-5',
  FORMAT_HEADING_6: 'mdi:format-heading-6',
  ...
  LOGOUT: 'mdi:logout',
  LOUDSPEAKER_OUTLINE: 'mdi:loudspeaker-outline',
  MAGNIFY: 'mdi:magnify',
  ...
  PERSON_OUTLINE: 'mdi:person-outline',
...
export const MS_ICONS = {
  ...
  CONTENT_COPY_OUTLINE: 'material-symbols:content-copy-outline',
